...
set_sprite_animation:
	JMP set_sprite_animation_direct		;$B9A000

set_alt_sprite_animation:
	JMP set_alt_sprite_animation_direct	;$B9A003

process_sprite_animation:
	JMP process_sprite_animation_direct	;$B9A006

set_anim_handle_kiddy:
	JMP set_anim_handle_kiddy_direct	;$B9A009

process_anim_preserve_state:
	JMP process_anim_preserve_state_direct	;$B9A00C

set_anim_handle_animal:
	JMP set_anim_handle_animal_direct	;$B9A00F
...
set_anim_once_handle_kiddy:
	JMP set_anim_once_handle_kiddy_direct	;$B9A018
...
CODE_B9A035:
	...
	LDA.b kong_control.animation_id,x	;$B9A03C
	PHX					;$B9A03E
	PHA					;$B9A03F
...
CODE_B9A091:
	...
	LDY.w follower_kong_control_variables	;$B9A09A
...
set_anim_handle_kiddy_direct:
	...
	STA.w kong_control.animation_id,y	;$B9A0AE
	CPY.w #dixie_control_variables		;$B9A0B1
	BEQ.b set_sprite_animation_direct	;$B9A0B4
	CLC					;$B9A0B6
	ADC.w #$0087				;$B9A0B7
set_sprite_animation_direct:
	PHB					;$B9A0BA
	%pea_shift_dbr(animation_scripts_table)	;$B9A0BB
	PLB					;$B9A0BE
	PLB					;$B9A0BF
...
process_anim_preserve_state_direct:
	LDX.b current_sprite			;$B9A0E2
	LDA.b $38,x				;$B9A0E4
	PHA					;$B9A0E6
	JSL.l process_sprite_animation_direct	;$B9A0E7
	PLA					;$B9A0EB
	STA.b $38,x				;$B9A0EC
	RTL					;$B9A0EE
...
process_sprite_animation_direct:
...
CODE_B9A112:
	PHB					;$B9A112
	%pea_shift_dbr(animation_scripts_table)	;$B9A113
	PLB					;$B9A116
	PLB					;$B9A117
	LDY.b $46,x				;$B9A118
CODE_B9A11A:
...
anim_command_81:
	...
	PHK					;$B9A1CB
	PLB					;$B9A1CC
	%return(CODE_B9A1D3)			;$B9A1CD
	JMP.w ($0042)				;$B9A1D0

CODE_B9A1D3:
	PLB					;$B9A1D3
	PLY					;$B9A1D4
	BCS.b anim_command_82			;$B9A1D5
...
anim_command_87_89:
	...
	PLB					;$B9A24C
	JMP.w set_sprite_animation_direct	;$B9A24D
...
CODE_B9A47B:
	LDA.w $0001,y				;$B9A47B
	STA.b $24,x				;$B9A47E
	LDA.l current_held_sprite		;$B9A480
...
CODE_B9A4BE:
	LDA.w $0001,y				;$B9A4BE
	STA.b $24,x				;$B9A4C1
	LDA.l current_held_sprite		;$B9A4C3
...
CODE_B9A548:
	...
	STA.l $00188F				;$B9A567
CODE_B9A56B:
	LDA.l current_held_sprite		;$B9A56B
	BEQ.b CODE_B9A57F			;$B9A56F
	LDA.w $0007,y				;$B9A571
	STA.l $00186D				;$B9A574
	LDA.w $0009,y				;$B9A578
	STA.l RAM_186F				;$B9A57B
CODE_B9A57F:
	TYA					;$B9A57F
	CLC					;$B9A580
	ADC.w #$000B				;$B9A581
...
CODE_B9AA3F:
	...
	LDA.b $12,x				;$B9AA4E
	SEC					;$B9AA50
	SBC.w RAM_196D				;$B9AA51
	CMP.w #$0100				;$B9AA54
	BCS.b CODE_B9AA6B			;$B9AA57
	LDA.b $16,x				;$B9AA59
	SEC					;$B9AA5B
	SBC.w RAM_1973				;$B9AA5C
	CMP.w #$00F0				;$B9AA5F
...
CODE_B9AA6C:
	...
	BRL CODE_B9A1B0				;$B9AA7E

CODE_B9AA81:
	BRL CODE_B9A1B7				;$B9AA81
...
CODE_B9AB2F:
	LDX.w RAM_18DF				;$B9AB2F
	BEQ.b CODE_B9AB3D			;$B9AB32
	LDA.b sprite.type,x			;$B9AB34
...
CODE_B9AC68:
	...
	LDY.w #$0100				;$B9AC75
CODE_B9AC78:
	LDA.w player_action_button_held		;$B9AC78
	AND.w #$0300				;$B9AC7B
...
CODE_B9AD21:
	LDA.w #$0001				;$B9AD21
	STA.w RAM_1871				;$B9AD24
	RTS					;$B9AD27

CODE_B9AD28:
	LDA.w #$FFFF				;$B9AD28
	STA.w RAM_1871				;$B9AD2B
	RTS					;$B9AD2E

CODE_B9AD2F:
	LDA.w #$4000				;$B9AD2F
	TSB.w RAM_1877				;$B9AD32
	RTS					;$B9AD35
...
CODE_B9AD6C:
	...
	JSL.l set_alt_sprite_animation_direct	;$B9AD83
...
CODE_B9AE11:
	...
	JSL.l set_alt_sprite_animation_direct	;$B9AE25
...
CODE_B9AE75:
	...
	LDA.w #$0000				;$B9AE94
	STA.w $0028,y				;$B9AE97
	LDA.w RAM_1875				;$B9AE9A
	AND.w #$FFDE				;$B9AE9D
	STA.w $003A,y				;$B9AEA0
	LDA.w RAM_1873				;$B9AEA3
	STA.w $000E,y				;$B9AEA6
...
CODE_B9AECB:
	...
	JSL.l set_alt_sprite_animation_direct	;$B9AEDF
...
CODE_B9AF13:
	...
	LDA.w #$0000				;$B9AF32
	STA.w $0028,y				;$B9AF35
	LDA.w RAM_1875				;$B9AF38
	AND.w #$FFDE				;$B9AF3B
	STA.w $003A,y				;$B9AF3E
	LDA.w RAM_1873				;$B9AF41
	STA.w $000E,y				;$B9AF44
...
CODE_B9AF6E:
	...
	JSL.l set_alt_sprite_animation_direct	;$B9AF85
...
CODE_B9AFE7:
	...
	LDA.w #$0001				;$B9AFF3
	TSB.w game_state_flags			;$B9AFF6
	LDA.w #$FFFF				;$B9AFF9
	STA.w RAM_195B				;$B9AFFC
CODE_B9AFFF:
	RTS					;$B9AFFF

CODE_B9B000:
	LDA.w RAM_1957				;$B9B000
	CPX.w active_kong_sprite		;$B9B003
	BEQ.b CODE_B9B00B			;$B9B006
	LDA.w RAM_1927				;$B9B008
CODE_B9B00B:
	EOR.w #$FFFF				;$B9B00B
	AND.w #$8000				;$B9B00E
	CMP.w #$0001				;$B9B011
...
CODE_B9B015:
	...
	LDA.w RAM_195A				;$B9B01A
	AND.w #$FFFD				;$B9B01D
	ORA.w #$0001				;$B9B020
	STA.w RAM_195A				;$B9B023
	JSL.l CODE_BB860F			;$B9B026
	RTS					;$B9B02A

CODE_B9B02B:
	LDA.w RAM_1959				;$B9B02B
	AND.w #$FFFD				;$B9B02E
	ORA.w #$0001				;$B9B031
	STA.w RAM_1959				;$B9B034
...
CODE_B9B03C:
	...
	LDA.w RAM_195A				;$B9B041
	AND.w #$FFFE				;$B9B044
	ORA.w #$0002				;$B9B047
	STA.w RAM_195A				;$B9B04A
	JSL.l CODE_BB860F			;$B9B04D
	RTS					;$B9B051

CODE_B9B052:
	LDA.w RAM_1959				;$B9B052
	AND.w #$FFFE				;$B9B055
	ORA.w #$0002				;$B9B058
	STA.w RAM_1959				;$B9B05B
...
CODE_B9B063:
	...
	LDA.w #$0003				;$B9B068
	TRB.w RAM_195A				;$B9B06B
	LDA.w #$8000				;$B9B06E
	TRB.w RAM_1927				;$B9B071
	JSL.l CODE_BB860F			;$B9B074
	RTS					;$B9B078

CODE_B9B079:
	LDA.w #$0003				;$B9B079
	TRB.w RAM_195A				;$B9B07C
	LDA.w #$8000				;$B9B07F
	TRB.w RAM_1957				;$B9B082
...
CODE_B9B22F:
	LDA.w RAM_0777				;$B9B22F
	AND.w #$0020				;$B9B232
	BEQ.b CODE_B9B2A4			;$B9B235
	LDA.w ellie_ammo_count			;$B9B237
	CMP.w #$0007				;$B9B23A
	BCS.b CODE_B9B2A4			;$B9B23D
	LDA.w RAM_0775				;$B9B23F
	AND.w #$0200				;$B9B242
	BNE.b CODE_B9B272			;$B9B245
	LDA.w water_y_position			;$B9B247
	SEC					;$B9B24A
	SBC.b $16,x				;$B9B24B
	CMP.w #$0038				;$B9B24D
...
CODE_B9B282:
	INY					;$B9B282
	INY					;$B9B283
	CMP.w RAM_18B7,y				;$B9B284
	BCC.b CODE_B9B2A4			;$B9B287
	CMP.w RAM_18C1,y				;$B9B289
...
CODE_B9B2D4:
	LDA.w ellie_ammo_count			;$B9B2D4
	CMP.w #$0007				;$B9B2D7
	BCS.b CODE_B9B2E6			;$B9B2DA
	INC.w ellie_ammo_count			;$B9B2DC
	LDA.w #$000A				;$B9B2DF
...
CODE_B9B340:
	...
	DEC.w ellie_ammo_count			;$B9B349
	BPL.b CODE_B9B351			;$B9B34C
	STZ.w ellie_ammo_count			;$B9B34E
CODE_B9B351:
	LDA.w #$0009				;$B9B351
...
CODE_B9B359:
	...
	DEC.w ellie_ammo_count			;$B9B362
	BPL.b CODE_B9B36A			;$B9B365
	STZ.w ellie_ammo_count			;$B9B367
CODE_B9B36A:
	LDA.w #$0009				;$B9B36A
...
CODE_B9B3FD:
	LDA.w #$0057				;$B9B3FD
	JSL.l set_sprite_animation_direct	;$B9B400
	LDA.w #$006C				;$B9B404
	STA.b $38,x				;$B9B407
	LDY.w #$02A0				;$B9B409
	LDA.b [$6A],y				;$B9B40C
...
CODE_B9B50D:
	LDA.w #$0001				;$B9B50D
	TRB.w RAM_1957				;$B9B510
	RTS					;$B9B513

CODE_B9B514:
	LDA.w #$0001				;$B9B514
	TRB.w RAM_1957				;$B9B517
...
CODE_B9B6B4:
	...
	ADC.w #$0003				;$B9B6C1
	PHA					;$B9B6C4
	BRL CODE_B9A1B0				;$B9B6C5

CODE_B9B6C8:
	XBA					;$B9B6C8
	BIT.w #$003F				;$B9B6C9
	BNE.b CODE_B9B6D1			;$B9B6CC
	BRL CODE_B9A1B0				;$B9B6CE
...
;Graphic ID's. Used by animal buddy box, floor door and spawn command F3
DATA_B9B6E7:
	dw $8005
	dw $2738
	dw $030C
...
CODE_B9B867:
	...
	TYA					;$B9B873
	JSL.l set_sprite_animation_direct	;$B9B874
CODE_B9B878:
	RTS					;$B9B878
...
CODE_B9B88D:
	...
	LDA.b $1A				;$B9B8AA
	JSL.l set_sprite_animation_direct	;$B9B8AC
CODE_B9B8B0:
	RTS					;$B9B8B0
...
CODE_B9B8B1:
	...
	LDA.b $1A				;$B9B8CE
	JSL.l set_sprite_animation_direct	;$B9B8D0
CODE_B9B8D4:
	RTS					;$B9B8D4
...
CODE_B9B9C4:
	INC.w RAM_1877				;$B9B9C4
	BIT.w RAM_1877				;$B9B9C7
...
CODE_B9B9D9:
	...
	LDY #$0008				;$B9B9F5
	LDA [$6A],y				;$B9B9F8
	JSL set_sprite_animation_direct		;$B9B9FA
...
CODE_B9BA02:
	...
	LDY #$0008				;$B9BA16
	LDA [$6A],y				;$B9BA19
	JSL set_sprite_animation_direct		;$B9BA1B
	STZ current_held_sprite			;$B9BA1F
	RTS					;$B9BA22

CODE_B9BA23:
	LDA.w water_y_position			;$B9BA23
	STA.b $16,x				;$B9BA26
	RTS					;$B9BA28
...
CODE_B9BA5E:
	...
	LDA.w #$0182				;$B9BA62
	JSL.l set_sprite_animation_direct	;$B9BA65
CODE_B9BA69:
	RTS					;$B9BA69
...
CODE_B9BAED:
	...
	TYA					;$B9BAF9
	JSL.l set_sprite_animation_direct	;$B9BAFA
CODE_B9BAFE:
	RTS					;$B9BAFE
...
CODE_B9BCFB:
	...
	JSL.l set_sprite_animation_direct	;$B9BD02
CODE_B9BD06:
	RTS					;$B9BD06
...
CODE_B9BD14:
	...
	JSL.l set_sprite_animation_direct	;$B9BD2E
CODE_B9BD32:
	RTS					;$B9BD32
...
CODE_B9BD5B:
	...
	JSL.l set_sprite_animation_direct	;$B9BD71
CODE_B9BD75:
	LDA.b $62,x				;$B9BD75
	CLC					;$B9BD77
	ADC.w #$0100				;$B9BD78
...
CODE_B9BDB1:
	...
	LDA.w #$02E3				;$B9BDB8
	JSL.l set_sprite_animation_direct	;$B9BDBB
CODE_B9BDBF:
	RTS					;$B9BDBF
...
CODE_B9BDD7:
	LDA.w bear_dialogue.boomer		;$B9BDD7
	AND.w #$0700				;$B9BDDA
	...
	XBA					;$B9BDE1
	ORA.w #$8000				;$B9BDE2
	STA.w bear_dialogue.boomer		;$B9BDE5
	LDY.b $68,x				;$B9BDE8
	LDA.w $005E,y				;$B9BDEA
	STA.w $0060,y				;$B9BDED
	LDA.w #$0014				;$B9BDF0
...
CODE_B9BE11:
	LDA.w #$2000				;$B9BE11
	TSB.w bear_dialogue.brash			;$B9BE14
	RTS					;$B9BE17
...
CODE_B9BE74:
	LDA.w #$0200				;$B9BE74
	CMP.w RAM_15E8				;$B9BE77
	RTS					;$B9BE7A

CODE_B9BE7B:
	LDA.w #$0100				;$B9BE7B
	STA.w RAM_196D				;$B9BE7E
	STA.w RAM_1973				;$B9BE81
	RTS					;$B9BE84
...
CODE_B9BF92:
	LDA.w #$0200				;$B9BF92
	CMP.w RAM_15E8				;$B9BF95
	RTS					;$B9BF98

CODE_B9BF99:
	LDA.w #$0100				;$B9BF99
	STA.w RAM_196B				;$B9BF9C
	STA.w RAM_1971				;$B9BF9F
	RTS					;$B9BFA2
...
sprite_movement_routines:
	...
	dw CODE_B9E9AB			;36
	dw CODE_B9E9FD			;37
	dw CODE_B9EA8A			;38 Used by moving mill/factory platforms
	dw CODE_B9EB15			;39
	dw CODE_B9EB21			;3A
	dw CODE_B9EB37			;3B
	dw CODE_B9EB3D			;3C
...
CODE_B9E362:
	...
	PLX					;$B9E371
CODE_B9E372:
	BRL CODE_B9E2B0				;$B9E372

CODE_B9E375:
	PLX					;$B9E375
	LDA.b [$3E],y				;$B9E376
	STA.b $1C,x				;$B9E378
	BRL CODE_B9E2B0				;$B9E37A
...
CODE_B9E38A:
	...
	ADC.b $5E,x				;$B9E38E
	STA.b $5E,x				;$B9E390
	BRL CODE_B9E2B0				;$B9E392

CODE_B9E395:
	PLX					;$B9E395
	LDA.b [$3E],y				;$B9E396
	STA.b $38,x				;$B9E398
	BRL CODE_B9E2B0				;$B9E39A
...
CODE_B9E3B1:
	...
	INC.b $5C,x				;$B9E3BC
	INC.b $5C,x				;$B9E3BE
	BRL CODE_B9E2B0				;$B9E3C0

CODE_B9E3C3:
	PLX					;$B9E3C3
	LDA.b [$3E],y				;$B9E3C4
	STA.b $64,x				;$B9E3C6
	BRL CODE_B9E2B0				;$B9E3C8

CODE_B9E3CB:
	PLX					;$B9E3CB
	LDA.b [$3E],y				;$B9E3CC
	STA.b $5C,x				;$B9E3CE
	BRL CODE_B9E2B0				;$B9E3D0

CODE_B9E3D3:
	PLX					;$B9E3D3
	LDA.b [$3E],y				;$B9E3D4
	STA.b $5E,x				;$B9E3D6
	BRL CODE_B9E2B0				;$B9E3D8

CODE_B9E3DB:
	PLX					;$B9E3DB
	STZ.b $5A,x				;$B9E3DC
	BRL CODE_B9E251				;$B9E3DE
...
CODE_B9EE0D:
	...
	LDA.w RAM_0775				;$B9EE10
	AND.w #$0004				;$B9EE13
	BEQ.b CODE_B9EE20			;$B9EE16
	CLC					;$B9EE18
	PHK					;$B9EE19
	%return(CODE_B9EE20)			;$B9EE1A
	JMP.w [RAM_18B1]			;$B9EE1D
...
CODE_B9EE2E:
	...
	LDA.w RAM_0775				;$B9EE3B
	AND.w #$0004				;$B9EE3E
	BEQ.b CODE_B9EE4B			;$B9EE41
	CLC					;$B9EE43
	PHK					;$B9EE44
	%return(CODE_B9EE4B)			;$B9EE45
	JMP.w [RAM_18B1]			;$B9EE48
...
CODE_B9EE4C:
	...
	LDA.w RAM_0775				;$B9EE53
	AND.w #$0004				;$B9EE56
	BEQ.b CODE_B9EE63			;$B9EE59
	CLC					;$B9EE5B
	PHK					;$B9EE5C
	%return(CODE_B9EE63)			;$B9EE5D
	JMP.w [RAM_18B1]			;$B9EE60
...
CODE_B9EE90:
	LDA.w water_y_position			;$B9EE90
	PHA					;$B9EE93
	STZ.w water_y_position			;$B9EE94
	JSL.l CODE_B9EEA0			;$B9EE97
	PLA					;$B9EE9B
	STA.w water_y_position			;$B9EE9C
	RTL					;$B9EE9F
...
CODE_B9EFF6:
	...
	STY.b $18,x				;$B9F002
	BRL CODE_B9F119				;$B9F004

CODE_B9F007:
	STZ.b $1A,x				;$B9F007
	BRL CODE_B9F119				;$B9F009
...
CODE_B9F612:
	...
	LDA.w water_current_speed		;$B9F625
	STA.b $36,x				;$B9F628
	RTL					;$B9F62A
...
CODE_B9F62E:
	LDA.w RAM_0775				;$B9F62E
	AND.w #$0060				;$B9F631
	BNE.b CODE_B9F656			;$B9F634
	LDA.w RAM_0777				;$B9F636
	AND.w #$0080				;$B9F639
