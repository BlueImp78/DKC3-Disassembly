...
CODE_B9A0BA:
	...
	LDA.b $4A,x				;$B9A0C7
	AND.w #$8000				;$B9A0C9
	ORA.w DATA_F90100+$02,y			;$B9A0CC
	STA.b $4A,x				;$B9A0CF
	LDA.w DATA_F90100,y			;$B9A0D1
	STA.b $46,x				;$B9A0D4
	TAY					;$B9A0D6
	LDA.w #$0100				;$B9A0D7
	STA.b $44,x				;$B9A0DA
...
CODE_B9A855:
	...
	LDA.w #$0013				;$B9A85A
	JSL.l CODE_B9A0AC			;$B9A85D
	SEC					;$B9A861
	RTS					;$B9A862

CODE_B9A863:
	LDA.w #$002D				;$B9A863
	JSL.l CODE_B9A0AC			;$B9A866
	SEC					;$B9A86A
	RTS					;$B9A86B
