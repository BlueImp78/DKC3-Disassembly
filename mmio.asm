...
struct CPU $4200
	.enable_interrupts: skip 1			;4200
	.output_port: skip 1				;4201
	.multiply:
		.multiply_A: skip 1			;4202
		.multiply_B: skip 1			;4203
	.dividen:
		.dividen_low: skip 1			;4204
		.dividen_high: skip 1			;4205
	.divisor: skip 1				;4206

	.horizontal_timer:
		.horizontal_timer_low: skip 1		;4207
		.horizontal_timer_high: skip 1		;4208

	.vertical_timer:
		.vertical_timer_low: skip 1		;4209
		.vertical_timer_high: skip 1		;420A

	.enable_dma_hdma:
		.enable_dma: skip 1			;420B
		.enable_hdma: skip 1			;420C

	.rom_speed: skip 1				;420D

	.openbus: skip 2				;420E

	.nmi_flag: skip 1				;4210
	.irq_flag: skip 1				;4211
	.ppu_status: skip 1				;4212

	.input_port: skip 1				;4213

	.divide_result:
		.divide_result_low: skip 1		;4214
		.divide_result_high: skip 1		;4215

	.multiply_result:
	.divide_remainder:
		.multiply_result_low:
		.divide_remainder_low: skip 1		;4216
		.multiply_result_high:
		.divide_remainder_high: skip 1		;4217

	.controllers:
		.port_0_data_1:
			.port_0_data_1_low: skip 1	;4218
			.port_0_data_1_high: skip 1	;4219
		.port_1_data_1:
			.port_1_data_1_low: skip 1	;421A
			.port_1_data_1_high: skip 1	;421B
		.port_0_data_2:
			.port_0_data_2_low: skip 1	;421C
			.port_0_data_2_high: skip 1	;421D
		.port_1_data_2:
			.port_1_data_2_low: skip 1	;421E
			.port_1_data_2_high: skip 1	;421F
