...
%offset(sprite_timestop_flag, 3)
	...
	dl barrel_piece_main-1				: db $00	;0034
	...
	dl animal_crate_main-1				: db $00	;0250
	dl animal_icon_main-1				: db $01	;0254
	dl no_animal_sign_main-1			: db $01	;0258
	dl animal_sign_prize_main-1			: db $01	;025C
	...
	dl contact_flash_main-1				: db $01	;026C Also checkpoint stars and smoke
	...
	dl life_balloon_main-1				: db $00	;029C
...
init_sprite_render_order:
	LDX #$0000				;$BB8EFD
	LDA #sprite_table.slot_0		;$BB8F00
.next_slot:
...
CODE_BB8F8B:
	LDX #sprite_table.slot_1		;$BB8F8B
	CLC					;$BB8F8E
CODE_BB8F8F:
	...
	TAX					;$BB8F97
	CPX #sprite_table.end			;$BB8F98
	BCC CODE_BB8F8F				;$BB8F9B
	SEC					;$BB8F9D
	LDX #sprite_table.slot_0		;$BB8F9E
CODE_BB8FA1:
...
spawn_command_setup_static:
	...
	LDX #sprite_table.slot_1		;$BB9241
CODE_BB9244:
	LDA $1E					;$BB9244
...
CODE_BB94B2:
	STA $1A					;$BB94B2
	LDX #sprite_table.slot_1		;$BB94B4
CODE_BB94B7:
	LDA $1A					;$BB94B7
...
CODE_BB9957:
	...
	LDA game_state_flags			;$BB997A
	AND #$D080				;$BB997D
	STA game_state_flags			;$BB9980
	LDA #$0006				;$BB9983
	TRB RAM_05B1				;$BB9986
	LDA #$FFFF				;$BB9989
	STA RAM_06F4				;$BB998C
...
CODE_BB9AD3:
	...
	LDA current_entrance			;$BB9ADA
	BNE CODE_BB9B05				;$BB9ADD
	LDA RAM_05BB				;$BB9ADF
	STA current_entrance			;$BB9AE2
	LDA RAM_05BD				;$BB9AE5
	...
	LDA RAM_05C3				;$BB9AF3
	STA kong_letter_flags			;$BB9AF6
	LDA RAM_05C6				;$BB9AF9
	STA RAM_0536				;$BB9AFC
	LDA RAM_05C5				;$BB9AFF
	STA riverside_race_timer		;$BB9B02
CODE_BB9B05:
	RTS					;$BB9B05
...
CODE_BB9B06:
	...
	STA RAM_05C1				;$BB9B2C
CODE_BB9B2F:
	LDA kong_letter_flags			;$BB9B2F
	STA RAM_05C3				;$BB9B32
	LDA RAM_0536				;$BB9B35
	STA RAM_05C6				;$BB9B38
	LDA riverside_race_timer		;$BB9B3B
	STA RAM_05C5				;$BB9B3E
	RTL					;$BB9B41
...
disable_screen:
	...
	REP #$20				;$BB9B56
	LDA #$0000				;$BB9B58
	STA.l pending_dma_hdma_channels		;$BB9B5B
	RTL					;$BB9B5F
...
CODE_BB9C99:
	...
	STA RAM_18B7,x				;$BB9C9D
	INY					;$BB9CA0
	INY					;$BB9CA1
	INY					;$BB9CA2
	INY					;$BB9CA3
	LDA [$42],y				;$BB9CA4
	STA RAM_18C1,x				;$BB9CA6
	INY					;$BB9CA9
	INY					;$BB9CAA
	INY					;$BB9CAB
	INY					;$BB9CAC
...
CODE_BB9CB1:
	STA RAM_18B7,x				;$BB9CB1
	STA RAM_18C1,x				;$BB9CB4
	INX					;$BB9CB7
	INX					;$BB9CB8
	CPX #$000A				;$BB9CB9
...
CODE_BB9CF9:
	...
	STA RAM_0536				;$BB9D1C
	LDA RAM_0538				;$BB9D1F
	STA riverside_race_timer		;$BB9D22
	BRA CODE_BB9D33				;$BB9D25

CODE_BB9D27:
	STZ riverside_race_timer		;$BB9D27
	STZ RAM_0536				;$BB9D2A
CODE_BB9D2D:
	LDA #$0100				;$BB9D2D
	STA RAM_18E5				;$BB9D30
CODE_BB9D33:
	LDA current_entrance			;$BB9D33
	CMP #$0004				;$BB9D36
...
CODE_BBA09C:
	INY					;$BBA09C
	INY					;$BBA09D
	CMP RAM_18C1,y				;$BBA09E
	BCS CODE_BBA09C				;$BBA0A1
	CMP RAM_18B7,y				;$BBA0A3
	BCC CODE_BBA0D0				;$BBA0A6
	LDA RAM_18C1,y				;$BBA0A8
	SBC #$0024				;$BBA0AB
...
CODE_BBA12E:
	...
	STZ water_current_speed			;$BBA137
	STZ RAM_050D				;$BBA13A
	RTS					;$BBA13D
...
CODE_BBA13E:
	...
	LDA #$FF80				;$BBA147
	STA water_current_speed			;$BBA14A
	LDA #$FFFE				;$BBA14D
	STA water_bubbles_x_speed		;$BBA150
	RTS					;$BBA153
...
CODE_BBA27B:
	...
	STA nmi_pointer				;$BBA28B
	STA complete_frame_nmi_pointer		;$BBA28D
...
CODE_BBA2B1:
	...
	STA nmi_pointer				;$BBA2BA
	STA complete_frame_nmi_pointer		;$BBA2BC
...
CODE_BBA2C8:
	...
	LDA RAM_0536				;$BBA2CD
	STA RAM_0539				;$BBA2D0
	LDA riverside_race_timer		;$BBA2D3
	STA RAM_0538				;$BBA2D6
...
CODE_BBA32A:
	...
	STA nmi_pointer				;$BBA35E
	STA complete_frame_nmi_pointer		;$BBA360
...
CODE_BBA3CB:
	STY game_mode_pointer			;$BBA3CB
	STX game_mode_pointer_bank		;$BBA3CD
...
CODE_BBAC2D:
	JML [sprite_return_address]		;$BBAC2D
...
sprite_slots_table:
	dw sprite_table.slot_0			;$080A
	dw sprite_table.slot_1			;$0878
	dw sprite_table.slot_2			;$08E6
	dw sprite_table.slot_3			;$0954
	dw sprite_table.slot_4			;$09C2
	dw sprite_table.slot_5			;$0A30
	dw sprite_table.slot_6			;$0A9E
	dw sprite_table.slot_7			;$0B0C
	dw sprite_table.slot_8			;$0B7A
	dw sprite_table.slot_9			;$0BE8
	dw sprite_table.slot_10			;$0C56
	dw sprite_table.slot_11			;$0CC4
	dw sprite_table.slot_12			;$0D32
	dw sprite_table.slot_13			;$0DA0
	dw sprite_table.slot_14			;$0E0E
	dw sprite_table.slot_15			;$0E7C
	dw sprite_table.slot_16			;$0EEA
	dw sprite_table.slot_17			;$0F58
	dw sprite_table.slot_18			;$0FC6
	dw sprite_table.slot_19			;$1034
	dw sprite_table.slot_20			;$10A2
	dw sprite_table.slot_21			;$1110
	dw sprite_table.slot_22			;$117E
	dw sprite_table.slot_23			;$11EC
	dw sprite_table.slot_24			;$125A
	dw sprite_table.slot_25			;$12C8
	dw sprite_table.slot_26			;$1336
	dw sprite_table.slot_27			;$13A4
	dw sprite_table.slot_28			;$1412
...
CODE_BBAE1F:
	LDA rocket_rush_fuel_amount		;$BBAE1F
...
CODE_BBAE36:
	CLC					;$BBAE36
	ADC rocket_rush_fuel_amount		;$BBAE37
	BCC CODE_BBAE3F				;$BBAE3A
	LDA #$FFFF				;$BBAE3C
CODE_BBAE3F:
	STA rocket_rush_fuel_amount		;$BBAE3F
CODE_BBAE42:
	LDY next_oam_slot			;$BBAE42
	LDA RAM_18EB				;$BBAE44
	XBA					;$BBAE47
	CLC					;$BBAE48
	ADC rocket_rush_fuel_amount		;$BBAE49
...
CODE_BBAE65:
	LDA rocket_rush_fuel_amount		;$BBAE65
	LSR					;$BBAE68
	AND #$FF00				;$BBAE69
	EOR #$FFFF				;$BBAE6C
	SEC					;$BBAE6F
...
CODE_BBAF06:
	CMP rocket_rush_fuel_amount		;$BBAF06
...
CODE_BBAF56:
	...
	LDA riverside_race_timer		;$BBAF61
...
CODE_BBB155:
	LDY bonus_timer_index			;$BBB155
	BEQ CODE_BBB16B				;$BBB158
	JSR CODE_BBB162				;$BBB15A
	LDX bonus_timer_index			;$BBB15D
	LDY $5C,x				;$BBB160
CODE_BBB162:
	LDX $12,y				;$BBB162
	LDA $0016,y				;$BBB164
...
CODE_BBB261:
	...
	STZ $0830				;$BBB273
	TYA					;$BBB276
	LDY #sprite_table.slot_0		;$BBB277
...
CODE_BBB475:
	...
	LDA $7E9892,x				;$BBB476
	CLC					;$BBB47A
	ADC water_bubbles_x_speed		;$BBB47B
	STA $7E9892,x				;$BBB47E
	LSR					;$BBB482
	LSR					;$BBB483
	SEC					;$BBB484
...
CODE_BBB87D:
	JML [sprite_return_address]		;$BBB87D
...
sprite_handler_direct:
	...
	LDY #sprite_table.slot_1		;$BBB8CB   | Load sprite base pointer
.next_slot:					;	   |
...
.time_stop_sprite_handler:
	...
	STA sprite_return_bank			;$BBB912   |/
	LDA #..sprite_return			;$BBB915   |\ Write sprite return pointer
	STA sprite_return_address		;$BBB918   |/
	LDY #sprite_table.slot_1		;$BBB91B   | Load sprite base pointer
..next_slot:					;	   |
...
handle_kong_follow:
	...
	LDA #$0004				;$BBBA0E
	TRB game_state_flags			;$BBBA11
	BNE CODE_BBBA1D				;$BBBA14
CODE_BBBA16:
	LDA #$0006				;$BBBA16
	TRB game_state_flags			;$BBBA19
	RTS					;$BBBA1C
...
CODE_BBC827:
	...
	JML [sprite_return_address]		;$BBC82B
...
CODE_BBC887:
	JML [sprite_return_address]		;$BBC887
...
CODE_BBC8AB:
	LDA riverside_race_player_time		;$BBC8AB
	CMP riverside_race_timer		;$BBC8AE
...
CODE_BBC90F:
	...
	JML [sprite_return_address]		;$BBC912
...
CODE_BBC92C:
	LDA riverside_race_timer		;$BBC92C
	STA riverside_race_player_time		;$BBC92F
	LDA RAM_0536				;$BBC932
	STA $0630				;$BBC935
	RTS					;$BBC938
...
CODE_BBC950:
	...
	JML [sprite_return_address]		;$BBC953
...
CODE_BBC96A:
	...
	JML [sprite_return_address]		;$BBC970
...
CODE_BBC97F:
	JML [sprite_return_address]		;$BBC97F
...
CODE_BBCA21:
	...
	JML [sprite_return_address]		;$BBCA29

CODE_BBCA2C:
	JSL delete_sprite_handle_deallocation	;$BBCA2C
	JML [sprite_return_address]		;$BBCA30
...
CODE_BBCC58:
	JML [sprite_return_address]		;$BBCC58
...
CODE_BBCCA2:
	JML [sprite_return_address]		;$BBCCA2
...
CODE_BBCCD7:
	...
	JML [sprite_return_address]		;$BBCCE5

CODE_BBCCE8:
	JML [sprite_return_address]		;$BBCCE8
...
CODE_BBCCFC:
	...
	JML [sprite_return_address]		;$BBCD08
...
CODE_BBCD6E:
	JML [sprite_return_address]		;$BBCD6E

CODE_BBCD71:
	JSL process_sprite_animation		;$BBCD71
	JSL CODE_BBD68C				;$BBCD75
	JML [sprite_return_address]		;$BBCD79
...
CODE_BBCE2B:
	JML [sprite_return_address]		;$BBCE2B
...
CODE_BBCE68:
	JML [sprite_return_address]		;$BBCE68
...
CODE_BBCE6B:
	...
	JML [sprite_return_address]		;$BBCE88

CODE_BBCE8B:
	LDA sprite.oam_property,x		;$BBCE8B
	ORA #$8000				;$BBCE8D
	STA sprite.oam_property,x		;$BBCE90
	JML [sprite_return_address]		;$BBCE92
...
CODE_BBCEF6:
	...
	STA ($1A)				;$BBCEF9
CODE_BBCEFB:
	JML [sprite_return_address]		;$BBCEFB
...
CODE_BBCEFE:
	...
	STZ RAM_18DD				;$BBCF10
CODE_BBCF13:
	JML [sprite_return_address]		;$BBCF13
...
CODE_BBCFC7:
	...
	JML [sprite_return_address]		;$BBCFDF
...
CODE_BBCFF3:
	...
	JML [sprite_return_address]		;$BBD012
...
CODE_BBD02D:
	...
	JML [sprite_return_address]		;$BBD043
...
CODE_BBD046:
	...
	JML [sprite_return_address]		;$BBD070

CODE_BBD073:
	JSL process_sprite_animation		;$BBD073
	JML [sprite_return_address]		;$BBD077
...
CODE_BBD085:
	...
	JML [sprite_return_address]		;$BBD09A
...
CODE_BBD0F9:
	JML [sprite_return_address]		;$BBD0F9

CODE_BBD0FC:
	JSL delete_sprite_handle_deallocation	;$BBD0FC
CODE_BBD100:
	JML [sprite_return_address]		;$BBD100
...
CODE_BBD103:
	...
	JML [sprite_return_address]		;$BBD10D
...
CODE_BBD117:
	...
	JML [sprite_return_address]		;$BBD12F
...
CODE_BBD171:
	...
	JML [sprite_return_address]		;$BBD17E
...
CODE_BBD1A0:
	...
	JML [sprite_return_address]		;$BBD1A8
...
CODE_BBD1EE:
	JML [sprite_return_address]		;$BBD1EE
...
CODE_BBD1F1:
	...
	JML [sprite_return_address]		;$BBD210
...
CODE_BBD25F:
	...
	JML [sprite_return_address]		;$BBD267
...
unknown_sprite_0288_main:
	...
	JML [sprite_return_address]		;$BBD278
...
CODE_BBD2AD:
	...
	JML [sprite_return_address]		;$BBD2B5
...
CODE_BBD2B8:
	...
	JML [sprite_return_address]		;$BBD2C8
...
CODE_BBD2EE:
	JML [sprite_return_address]		;$BBD2EE
...
CODE_BBD2F1:
	...
	JML [sprite_return_address]		;$BBD2FF
...
CODE_BBD302:
	...
	JML [sprite_return_address]		;$BBD318
...
CODE_BBD31B:
	...
	JML [sprite_return_address]		;$BBD331
...
CODE_BBD341:
	...
	JML [sprite_return_address]		;$BBD346

CODE_BBD349:
	JSL process_sprite_animation		;$BBD349
	JML [sprite_return_address]		;$BBD34D
...
CODE_BBD350:
	...
	JML [sprite_return_address]		;$BBD361
...
CODE_BBD364:
	...
	JML [sprite_return_address]		;$BBD370
...
CODE_BBD373:
	...
	JML [sprite_return_address]		;$BBD37E
...
CODE_BBD38C:
	...
	JML [sprite_return_address]		;$BBD3AE
...
CODE_BBD3C5:
	...
	JML [sprite_return_address]		;$BBD3C9
...
CODE_BBD3F1:
	...
	JML [sprite_return_address]		;$BBD3F5
...
CODE_BBD3FC:
	...
	JML [sprite_return_address]		;$BBD409
...
CODE_BBD40C:
	...
	STZ RAM_18DF				;$BBD424
CODE_BBD427:
	JML [sprite_return_address]		;$BBD427
...
CODE_BBD51C:
	...
	LDA RAM_0632,x				;$BBD523
	ORA #$0020				;$BBD526
	STA RAM_0632,x				;$BBD529
	RTS					;$BBD52C
...
CODE_BBD544:
	...
	ORA RAM_0632,x				;$BBD547
	STA RAM_0632,x				;$BBD54A
	LDA #$0002				;$BBD54D
...
CODE_BBD5B5:
	JML [sprite_return_address]		;$BBD5B5
...
CODE_BBD606:
	...
	JML [sprite_return_address]		;$BBD60A
...
CODE_BBD60D:
	...
	JML [sprite_return_address]		;$BBD619
...
CODE_BBD61C:
	...
	JML [sprite_return_address]		;$BBD629
...
CODE_BBD64B:
	JML [sprite_return_address]		;$BBD64B
...
CODE_BBD6E9:
	...
	JML [sprite_return_address]		;$BBD6F2
...
CODE_BBD6F5:
	...
	JML [sprite_return_address]		;$BBD713
...
CODE_BBD793:
	JML [sprite_return_address]		;$BBD793
...
CODE_BBD79F:
	LDA #$0064				;$BBD79F
	STA hud_banana_display_timer		;$BBD7A2
...
CODE_BBD7AC:
	LDA #$0064				;$BBD7AC
	STA hud_banana_display_timer		;$BBD7AF
...
CODE_BBD7D8:
	...
	JML [sprite_return_address]		;$BBD7E7
...
CODE_BBD7EA:
	...
	JML [sprite_return_address]		;$BBD7FB
...
CODE_BBD7FE:
	...
	JML [sprite_return_address]		;$BBD81B
...
CODE_BBD833:
	JML [sprite_return_address]		;$BBD833

CODE_BBD836:
	STY bonus_timer_index			;$BBD836
	JML [sprite_return_address]		;$BBD839

CODE_BBD83C:
	STZ bonus_timer_index			;$BBD83C
	JML [sprite_return_address]		;$BBD83F
...
CODE_BBD864:
	...
	JML [sprite_return_address]		;$BBD873
...
CODE_BBD876:
	...
	JML [sprite_return_address]		;$BBD887
...
CODE_BBD88A:
	...
	JML [sprite_return_address]		;$BBD899

CODE_BBD89C:
	LDA #$0001				;$BBD89C
	TSB game_state_flags			;$BBD89F
	BNE CODE_BBD8AB				;$BBD8A2
	LDA #$820F				;$BBD8A4
	JSL set_screen_fade			;$BBD8A7
CODE_BBD8AB:
	LDA #$001F				;$BBD8AB
	LDY #$0004				;$BBD8AE
...
CODE_BBD8C3:
	...
	JML [sprite_return_address]		;$BBD8C6
...
CODE_BBD9E3:
	...
	JML [sprite_return_address]		;$BBDA2C
...
CODE_BBDA55:
	...
	JML [sprite_return_address]		;$BBDA6B
...
CODE_BBDBA2:
	JML [sprite_return_address]		;$BBDBA2
...
CODE_BBDBF2:
	JML [sprite_return_address]		;$BBDBF2
...
CODE_BBDC1A:
	...
	JML [sprite_return_address]		;$BBDC1D
...
CODE_BBDC3D:
	...
	JML [sprite_return_address]		;$BBDC48
...
..return:
	...
	JMP [sprite_return_address]		;$BBDD7D  / Return
...
CODE_BBDDA5:
	...
	JML [sprite_return_address]		;$BBDDB3
...
CODE_BBDDB6:
	...
	JML [sprite_return_address]		;$BBDDC0
...
CODE_BBDDC3:
	...
	JML [sprite_return_address]		;$BBDDEA
...
CODE_BBDDED:
	...
	JML [sprite_return_address]		;$BBDDFB
...
CODE_BBDF28:
	...
	JML [sprite_return_address]		;$BBDF33
