...
DMA_sprite_graphics:
	JMP DMA_sprite_graphics_global		;$B38006
...
CODE_B38086:					;	   |
	STZ.w RAM_1560				;$B38086   |
	STZ.w next_sprite_dma_buffer_slot	;$B38089   |
	LDA game_sub_mode			;$B3808C   |
	ASL					;$B3808E   |
	TAX					;$B3808F   |
...
CODE_B38093:
	...
	STY.w DMA[0].size			;$B38096
	LDA.w #$1801				;$B38099
	STA.w DMA[0].settings			;$B3809C
	SEP.b #$30				;$B3809F
	STX.w DMA[0].source_bank		;$B380A1
	LDA.b #$01				;$B380A4
...
CODE_B38EFC:
	...
	LDA.w RAM_15E2				;$B38EFF
	BEQ.b CODE_B38F36			;$B38F02
	STZ.w RAM_15E2				;$B38F04
	LDA.w RAM_15E4				;$B38F07
	ASL					;$B38F0A
	ASL					;$B38F0B
	ASL					;$B38F0C
	ASL					;$B38F0D
...
CODE_B397A2:
	...
	LDA.w #$7EF5C0				;$B397BE
	STA.w DMA[0].source_word		;$B397C1
	STA.w DMA[0].unused_2			;$B397C4
	LDA.w #$0100				;$B397C7
	STA.w DMA[0].size			;$B397CA
	LDA.w #$1801				;$B397CD
	STA.w DMA[0].settings			;$B397D0
	SEP.b #$20				;$B397D3
	LDA.b #$7EF5C0>>16			;$B397D5
	STA.w DMA[0].source_bank		;$B397D7
	LDA.b #$01				;$B397DA
...
CODE_B39BEA:
	...
	LDA.w RAM_15E6				;$B39BED
	CMP.w RAM_15E4				;$B39BF0
	BNE.b CODE_B39BF6			;$B39BF3
	RTS					;$B39BF5

CODE_B39BF6:
	LDA.w RAM_15E4				;$B39BF6
	BEQ.b CODE_B39C15			;$B39BF9
	CMP.w #$0001				;$B39BFB
	BNE.b CODE_B39C64			;$B39BFE
	LDA.w RAM_15E6				;$B39C00
	BNE.b CODE_B39C64			;$B39C03
	INC.w RAM_15E2				;$B39C05
	LDA.w RAM_15E2				;$B39C08
	CMP.w #$0100				;$B39C0B
...
CODE_B39C15:
	INC.w RAM_15E2				;$B39C15
	LDA.w RAM_15E2				;$B39C18
	CMP.w #$0100				;$B39C1B
...
CODE_B39C64:
	LDA.w RAM_15E4				;$B39C64
	LDX.w RAM_15E6				;$B39C67
	CMP.w #$0003				;$B39C6A
...
CODE_B39C7E:
	INC.w RAM_15E2				;$B39C7E
	LDA.w RAM_15E2				;$B39C81
	CMP.w #$00C0				;$B39C84
...
CODE_B39CBA:
	LDA.w RAM_15E4				;$B39CBA
	CLC					;$B39CBD
	ADC.w RAM_15E6				;$B39CBE
	CMP.w #$0009				;$B39CC1
	BEQ.b CODE_B39CC9			;$B39CC4
	JMP.w CODE_B39DA4			;$B39CC6

CODE_B39CC9:
	LDA.w RAM_15E4				;$B39CC9
	CMP.w #$0005				;$B39CCC
	BEQ.b CODE_B39CD4			;$B39CCF
	JMP.w CODE_B39D35			;$B39CD1

CODE_B39CD4:
	INC.w RAM_15E2				;$B39CD4
	LDA.w RAM_15E2				;$B39CD7
	CMP.w #$00D8				;$B39CDA
...
CODE_B39D35:
	INC.w RAM_15E2				;$B39D35
	LDA.w RAM_15E2				;$B39D38
	CMP.w #$00D8				;$B39D3B
...
CODE_B39D69:
	...
	REP.b #$20				;$B39D9C
	LDA.w #$0004				;$B39D9E
	STA.w RAM_15EA				;$B39DA1
CODE_B39DA4:
	RTS					;$B39DA4

CODE_B39DA5:
	LDA.w RAM_15EC				;$B39DA5
	CMP.w #$00FE				;$B39DA8
...
CODE_B39E3F:
	LDA.w RAM_15E6				;$B39E3F
	STA.w RAM_15E4				;$B39E42
	STZ.w RAM_15E2				;$B39E45
	RTS					;$B39E48
...
CODE_B3A109:
	...
	INC.w RAM_15E4				;$B3A132
CODE_B3A135:
	LDA.w RAM_15E4				;$B3A135
	CMP.w #$0002				;$B3A138
	...
	REP.b #$20				;$B3A144
	LDA.w pending_dma_hdma_channels		;$B3A146
	EOR.w #$0600				;$B3A149
	STA.w pending_dma_hdma_channels		;$B3A14C
	LDA.w #$0662				;$B3A14F
...
CODE_B3A42B:
	...
	STA.l $7EA21E				;$B3A430
CODE_B3A434:
	LDA.w RAM_15E6				;$B3A434
	STA.l $7EA220				;$B3A437
	LDA.w #$0008				;$B3A43B
	TRB.w RAM_15E6				;$B3A43E
	LDA.l $7EA21E				;$B3A441
	CMP.l $7EA21C				;$B3A445
	BCC.b CODE_B3A4C4			;$B3A449
	LDA.w #$0008				;$B3A44B
	TSB.w RAM_15E6				;$B3A44E
	LDA.w RAM_15E6				;$B3A451
	BIT.w #$0004				;$B3A454
...
;Runs while paused
CODE_B3A694:
	DEC active_frame_counter		;$B3A694
	LDA RAM_05B1				;$B3A696
	AND #$7000				;$B3A699
...
CODE_B3AC96:
	JSL.l input_and_pause_handler		;$B3AC96
...
CODE_B3ACC2:
	JSL.l input_and_pause_handler		;$B3ACC2
...
CODE_B3B226:
	JSL.l input_and_pause_handler		;$B3B226
...
CODE_B3B253:
	JSL.l input_and_pause_handler		;$B3B253
...
CODE_B3B280:
	JSL.l input_and_pause_handler		;$B3B280
...
CODE_B3B2B4:
	JSL.l input_and_pause_handler		;$B3B2B4
...
CODE_B3B2E8:
	JSL.l input_and_pause_handler		;$B3B2E8
...
CODE_B3B314:
	JSL.l input_and_pause_handler		;$B3B314
...
CODE_B3B340:
	JSL.l input_and_pause_handler		;$B3B340
...
CODE_B3B402:
	JSL.l input_and_pause_handler		;$B3B402
...
CODE_B3B42E:
	LDA.w RAM_15E6				;$B3B42E
	DEC					;$B3B431
	BPL.b CODE_B3B43A			;$B3B432
	INC.w RAM_15E2				;$B3B434
	LDA.w #$0005				;$B3B437
CODE_B3B43A:
	STA.w RAM_15E6				;$B3B43A
	LDA.w RAM_15E6				;$B3B43D
...
CODE_B3B4EB:
	LDA.w RAM_15E6				;$B3B4EB
	DEC					;$B3B4EE
	DEC					;$B3B4EF
	DEC					;$B3B4F0
	BNE.b CODE_B3B518			;$B3B4F1
	LDA.w RAM_15E4				;$B3B4F3
	DEC					;$B3B4F6
	BPL.b CODE_B3B4FC			;$B3B4F7
	LDA.w #$0005				;$B3B4F9
CODE_B3B4FC:
	STA.w RAM_15E4				;$B3B4FC
	ASL					;$B3B4FF
	TAX					;$B3B500
...
CODE_B3B555:
	JSL.l input_and_pause_handler		;$B3B555
...
CODE_B3B58A:
	LDA.w RAM_15E2				;$B3B58A
	BEQ.b CODE_B3B59A			;$B3B58D
	DEC.w RAM_15E2				;$B3B58F
	LDA.w RAM_15E2				;$B3B592
	BIT.w #$0003				;$B3B595
...
CODE_B3B6FD:
	...
	DEC.w RAM_15EA				;$B3B715
	BRA.b CODE_B3B71A			;$B3B718

CODE_B3B71A:
	LDA.w RAM_15E6				;$B3B71A
	ASL					;$B3B71D
	ASL					;$B3B71E
	CMP.w RAM_15E4				;$B3B71F
	BNE.b CODE_B3B725			;$B3B722
	RTS					;$B3B724

CODE_B3B725:
	LDA.w RAM_15EA				;$B3B725
	BNE.b CODE_B3B730			;$B3B728
	LDA.w #$0001				;$B3B72A
	STA.w RAM_15EA				;$B3B72D
CODE_B3B730:
	LDA.w RAM_15E6				;$B3B730
	ASL					;$B3B733
	ASL					;$B3B734
	CMP.w RAM_15E4				;$B3B735
	PHK					;$B3B738
	PLB					;$B3B739
	...
	INC.w RAM_15E4				;$B3B75B
	BRA.b CODE_B3B782			;$B3B75E

CODE_B3B760:
	DEC.w RAM_15E4				;$B3B760
...
CODE_B3B782:
	LDA.w RAM_15E6				;$B3B782
	ASL					;$B3B785
	ASL					;$B3B786
	SEC					;$B3B787
	SBC.w RAM_15E4				;$B3B788
...
CODE_B3B934:
	JSL.l input_and_pause_handler		;$B3B934
...
CODE_B3B971:
	...
	LDA.w RAM_15E4				;$B3B98E
	CMP.w #$000E				;$B3B991
	BNE.b CODE_B3B99D			;$B3B994
	LDA.w #$0001				;$B3B996
	STA.l $7EA1BA				;$B3B999
CODE_B3B99D:
	LDA.w RAM_15E4				;$B3B99D
	CMP.w #$0008				;$B3B9A0
...
CODE_B3BC48:
	JSL.l input_and_pause_handler		;$B3BC48
...
CODE_B3BC7C:
	...
	LDA.w #$0200				;$B3BC8D
	STA.b $1D				;$B3BC90
	LDA.w RAM_15EA				;$B3BC92
	DEC					;$B3BC95
	EOR.w #$8073				;$B3BC96
	XBA					;$B3BC99
	JSL.l CODE_B78012			;$B3BC9A
	BCS.b CODE_B3BCD0			;$B3BC9E
	DEC.w RAM_15EA				;$B3BCA0
	LDA.w RAM_15EA				;$B3BCA3
	BIT.w #$0003				;$B3BCA6
	BNE.b CODE_B3BCD0			;$B3BCA9
	STZ.w RAM_15EA				;$B3BCAB
...
CODE_B3BCB0:
	...
	LDA.w #$0200				;$B3BCBA
	STA.b $1D				;$B3BCBD
	LDA.w RAM_15EA				;$B3BCBF
	DEC					;$B3BCC2
	EOR.w #$0073				;$B3BCC3
	XBA					;$B3BCC6
	JSL.l CODE_B78012			;$B3BCC7
	BCS.b CODE_B3BCD0			;$B3BCCB
	DEC.w RAM_15EA				;$B3BCCD
CODE_B3BCD0:
	LDA.w RAM_15E6				;$B3BCD0
	CMP.w RAM_15E4				;$B3BCD3
	BNE.b CODE_B3BD0D			;$B3BCD6
	CMP.w RAM_15E8				;$B3BCD8
	BEQ.b CODE_B3BD0D			;$B3BCDB
	BCC.b CODE_B3BD0A			;$B3BCDD
	LDA.w RAM_15E8				;$B3BCDF
	CMP.w #$0001				;$B3BCE2
	BNE.b CODE_B3BCF7			;$B3BCE5
	LDA.w RAM_15E4				;$B3BCE7
	CMP.w #$0002				;$B3BCEA
	BNE.b CODE_B3BCF7			;$B3BCED
	LDA.w #$0003				;$B3BCEF
	STA.w RAM_15E6				;$B3BCF2
	BRA.b CODE_B3BD0D			;$B3BCF5

CODE_B3BCF7:
	DEC.w RAM_15E6				;$B3BCF7
	LDA.w RAM_15E6				;$B3BCFA
	CMP.w #$0002				;$B3BCFD
	BNE.b CODE_B3BD0D			;$B3BD00
	LDA.w #$0001				;$B3BD02
	STA.w RAM_15E6				;$B3BD05
	BRA.b CODE_B3BD0D			;$B3BD08

CODE_B3BD0A:
	INC.w RAM_15E6				;$B3BD0A
CODE_B3BD0D:
...
CODE_B3BDFD:
	...
	PLB					;$B3BE1E
	LDA.w RAM_15E6				;$B3BE1F
	CLC					;$B3BE22
	ADC.w RAM_15E4				;$B3BE23
	CMP.w #$0007				;$B3BE26
...
CODE_B3BE4D:
	LDA.w RAM_15E6				;$B3BE4D
	CLC					;$B3BE50
	ADC.w RAM_15E4				;$B3BE51
	CMP.w #$0003				;$B3BE54
	BCC.b CODE_B3BE89			;$B3BE57
	LDA.w RAM_15E4				;$B3BE59
	CLC					;$B3BE5C
	ADC.w RAM_15E6				;$B3BE5D
	CMP.w #$0009				;$B3BE60
...
CODE_B3BEC7:
	LDA.w RAM_15E6				;$B3BEC7
	CMP.w RAM_15E4				;$B3BECA
...
CODE_B3BEED:
	LDA.w RAM_15E2				;$B3BEED
	ASL					;$B3BEF0
	BRA.b CODE_B3BF4E			;$B3BEF1

CODE_B3BEF3:
	LDA.w RAM_15E2				;$B3BEF3
	SEC					;$B3BEF6
	SBC.w #$005E				;$B3BEF7
...
CODE_B3BF00:
	INC.w RAM_15E2				;$B3BF00
	LDA.w RAM_15E2				;$B3BF03
	LSR					;$B3BF06
	CLC					;$B3BF07
	ADC.w #$0034				;$B3BF08
	CMP.w #$00FE				;$B3BF0B
...
CODE_B3BF12:
	...
	REP.b #$20				;$B3BF19
	INC.w RAM_15E2				;$B3BF1B
	LDA.w RAM_15E2				;$B3BF1E
	LSR					;$B3BF21
	CMP.w #$00FE				;$B3BF22
...
CODE_B3BF29:
	...
	REP.b #$20				;$B3BF30
	INC.w RAM_15E2				;$B3BF32
	LDA.w RAM_15E2				;$B3BF35
	LSR					;$B3BF38
	CMP.w #$0034				;$B3BF39
	BNE.b CODE_B3BF4E			;$B3BF3C
CODE_B3BF3E:
	LDA.w RAM_15E6				;$B3BF3E
	STA.w RAM_15E4				;$B3BF41
	STZ.w RAM_15E2				;$B3BF44
	LDA.w #$FFFF				;$B3BF47
	STA.w RAM_15EC				;$B3BF4A
	RTS					;$B3BF4D

CODE_B3BF4E:
	STA.w RAM_15EC				;$B3BF4E
	RTS					;$B3BF51
...
CODE_B3BF82:
	JSL.l input_and_pause_handler		;$B3BF82
...
CODE_B3C243:
	...
	JSL.l input_and_pause_handler		;$B3C246
...
CODE_B3C262:
	...
	JSL.l input_and_pause_handler		;$B3C265
...
CODE_B3C281:
	JSL.l input_and_pause_handler		;$B3C281
...
CODE_B3C396:
	JSL.l input_and_pause_handler		;$B3C396
...
CODE_B3C3BF:
	JSL.l input_and_pause_handler		;$B3C3BF
...
CODE_B3C3EB:
	JSL.l input_and_pause_handler		;$B3C3EB
...
CODE_B3C417:
	JSL.l input_and_pause_handler		;$B3C417
...
CODE_B3C48B:
	JSL.l input_and_pause_handler		;$B3C48B
...
CODE_B3C4B4:
	JSL.l input_and_pause_handler		;$B3C4B4
...
CODE_B3C639:
	JSL.l input_and_pause_handler		;$B3C639
...
CODE_B3CB21:
	JSL.l input_and_pause_handler		;$B3CB21
...
CODE_B3CB46:
	JSL.l input_and_pause_handler		;$B3CB46
...
CODE_B3CC21:
	...
	AND.w #$0018				;$B3CC2F
	STA.l $7EA35E				;$B3CC32
	LDA current_song			;$B3CC36
	CMP.w #!music_baddies_on_parade		;$B3CC38
	BEQ.b CODE_B3CC57			;$B3CC3B
	LDA.w RAM_15E6				;$B3CC3D
	BIT.w #$0001				;$B3CC40
	BNE.b CODE_B3CC57			;$B3CC43
	LDA.b rng_result			;$B3CC45
	LDX.w #$0772				;$B3CC47
	BIT.w #$0001				;$B3CC4A
	BEQ.b CODE_B3CC52			;$B3CC4D
	LDX.w #RAM_0771				;$B3CC4F
CODE_B3CC52:
	TXA					;$B3CC52
...
CODE_B3CE29:
	...
	INC.w RAM_15E4				;$B3CE40
CODE_B3CE43:
	LDA.w RAM_15E4				;$B3CE43
	CMP.w #$0005				;$B3CE46
	...
	INC.w RAM_15E4				;$B3CE5A
CODE_B3CE5D:
	LDA.w RAM_15E6				;$B3CE5D
	BEQ.b CODE_B3CE7E			;$B3CE60
	LDA.w RAM_15E4				;$B3CE62
...
CODE_B3CE9D:
	LDA.w RAM_15E6				;$B3CE9D
	BNE.b CODE_B3CEB9			;$B3CEA0
	LDA.w RAM_15E4				;$B3CEA2
	CMP.w #$0003				;$B3CEA5
	BNE.b CODE_B3CEB9			;$B3CEA8
	LDA.w #$0004				;$B3CEAA
	STA.w RAM_15E4				;$B3CEAD
	LDA.w pending_dma_hdma_channels		;$B3CEB0
	EOR.w #$0600				;$B3CEB3
	STA.w pending_dma_hdma_channels		;$B3CEB6
CODE_B3CEB9:
	RTS					;$B3CEB9
...
CODE_B3CF20:
	...
	STA.w palette_upload_ring_buffer,x	;$B3CF28
	LDA.w RAM_04F3				;$B3CF2B
	STA.w RAM_06FE,x			;$B3CF2E
	LDA.b $E8				;$B3CF31
	INC					;$B3CF33
	AND.w #$000F				;$B3CF34
	STA.b $E8				;$B3CF37
...
CODE_B3CF58:
	...
	LDA.b $22				;$B3CF66
	STA.b $1D				;$B3CF68
	LDA.w RAM_15E2				;$B3CF6A
	LSR					;$B3CF6D
	CLC					;$B3CF6E
	ADC.b $2A				;$B3CF6F
	JSL.l CODE_B78012			;$B3CF71
	BCS.b CODE_B3CF8A			;$B3CF75
	LDA.w RAM_15E2				;$B3CF77
	CLC					;$B3CF7A
	ADC.b $22				;$B3CF7B
	STA.w RAM_15E2				;$B3CF7D
	CMP.b $28				;$B3CF80
	BNE.b CODE_B3CF8A			;$B3CF82
	STZ.w RAM_15E2				;$B3CF84
	INC.w RAM_15E4				;$B3CF87
CODE_B3CF8A:
	RTS					;$B3CF8A

CODE_B3CF8B:
	JSL.l input_and_pause_handler		;$B3CF8B
...
CODE_B3CFC4:
	...
	REP.b #$20				;$B3CFF6
	LDA.w RAM_15E4				;$B3CFF8
	SEC					;$B3CFFB
	SBC.w RAM_15E6				;$B3CFFC
	STA.b $1A				;$B3CFFF
	CMP.w #$8000				;$B3D001
	ROR					;$B3D004
	CLC					;$B3D005
...
CODE_B3D02C:
	...
	SBC.w #$000E				;$B3D038
	STA.b $1A				;$B3D03B
	LDA.w RAM_15E6				;$B3D03D
	SEC					;$B3D040
	SBC.w RAM_15E4				;$B3D041
	SEP.b #$20				;$B3D044
	...
	REP.b #$20				;$B3D052
	LDA.w RAM_15E6				;$B3D054
	SEC					;$B3D057
	SBC.w RAM_15E4				;$B3D058
	CMP.w #$8000				;$B3D05B
	ROR					;$B3D05E
	CLC					;$B3D05F
	ADC.w PPU.multiply_result_mid		;$B3D060
	CLC					;$B3D063
	ADC.w RAM_15E4				;$B3D064
	XBA					;$B3D067
	STA.b $1E				;$B3D068
	LDX.w #$0054				;$B3D06A
	CLC					;$B3D06D
...
CODE_B3D0BA:
	...
	SBC.w #$000E				;$B3D0C6
	STA.b $1A				;$B3D0C9
	LDA.w RAM_15E6				;$B3D0CB
	SEC					;$B3D0CE
	SBC.w RAM_15E4				;$B3D0CF
	SEP.b #$20				;$B3D0D2
	...
	REP.b #$20				;$B3D0E0
	LDA.w RAM_15E6				;$B3D0E2
	SEC					;$B3D0E5
	SBC.w RAM_15E4				;$B3D0E6
	CMP.w #$8000				;$B3D0E9
	ROR					;$B3D0EC
	CLC					;$B3D0ED
	ADC.w PPU.multiply_result_mid		;$B3D0EE
	CLC					;$B3D0F1
	ADC.w RAM_15E4				;$B3D0F2
	XBA					;$B3D0F5
	STA.b $1E				;$B3D0F6
	LDX.w #$0054				;$B3D0F8
	CLC					;$B3D0FB
...
CODE_B3D174:
	JSL.l input_and_pause_handler		;$B3D174
...
CODE_B3D1A4:
	JSL.l input_and_pause_handler		;$B3D1A4
...
CODE_B3D1E1:
	LDA.w RAM_15E6				;$B3D1E1
	BEQ.b CODE_B3D204			;$B3D1E4
	LDA.w RAM_15E4				;$B3D1E6
	CMP.w #$001F				;$B3D1E9
	BEQ.b CODE_B3D220			;$B3D1EC
	DEC.w RAM_15E8				;$B3D1EE
	LDA.w RAM_15E8				;$B3D1F1
	CMP.w #$0001				;$B3D1F4
	BCC.b CODE_B3D220			;$B3D1F7
	LDA.w #$0001				;$B3D1F9
	STA.w RAM_15E8				;$B3D1FC
	INC.w RAM_15E4				;$B3D1FF
	BRA.b CODE_B3D21D			;$B3D202

CODE_B3D204:
	DEC.w RAM_15E8				;$B3D204
	LDA.w RAM_15E8				;$B3D207
	CMP.w #$0008				;$B3D20A
	BCC.b CODE_B3D220			;$B3D20D
	LDA.w #$0008				;$B3D20F
	STA.w RAM_15E8				;$B3D212
	LDA.w RAM_15E4				;$B3D215
	BEQ.b CODE_B3D220			;$B3D218
	DEC.w RAM_15E4				;$B3D21A
CODE_B3D21D:
...
CODE_B3D571:
	JSL.l input_and_pause_handler		;$B3D571
...
CODE_B3D5B1:
	JSL.l input_and_pause_handler		;$B3D5B1
...
CODE_B3D75B:
	LDA.w RAM_15E4				;$B3D75B
	CLC					;$B3D75E
	ADC.w RAM_15E2				;$B3D75F
...
CODE_B3D768:
	...
	SBC.w #$2B00				;$B3D76D
CODE_B3D770:
	STA.w RAM_15E4				;$B3D770
	LDA.w RAM_15E2				;$B3D773
	CMP.w RAM_15E8				;$B3D776
...
CODE_B3D781:
	CLC					;$B3D781
	ADC.w #$0010				;$B3D782
	STA.w RAM_15E2				;$B3D785
CODE_B3D788:
	EOR.w #$FFFF				;$B3D788
	INC					;$B3D78B
	STA.w water_current_speed		;$B3D78C
	LDA.w RAM_15E4				;$B3D78F
	XBA					;$B3D792
	AND.w #$00FF				;$B3D793
	CLC					;$B3D796
...
DMA_sprite_graphics_global:
	LDA.w #$1801				;$B3D843
	STA.w DMA[0].settings			;$B3D846
	SEP.b #$10				;$B3D849
	LDY.b #$01				;$B3D84B
	LDX.b #$00				;$B3D84D
.next_DMA:
...
CODE_B3D87A:
	STZ.w $0088				;$B3D87A
	STZ.w $008A				;$B3D87D
	LDA.w RAM_0761				;$B3D880
	ASL					;$B3D883
	TAX					;$B3D884
	JSR.w (DATA_B38012,x)			;$B3D885
	LDA.w RAM_075C				;$B3D888
	CMP.w #$0002				;$B3D88B
	BNE.b CODE_B3D8C2			;$B3D88E
	LDA.w RAM_075E				;$B3D890
	AND.w #$00FF				;$B3D893
	CMP.w #$0003				;$B3D896
...
CODE_B3D999:
	...
	LDA.w RAM_0763				;$B3D99D
	ASL					;$B3D9A0
	TAX					;$B3D9A1
	JSR.w (DATA_B38044,x)			;$B3D9A2
	STZ.w next_sprite_dma_buffer_slot	;$B3D9A5
	RTL					;$B3D9A8
...
CODE_B3DC82:
	LDX.w #sprite_table.slot_1		;$B3DC82
	LDA.w #$0128				;$B3DC85
	JSL.l CODE_BB85C4			;$B3DC88
	LDX.w #sprite_table.slot_2		;$B3DC8C
	LDA.w #$0128				;$B3DC8F
...
CODE_B3DD51:
	LDA.w RAM_0775				;$B3DD51
	BIT.w #$0400				;$B3DD54
	BEQ.b CODE_B3DD5F			;$B3DD57
	LDA.w RAM_077B				;$B3DD59
	JSR.w CODE_B3DE89			;$B3DD5C
CODE_B3DD5F:
	LDA.w RAM_15E8				;$B3DD5F
	STA.w RAM_15E6				;$B3DD62
	STA.w RAM_15E4				;$B3DD65
	LDA.w #$7000				;$B3DD68
...
CODE_B3DD98:
	...
	LDA.w RAM_15E8				;$B3DD9E
	CMP.w #$0002				;$B3DDA1
	BNE.b CODE_B3DDB3			;$B3DDA4
	DEC					;$B3DDA6
	STA.w RAM_15E6				;$B3DDA7
	STA.w RAM_15E4				;$B3DDAA
	LDA.w #$0066				;$B3DDAD
	STA.w RAM_15E2				;$B3DDB0
CODE_B3DDB3:
	LDA.w RAM_15E8				;$B3DDB3
...
CODE_B3DE89:
	STA.l $000450				;$B3DE89
	LDX.w RAM_0793				;$B3DE8D
	LDA.l DATA_FF9E08,x			;$B3DE90
	STA.b $42				;$B3DE94
	STA.w RAM_15EC				;$B3DE96
...
CODE_B3E0EF:
	...
	REP.b #$20				;$B3E127
	LDA.w #$0801				;$B3E129
	STA.w pending_dma_hdma_channels		;$B3E12C
	RTS					;$B3E12F
...
CODE_B3E136:
	...
	REP #$20				;$B3E19E
	LDA #$1E01				;$B3E1A0
	STA pending_dma_hdma_channels		;$B3E1A3
	RTS					;$B3E1A6
...
CODE_B3E1A7:
	...
	REP #$20				;$B3E22A
	LDA #$0C01				;$B3E22C
	STA pending_dma_hdma_channels		;$B3E22F
	RTS					;$B3E232
...
CODE_B3E279:
	...
	REP #$20				;$B3E319
	LDA #$7E01				;$B3E31B
	STA pending_dma_hdma_channels		;$B3E31E
	RTS					;$B3E321
...
DATA_B3E370:
	...
	db $E0,$E0,$E0,$E0,$E0,$E0,$E0,$E0
	db $E0,$E0,$E0,$E0,$E0,$E0,$E0,$E0
	db $E0,$E0,$20,$40,$20,$40,$20,$40
	db $20,$40,$21,$40,$21,$40,$22,$40
	db $22,$40,$23,$40,$22,$40,$23,$40
	db $23,$40,$23,$40,$23,$40,$23,$40
	db $23,$40,$24,$40,$24,$40,$25,$40
	db $25,$40,$26,$40,$26,$40,$27,$40
	db $28,$40,$29,$40,$29,$40,$2A,$40
	db $2B,$40,$2C,$40,$2D,$40,$2E,$40
	db $2F,$40,$30,$40,$2F,$40,$2F,$40
	db $2F,$40,$2F,$40,$2F,$40,$2F,$40
	db $2E,$40,$2F,$40,$2E,$40,$2E,$40
	db $2D,$40,$2D,$40,$2D,$40,$2C,$40
	db $2C,$40,$2C,$40,$2D,$40,$2E,$40
	db $2F,$40,$31,$40,$31,$40,$33,$40
	db $34,$40,$35,$40,$36,$40,$38,$40
	db $39,$40,$3B,$40,$3C,$40,$3E,$40
	db $3F,$40,$3F,$40,$3F,$40,$3E,$40
	db $3D,$40,$3D,$41,$3C,$41,$3C,$42
	db $3B,$42,$3B,$43,$39,$42,$39,$43
	db $38,$43,$37,$43,$36,$43,$35,$43
	db $34,$43,$35,$44,$36,$44,$38,$45
	db $39,$45,$3B,$46,$3C,$46,$3E,$47
	db $3F,$48,$3F,$49,$3F,$49,$3F,$4A
	db $3F,$4B,$3F,$4C,$3F,$4D,$3F,$4E
	db $3F,$4F,$3F,$50,$3F,$4F,$3F,$4F
	db $3F,$4F,$3F,$4F,$3F,$4F,$3F,$4F
	db $3F,$4E,$3F,$4F,$3F,$4E,$3F,$4E
	db $3F,$4D,$3F,$4D,$3F,$4D,$3E,$4C
	db $3D,$4C,$3D,$4C,$3F,$4D,$3F,$4E
	db $3F,$4F,$3F,$51,$3F,$51,$3F,$53
	db $3F,$54,$3F,$55,$3F,$56,$3F,$58
	db $3F,$59,$3F,$5B,$3F,$5C,$3F,$5E
	db $3F,$5F,$3F,$5F,$3F,$5F,$3F,$5E
	db $3F,$5D,$3F,$5D,$3F,$5C,$3F,$5C
	db $3F,$5B,$3F,$5B,$3F,$59,$3F,$59
	db $3F,$58,$3F,$57,$3F,$56,$3F,$55
	db $3F,$54,$E0,$E0,$E0,$E0,$E0,$E0
	db $E0,$E0,$E0,$E0,$E0,$E0,$E0,$E0
	db $E0,$E0,$E0,$E0,$E0,$E0,$E0,$E0
	db $E0,$E0,$E0,$E0,$E0,$E0,$E0,$E0
	db $E0,$E0,$E0,$E0,$E0,$E0,$E0,$E0
...
DATA_B3E57A:
	db $20,$5A,$A1,$CC,$DA,$A1,$CC,$26
	db $A2,$84,$CC,$A1,$01,$5A,$A1,$00
	db $20,$5A,$A1,$CC,$DA,$A2,$CC,$26
	db $A3,$84,$D2,$A1,$01,$5A,$A1,$00
	db $20,$5A,$A1,$D4,$DA,$A3,$01,$5A
	db $A1,$00,$20,$5A,$A1,$D4,$DA,$A4
	db $01,$5B,$A1,$00
...
CODE_B3E5AE:
	...
	REP #$20				;$B3E6C9
	LDA #$7E01				;$B3E6CB
	STA pending_dma_hdma_channels		;$B3E6CE
	RTS					;$B3E6D1
...
DATA_B3E6DA:
	db $00,$00,$91,$09,$0D,$0D,$4E,$09
	db $0E,$0E,$C8,$04,$0F,$0F,$A8,$04
	db $00,$00,$92,$09,$0D,$0D,$50,$09
	db $0E,$0E,$0D,$05,$0F,$0F,$CB,$04
	db $00,$00,$73,$09,$0D,$0D,$30,$05
	db $0E,$0E,$EE,$04,$0F,$0F,$CB,$04
	db $00,$00,$75,$09,$0D,$0D,$32,$09
	db $0E,$0E,$0F,$05,$0F,$0F,$CD,$04
	db $00,$00,$76,$0D,$0D,$0D,$33,$09
	db $0E,$0E,$10,$09,$0F,$0F,$CD,$04
	db $00,$00,$77,$0D,$0D,$0D,$34,$09
	db $0E,$0E,$11,$05,$0F,$0F,$CF,$04
	db $00,$00,$78,$0D,$0D,$0D,$35,$09
	db $0E,$0E,$12,$09,$0F,$0F,$CF,$04
...
CODE_B3E750:
	...
	REP #$20				;$B3E82B
	LDA #$FE01				;$B3E82D
	STA pending_dma_hdma_channels		;$B3E830
	RTS					;$B3E833

CODE_B3E834:
	JSR.w CODE_B3E84E			;$B3E834
	LDA.w #$7801				;$B3E837
	STA.w pending_dma_hdma_channels		;$B3E83A
	RTS					;$B3E83D

CODE_B3E83E:
	JSR.w CODE_B3E84E			;$B3E83E
	LDA.w #$5C01				;$B3E841
	STA.w pending_dma_hdma_channels		;$B3E844
	LDA.w #$0001				;$B3E847
	STA.w RAM_15E2				;$B3E84A
	RTS					;$B3E84D
...
CODE_B3E8D5:
	...
	REP #$20				;$B3E94F
	LDA #$7E01				;$B3E951
	STA pending_dma_hdma_channels		;$B3E954
	RTS					;$B3E957

DATA_B3E958:
	dw $9C08, $9B08, $9A08, $9908
	dw $9808, $9708, $9608, $9508
	dw $9408, $9308, $9208, $9108
	dw $9008, $8F08, $8E08, $8D08
	dw $8C08, $8B08, $8A08, $8908
	dw $8808, $8708, $8608, $8508
	dw $8408, $8308, $8208, $8108

DATA_B3E990:
	dw $5C08, $5B08, $5A08, $5908
	dw $5808, $5708, $5608, $5508
	dw $5408, $5308, $5208, $5108
	dw $5008, $4F08, $4E08, $4D08
	dw $4C08, $4B08, $4A08, $4908
	dw $4808, $4708, $4608, $4508
	dw $4408, $4308, $4208, $4108

DATA_B3E9C8:
	dw $3008, $2F08, $2F08, $2E08
	dw $2E08, $2D08, $2D08, $2C08
	dw $2C08, $2B08, $2B08, $2A08
	dw $2A08, $2908, $2908, $2808
	dw $2808, $2708, $2708, $2608
	dw $2608, $2508, $2508, $2408
...
CODE_B3EA30:
	...
	REP #$20				;$B3EA6A
	LDA #$0201				;$B3EA6C
	STA pending_dma_hdma_channels		;$B3EA6F
	RTS					;$B3EA72
...
CODE_B3EA79:
	...
	LDA.w #$0001				;$B3EAC2
	STA.w pending_dma_hdma_channels		;$B3EAC5
	RTS					;$B3EAC8
...
CODE_B3EAC9:
	...
	REP #$20				;$B3EAE2
	LDA #$0401				;$B3EAE4
	STA pending_dma_hdma_channels		;$B3EAE7
	RTS					;$B3EAEA
...
CODE_B3EAEB:
	...
	STA incomplete_frame_game_mode_ptr	;$B3EAF3
	LDA.w #CODE_B394FF>>16			;$B3EAF5
	STA incomplete_frame_game_mode_bank	;$B3EAF8
	LDA.w #$0090				;$B3EAFA
	STA.l $7EA160				;$B3EAFD
	STA.l $7EA163				;$B3EB01
	STA.l $7EA166				;$B3EB05
...
CODE_B3EB91:
	...
	REP #$20				;$B3EC56
	LDA #$FE01				;$B3EC58
	STA pending_dma_hdma_channels		;$B3EC5B
	RTS					;$B3EC5E

DATA_B3EC5F:
	db $38,$00,$00,$00,$00,$38,$00,$00
	db $00,$00,$83,$05,$05,$C6,$39,$06
	db $06,$8B,$66,$07,$07,$2C,$6F,$2D
	db $00,$00,$08,$4A,$01,$00,$00,$80
	db $18,$00

DATA_B3EC81:
	db $38,$00,$00,$00,$00,$38,$00,$00
	db $00,$00,$83,$05,$05,$86,$3A,$06
	db $06,$4B,$67,$07,$07,$EC,$6F,$2D
	db $00,$00,$C8,$4A,$01,$00,$00,$80
	db $18,$00

DATA_B3ECA3:
	db $38,$17,$13,$38,$17,$13,$27,$15
	db $02,$09,$05,$12,$01,$04,$13,$00

CODE_B3ECB3:
	LDA #$0001				;$B3ECB3
	STA pending_dma_hdma_channels		;$B3ECB6
CODE_B3ECB9:
	LDA #$1200				;$B3ECB9
	STA $80					;$B3ECBC
	RTS					;$B3ECBE
...
CODE_B3ED3B:
	...
	REP #$20				;$B3EE84
	LDA #$FE01				;$B3EE86
	STA pending_dma_hdma_channels		;$B3EE89
	RTS					;$B3EE8C

DATA_B3EE8D:
	db $30,$E0,$30,$E0,$7F,$E6,$0E,$E6
	db $01,$E0,$01,$E0,$00

DATA_B3EE9A:
	db $30,$16,$01,$3F,$16,$01,$13,$13
	db $06,$13,$01,$16,$01,$00,$13,$00

DATA_B3EEAA:
	db $30,$02,$24,$3F,$02,$24,$10,$02
	db $21,$10,$02,$21,$01,$02,$20,$00

DATA_B3EEBA:
	db $40,$00,$00,$00,$00,$40,$00,$00
	db $00,$00,$78,$00,$00,$C6,$18,$01
	db $00,$00,$60,$18,$00
...
CODE_B3EECF:
	...
	REP #$20				;$B3EF97
	LDA #$1E01				;$B3EF99
	STA pending_dma_hdma_channels		;$B3EF9C
	RTS					;$B3EF9F
...
CODE_B3EFA0:
	...
	REP #$20				;$B3F068
	LDA #$0001				;$B3F06A
	STA pending_dma_hdma_channels		;$B3F06D
	RTS					;$B3F070
...
CODE_B3F0FE:
	...
	REP #$20				;$B3F17B
	LDA #$1E01				;$B3F17D
	STA pending_dma_hdma_channels		;$B3F180
	RTS					;$B3F183

DATA_B3F184:
	db $00,$00,$21,$04,$42,$08,$63,$0C
	db $84,$10,$A5,$14,$C6,$18,$E7,$1C
	db $08,$21,$E7,$1C,$C6,$18,$A5,$14
	db $84,$10,$63,$0C,$42,$08,$21,$04
...
CODE_B3F1B6:
	...
	REP #$20				;$B3F236
	LDA #$3E01				;$B3F238
	STA pending_dma_hdma_channels		;$B3F23B
	RTS					;$B3F23E

DATA_B3F23F:
	dw $0F0F, $3B9C, $0D0D, $2ED6
	dw $0A0A, $2652, $0707, $1DEF
	dw $0505, $0CE7, $0202, $0463
	dw $0F0F, $377B, $0D0D, $2AB5
	dw $0A0A, $2652, $0707, $1DCE
	dw $0505, $0CE7, $0202, $0463
	dw $0F0F, $375A, $0D0D, $2AB5
	dw $0A0A, $2231, $0707, $1DCE
	dw $0505, $0CE7, $0202, $0463
	dw $0F0F, $3339, $0D0D, $2A94
	dw $0A0A, $2210, $0707, $19AD
	dw $0505, $0CC6, $0202, $0463
	dw $0F0F, $3318, $0D0D, $2673
	dw $0A0A, $2210, $0707, $19AD
	dw $0505, $0CC6, $0202, $0463
	dw $0F0F, $2EF7, $0D0D, $2652
	dw $0A0A, $1DEF, $0707, $198C
	dw $0505, $0CC6, $0202, $0463
	dw $0F0F, $2ED6, $0D0D, $2652
	dw $0A0A, $1DEF, $0707, $198C
	dw $0505, $0CC6, $0202, $0463
	dw $0F0F, $2AB5, $0D0D, $2231
	dw $0A0A, $1DCE, $0707, $156B
	dw $0505, $08A5, $0202, $0442
	dw $0F0F, $2A94, $0D0D, $2210
	dw $0A0A, $19AD, $0707, $156B
	dw $0505, $08A5, $0202, $0442
	dw $0F0F, $2673, $0D0D, $1DEF
	dw $0A0A, $19AD, $0707, $154A
	dw $0505, $08A5, $0202, $0442
	dw $0F0F, $2652, $0D0D, $1DEF
	dw $0A0A, $198C, $0707, $154A
	dw $0505, $08A5, $0202, $0442
	dw $0F0F, $2231, $0D0D, $1DCE
	dw $0A0A, $156B, $0707, $1129
	dw $0505, $0884, $0202, $0442
	dw $0F0F, $2210, $0D0D, $19AD
	dw $0A0A, $156B, $0707, $1129
	dw $0505, $0884, $0202, $0442
	dw $0F0F, $1DEF, $0D0D, $198C
	dw $0A0A, $154A, $0707, $1108
	dw $0505, $0884, $0202, $0442
	dw $0F0F, $1DEF, $0D0D, $198C
	dw $0A0A, $154A, $0707, $1108
	dw $0505, $0884, $0202, $0442
	dw $0F0F, $1DCE, $0D0D, $156B
	dw $0A0A, $1129, $0707, $0CE7
	dw $0505, $0463, $0202, $0021
	dw $0F0F, $19AD, $0D0D, $154A
	dw $0A0A, $1108, $0707, $0CE7
	dw $0505, $0463, $0202, $0021
	dw $0F0F, $198C, $0D0D, $1129
	dw $0A0A, $1108, $0707, $0CC6
	dw $0505, $0463, $0202, $0021
	dw $0F0F, $156B, $0D0D, $1129
	dw $0A0A, $0CE7, $0707, $0CC6
	dw $0505, $0463, $0202, $0021
	dw $0F0F, $154A, $0D0D, $1108
	dw $0A0A, $0CC6, $0707, $08A5
	dw $0505, $0442, $0202, $0021
	dw $0F0F, $1129, $0D0D, $0CE7
	dw $0A0A, $0CC6, $0707, $08A5
	dw $0505, $0442, $0202, $0021
	dw $0F0F, $1108, $0D0D, $0CC6
	dw $0A0A, $08A5, $0707, $0884
	dw $0505, $0442, $0202, $0021
	dw $0F0F, $0CE7, $0D0D, $0CC6
	dw $0A0A, $08A5, $0707, $0884
	dw $0505, $0442, $0202, $0021
	dw $0F0F, $0CC6, $0D0D, $08A5
	dw $0A0A, $0884, $0707, $0463
	dw $0505, $0021, $0202, $0000
	dw $0F0F, $08A5, $0D0D, $0884
	dw $0A0A, $0463, $0707, $0463
	dw $0505, $0021, $0202, $0000
	dw $0F0F, $0884, $0D0D, $0463
	dw $0A0A, $0463, $0707, $0442
	dw $0505, $0021, $0202, $0000
	dw $0F0F, $0463, $0D0D, $0463
	dw $0A0A, $0442, $0707, $0442
	dw $0505, $0021, $0202, $0000
	dw $0F0F, $0442, $0D0D, $0442
	dw $0A0A, $0021, $0707, $0021
	dw $0505, $0000, $0202, $0000
	dw $0F0F, $0021, $0D0D, $0021
	dw $0A0A, $0021, $0707, $0021
	dw $0505, $0000, $0202, $0000
	dw $0F0F, $0000, $0D0D, $0000
	dw $0A0A, $0000, $0707, $0000
	dw $0505, $0000, $0202, $0000
	dw $0F0F, $0000, $0D0D, $0000
	dw $0A0A, $0000, $0707, $0000
	dw $0505, $0000, $0202, $0000
...
DATA_B3F527:
	dw $0E0E, $375A, $0B0B, $2ED6
	dw $0909, $1DEF, $0606, $156B
	dw $0303, $0CE7, $0101, $0021
	dw $0E0E, $3339, $0B0B, $2AB5
	dw $0909, $1DCE, $0606, $154A
	dw $0303, $0CE7, $0101, $0021
	dw $0E0E, $3318, $0B0B, $2AB5
	dw $0909, $1DCE, $0606, $154A
	dw $0303, $0CE7, $0101, $0021
	dw $0E0E, $2EF7, $0B0B, $2A94
	dw $0909, $19AD, $0606, $154A
	dw $0303, $0CC6, $0101, $0021
	dw $0E0E, $2ED6, $0B0B, $2673
	dw $0909, $19AD, $0606, $1129
	dw $0303, $0CC6, $0101, $0021
	dw $0E0E, $2AB5, $0B0B, $2652
	dw $0909, $198C, $0606, $1129
	dw $0303, $0CC6, $0101, $0021
	dw $0E0E, $2AB5, $0B0B, $2652
	dw $0909, $198C, $0606, $1129
	dw $0303, $0CC6, $0101, $0021
	dw $0E0E, $2A94, $0B0B, $2231
	dw $0909, $156B, $0606, $1108
	dw $0303, $08A5, $0101, $0021
	dw $0E0E, $2673, $0B0B, $2210
	dw $0909, $156B, $0606, $1108
	dw $0303, $08A5, $0101, $0021
	dw $0E0E, $2652, $0B0B, $1DEF
	dw $0909, $154A, $0606, $0CE7
	dw $0303, $08A5, $0101, $0021
	dw $0E0E, $2231, $0B0B, $1DEF
	dw $0909, $154A, $0606, $0CE7
	dw $0303, $08A5, $0101, $0021
	dw $0E0E, $2210, $0B0B, $1DCE
	dw $0909, $1129, $0606, $0CE7
	dw $0303, $0884, $0101, $0021
	dw $0E0E, $1DEF, $0B0B, $19AD
	dw $0909, $1129, $0606, $0CC6
	dw $0303, $0884, $0101, $0021
	dw $0E0E, $1DCE, $0B0B, $198C
	dw $0909, $1108, $0606, $0CC6
	dw $0303, $0884, $0101, $0021
	dw $0E0E, $1DCE, $0B0B, $198C
	dw $0909, $1108, $0606, $0CC6
	dw $0303, $0884, $0101, $0021
	dw $0E0E, $19AD, $0B0B, $156B
	dw $0909, $0CE7, $0606, $08A5
	dw $0303, $0463, $0101, $0000
	dw $0E0E, $198C, $0B0B, $154A
	dw $0909, $0CE7, $0606, $08A5
	dw $0303, $0463, $0101, $0000
	dw $0E0E, $156B, $0B0B, $1129
	dw $0909, $0CC6, $0606, $0884
	dw $0303, $0463, $0101, $0000
	dw $0E0E, $154A, $0B0B, $1129
	dw $0909, $0CC6, $0606, $0884
	dw $0303, $0463, $0101, $0000
	dw $0E0E, $1129, $0B0B, $1108
	dw $0909, $08A5, $0606, $0884
	dw $0303, $0442, $0101, $0000
	dw $0E0E, $1108, $0B0B, $0CE7
	dw $0909, $08A5, $0606, $0463
	dw $0303, $0442, $0101, $0000
	dw $0E0E, $0CE7, $0B0B, $0CC6
	dw $0909, $0884, $0606, $0463
	dw $0303, $0442, $0101, $0000
	dw $0E0E, $0CE7, $0B0B, $0CC6
	dw $0909, $0884, $0606, $0463
	dw $0303, $0442, $0101, $0000
	dw $0E0E, $0CC6, $0B0B, $08A5
	dw $0909, $0463, $0606, $0442
	dw $0303, $0021, $0101, $0000
	dw $0E0E, $08A5, $0B0B, $0884
	dw $0909, $0463, $0606, $0442
	dw $0303, $0021, $0101, $0000
	dw $0E0E, $0884, $0B0B, $0463
	dw $0909, $0442, $0606, $0021
	dw $0303, $0021, $0101, $0000
	dw $0E0E, $0463, $0B0B, $0463
	dw $0909, $0442, $0606, $0021
	dw $0303, $0021, $0101, $0000
	dw $0E0E, $0442, $0B0B, $0442
	dw $0909, $0021, $0606, $0021
	dw $0303, $0000, $0101, $0000
	dw $0E0E, $0021, $0B0B, $0021
	dw $0909, $0021, $0606, $0000
	dw $0303, $0000, $0101, $0000
	dw $0E0E, $0000, $0B0B, $0000
	dw $0909, $0000, $0606, $0000
	dw $0303, $0000, $0101, $0000
	dw $0E0E, $0000, $0B0B, $0000
	dw $0909, $0000, $0606, $0000
	dw $0303, $0000, $0101, $0000
...
CODE_B3F8C3:
	...
	REP #$20				;$B3F920
	LDA #$0E01				;$B3F922
	STA pending_dma_hdma_channels		;$B3F925
	RTS					;$B3F928
...
CODE_B3F929:
	...
	STA $80					;$B3F92F
	LDA #$0400				;$B3F931
	TRB pending_dma_hdma_channels		;$B3F934
	RTS					;$B3F937
