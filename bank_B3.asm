CODE_B38000:
	JMP.w CODE_B3D87A			;$B38000

CODE_B38003:
	JMP.w CODE_B3D999			;$B38003

CODE_B38006:
	JMP.w CODE_B3D843			;$B38006

CODE_B38009:
	JMP.w CODE_B3D9A9			;$B38009

CODE_B3800C:
	JMP.w CODE_B3C1ED			;$B3800C

CODE_B3800F:
	JMP.w CODE_B3DBC7			;$B3800F
...
CODE_B3AB52:
	...
	AND.w #$FFFE				;$B3AB5B
	STA.b $1A				;$B3AB5E
	PEA.w (($7EA52C&$FF0000)>>16)|((CODE_B3A8E4&$FF0000)>>8)	;$B3AB60
	PLB					;$B3AB63
	TSC					;$B3AB64
	STA.b $22				;$B3AB65
	LDA.w $1B65				;$B3AB67
...
CODE_B3B99D:
	...
	STA.l $7EA1BA				;$B3B9A8
CODE_B3B9AC:
	PEA.w (($7EA1DA&$FF0000)>>16)|((CODE_B3B934&$FF0000)>>8)	;$B3B9AC
	PLB					;$B3B9AF
	LDA.w #$0010				;$B3B9B0
	SEC					;$B3B9B3
	SBC.b $00				;$B3B9B4
...
CODE_B3BD0A:
	INC.w $15E6				;$B3BD0A
CODE_B3BD0D:
	PEA.w (($7EA1FA&$FF0000)>>16)|((CODE_B3BC48&$FF0000)>>8)	;$B3BD0D
	PLB					;$B3BD10
	LDA.l $0015E4				;$B3BD11
	CLC					;$B3BD15
	ADC.l $0015E6				;$B3BD16
