...
CODE_B2D3D9:
	...
	AND #!input_any_direction		;$B2D3DC
...
CODE_B2D439:
	...
	BIT #!input_any_direction		;$B2D43C
...
CODE_B2DC2E:
	...
	CLC					;$B2DC34
	ADC #$0005				;$B2DC35
	STA.w sprite.sprite_graphic,y		;$B2DC38
	LDX #$00A1				;$B2DC3B
	LDA #$0080				;$B2DC3E
	...
	CLC					;$B2DC5C
	ADC #$000A				;$B2DC5D
	STA.w sprite.sprite_graphic,y		;$B2DC60
	LDX #$00A1				;$B2DC63
	LDA #$0080				;$B2DC66
	...
	CLC					;$B2DC72
	ADC #$000F				;$B2DC73
	STA.w sprite.sprite_graphic,y		;$B2DC76
	LDX #$00A1				;$B2DC79
	LDA #$0080				;$B2DC7C
...
CODE_B2DC85:
	...
	STA.w sprite.sprite_graphic,y		;$B2DC88
	JML [$04F5]				;$B2DC8B
