...
.play_queued_sound_effect:
	...
	PHK					;$B28197
	PLB					;$B28198
	LDA.b active_frame_counter		;$B28199
	CMP.w $0438				;$B2819B
	...
	AND.w #$000E				;$B281B4
	STA.w $0434				;$B281B7
	LDA.b active_frame_counter		;$B281BA
	STA.w $0438				;$B281BC
	PLB					;$B281BF
	RTL					;$B281C0
...
CODE_B28AB7:
	...
	LDA.w #$0088				;$B28AC2
	STA.b active_frame_counter		;$B28AC5
	LDA.w #$0141				;$B28AC7
	SEC					;$B28ACA
	SBC.b active_frame_counter		;$B28ACB
	STA.l $7EA25A				;$B28ACD
	LDA.w #$FFF0				;$B28AD1
	STA.w $1973				;$B28AD4
	SEP.b #$20				;$B28AD7
...
CODE_B28B92:
	LDA.b active_frame_counter		;$B28B92
	CMP.w #$00AB				;$B28B94
	BCC.b CODE_B28BC4			;$B28B97
	LDA.b active_frame_counter		;$B28B99
	SEC					;$B28B9B
	SBC.w #$0103				;$B28B9C
	CMP.w #$003C				;$B28B9F
	BCC.b CODE_B28BC4			;$B28BA2
	LDA.b active_frame_counter		;$B28BA4
	SEC					;$B28BA6
	SBC.w #$0258				;$B28BA7
...
CODE_B291D6:
	...
	PLB					;$B291D9
	LDA.b active_frame_counter		;$B291DA
	SEC					;$B291DC
	SBC.w #$0258				;$B291DD
...
CODE_B293EF:
	...
	LDA.b active_frame_counter		;$B293F5
	BIT.w #$0001				;$B293F7
...
CODE_B29432:
	...
	STZ.w $1560				;$B2944A
	STZ.w $155E				;$B2944D
	LDA.b active_frame_counter		;$B29450
	BIT.w #$0001				;$B29452
...
CODE_B2945A:
	...
	LDY.w #$0000				;$B29463
	LDX.w #$0000				;$B29466
	LDA.b active_frame_counter		;$B29469
	BIT.w #$0001				;$B2946B
...
CODE_B29816:
	...
	ASL					;$B29828
	STA.b $3E				;$B29829
	LDA.b active_frame_counter		;$B2982B
	STA.b $1A				;$B2982D
	LDA.b $12,x				;$B2982F
	SEC					;$B29831
	SBC.b $3E				;$B29832
...
CODE_B29B66:
	...
	LDA.w #$0001				;$B29B7A
	STA.w $052F				;$B29B7D
	STZ.b active_frame_counter		;$B29B80
...
CODE_B29D83:
	...
	STZ.b active_frame_counter		;$B29D8B
	RTS					;$B29D8D
...
CODE_B2B25B:
	...
	STA.b $28,x				;$B2B27C
	LDY.w $04FB				;$B2B27E
	LDA.b active_frame_counter		;$B2B281
	STA.w $0022,y				;$B2B283
...
CODE_B2B29D:
	...
	STA.b $28,x				;$B2B2A0
	LDY.w $04FB				;$B2B2A2
	LDA.b active_frame_counter		;$B2B2A5
	STA.w $0022,y				;$B2B2A7
...
CODE_B2B473:
	...
	STA.b $28,x				;$B2B499
	LDY.w $04FB				;$B2B49B
	LDA.b active_frame_counter		;$B2B49E
	STA.w $0022,y				;$B2B4A0
...
CODE_B2B4BA:
	...
	STA.b $28,x				;$B2B4BD
	LDY.w $04FB				;$B2B4BF
	LDA.b active_frame_counter		;$B2B4C2
	STA.w $0022,y				;$B2B4C4
...
CODE_B2B629:
	...
	LDA.w #$0F00				;$B2B631
	STA.w $004A,y				;$B2B634
	LDA.b active_frame_counter		;$B2B637
	SBC.w #$0010				;$B2B639
	STA.w $0022,y				;$B2B63C
CODE_B2B63F:
...
CODE_B2B771:
	...
	STA.b $5E,x				;$B2B782
	LDY.w $04FB				;$B2B784
	LDA.b active_frame_counter		;$B2B787
	SEC					;$B2B789
	SBC.w #$0010				;$B2B78A
	STA.w $0022,y				;$B2B78D
...
CODE_B2B852:
	...
	LDA.b active_frame_counter		;$B2B85D
	STA.w $0022,y				;$B2B85F
CODE_B2B862:
	RTS					;$B2B862
...
CODE_B2B863:
	...
	LDY.w $04FB				;$B2B86C
	LDA.b active_frame_counter		;$B2B86F
	SEC					;$B2B871
	SBC.w $0022,y				;$B2B872
	CMP.w #$0010				;$B2B875
	...
	AND.w #$FFFE				;$B2B883
	STA.b $28,x				;$B2B886
	LDA.b active_frame_counter		;$B2B888
	SBC.w #$0010				;$B2B88A
	STA.w $0022,y				;$B2B88D
	INC.b $39,x				;$B2B890
	LDA.b [$6A]				;$B2B892
...
CODE_B2B8E0:
	...
	STZ.b $5E,x				;$B2B8E2
	LDY.w $04FB				;$B2B8E4
	LDA.b active_frame_counter		;$B2B8E7
	SBC.w #$0010				;$B2B8E9
	STA.w $0022,y				;$B2B8EC
	STZ.b $3A,x				;$B2B8EF
	LDA.w #$0001				;$B2B8F1
...
CODE_B2B8F9:
	...
	STZ.b $5E,x				;$B2B90E
	STZ.b $60,x				;$B2B910
	LDA.b active_frame_counter		;$B2B912
	SBC.w #$0010				;$B2B914
	LDY.w $04FB				;$B2B917
	STA.w $0022,y				;$B2B91A
	LDA.w #$0000				;$B2B91D
...
CODE_B2C983:
	LDA.w current_map_vehicle		;$B2C983
	CMP.w #!vehicle_gyrocopter		;$B2C986
...
CODE_B2C9C5:
	LDA.w current_map_vehicle		;$B2C9C5
	ASL					;$B2C9C8
	TAX					;$B2C9C9
...
CODE_B2CA5E:
	...
	ASL					;$B2CA63
	TAX					;$B2CA64
	LDA.w current_map_vehicle		;$B2CA65
	BIT.w #$0001				;$B2CA68
...
CODE_B2CAA6:
	LDA.w current_map_vehicle		;$B2CAA6
	CMP.w #!vehicle_hovercraft		;$B2CAA9
...
map_swimming_kong_splash_main:
	...
	JSL.l delete_sprite_handle_deallocation	;$B2CAD6
...
CODE_B2CB8D:
	LDA.b active_frame_counter		;$B2CB8D
	BIT.w #$0003				;$B2CB8F
...
CODE_B2CC69:
	...
	LDA.w current_map_vehicle		;$B2CC9F
	CMP.w #!vehicle_gyrocopter		;$B2CCA2
...
CODE_B2CCCC:
	...
	LDA.w current_map_vehicle		;$B2CCD0
	CMP.w #!vehicle_gyrocopter		;$B2CCD3
...
CODE_B2CCE9:
	...
	LDA.w current_map_vehicle		;$B2CD0F
	CMP.w #!vehicle_gyrocopter		;$B2CD12
...
CODE_B2CD1A:
	...
	LDA.w current_map_vehicle		;$B2CD35
	CMP.w #!vehicle_gyrocopter		;$B2CD38
...
CODE_B2CD52:
	...
	LDY.w current_map_vehicle		;$B2CD57
	CPY.w #!vehicle_turbo_ski		;$B2CD5A
...
CODE_B2CE98:
	LDA.w current_map_vehicle		;$B2CE98
	CMP.w #!vehicle_gyrocopter		;$B2CE9B
	BNE.b CODE_B2CF1D			;$B2CE9E
	LDX.b current_sprite			;$B2CEA0
	LDA.b active_frame_counter		;$B2CEA2
	BIT.w #$0001				;$B2CEA4
...
CODE_B2D00B:
	...
	STA.b $00,x				;$B2D02C
	LDY.b $3E				;$B2D02E
	LDA.b active_frame_counter		;$B2D030
	BIT.w #$0001				;$B2D032
...
CODE_B2D09A:
	LDA.b active_frame_counter		;$B2D09A
	INC					;$B2D09C
	BIT.w #$0007				;$B2D09D
...
CODE_B2D1B1:
	...
	CMP.w #$8000				;$B2D1B3
	ROR					;$B2D1B6
	LDY.w current_map_vehicle		;$B2D1B7
...
CODE_B2D219:
	...
	LDA.w current_map_vehicle		;$B2D21B
	CMP.w #!vehicle_gyrocopter		;$B2D21E
...
CODE_B2D247:
	...
	LDA.b active_frame_counter		;$B2D249
	BIT.w #$0003				;$B2D24B
...
CODE_B2D284:
	...
	LDA.b active_frame_counter		;$B2D28E
	BIT.w #$0003				;$B2D290
	BNE.b CODE_B2D2A9			;$B2D293
	LSR					;$B2D295
	AND.w #$000F				;$B2D296
	TAX					;$B2D299
	LDA.w current_map_vehicle		;$B2D29A
	CMP.w #!vehicle_gyrocopter		;$B2D29D
...
CODE_B2D2B9:
	LDA.w current_map_vehicle		;$B2D2B9
	CMP.w #!vehicle_gyrocopter		;$B2D2BC
...
CODE_B2D425:
	LDA.w current_map_vehicle		;$B2D425
...
CODE_B2D439:
	...
	STA.b $26				;$B2D44F
	LDA.b $68,x				;$B2D451
	LDY.w current_map_vehicle		;$B2D453
...
CODE_B2D464:
	AND.w #$03FF				;$B2D464
	LDY.w current_map_vehicle		;$B2D467
	CPY.w #!vehicle_gyrocopter		;$B2D46A
...
CODE_B2D538:
	LDA.b active_frame_counter		;$B2D538
	STA.w $1C37				;$B2D53A
	LDA.w $1C35				;$B2D53D
	BIT.w #$4000				;$B2D540
...
CODE_B2D5A2:
	...
	CLC					;$B2D5A8
	ADC.w $1C37				;$B2D5A9
	CMP.b active_frame_counter		;$B2D5AC
...
CODE_B2DA04:
	...
	ORA.w #$2000				;$B2DA0E
	STA.w $005C,y				;$B2DA11
	STZ.b active_frame_counter		;$B2DA14
...
CODE_B2DA7D:
	...
	ADC.w #$0020				;$B2DA81
	STA.b $1A				;$B2DA84
	LDA.b active_frame_counter		;$B2DA86
	AND.w #$01F8				;$B2DA88
	LSR					;$B2DA8B
	LSR					;$B2DA8C
	LSR					;$B2DA8D
	STA.b $1E				;$B2DA8E
	LDA.b active_frame_counter		;$B2DA90
	AND.w #$0007				;$B2DA92
	EOR.w #$FFFF				;$B2DA95
	INC					;$B2DA98
	CLC					;$B2DA99
...
CODE_B2DAAE:
	...
	LDA.b active_frame_counter		;$B2DADA
	BIT.w #$0003				;$B2DADC
	BNE.b CODE_B2DAF4			;$B2DADF
	LDA.b active_frame_counter		;$B2DAE1
	AND.w #$000C				;$B2DAE3
	ASL					;$B2DAE6
	TAY					;$B2DAE7
	LDX.w #$7EA90B				;$B2DAE8
...
unknown_sprite_0360_main:
	...
	JSL.l delete_sprite_handle_deallocation	;$B2DE91
CODE_B2DE95:
	JML [$04F5]				;$B2DE95
...
.init:
	...
	LDA sprite.unknown_5C,x			;$B2E560   |
	AND #$000F				;$B2E562   |
	CMP #$0004				;$B2E565   |
...
.init:
	...
	LDA #$0006				;$B2E5B7   |
	STA sprite.unknown_62,x			;$B2E5BA   |
	LDA #$0070				;$B2E5BC   |
...
.update_timer:
	...
	AND #$0007				;$B2E5FA   |
	STA sprite.unknown_64,x			;$B2E5FD   |
	DEC sprite.unknown_62,x			;$B2E5FF   |
	BNE ..return				;$B2E601   |
	LDA #$0006				;$B2E603   |
	STA sprite.unknown_62,x			;$B2E606   |
	LDA $0535				;$B2E608   |
	SEP #$28				;$B2E60B   |
	ADC #$01				;$B2E60D   |
	STA $0535				;$B2E60F   |
...
CODE_B2E9A5:
	JSL.l delete_sprite_handle_deallocation	;$B2E9A5
	JML [$04F5]				;$B2E9A9
...
CODE_B2F420:
	...
	STZ.b $26,x				;$B2F42D
CODE_B2F42F:
	LDA.b active_frame_counter		;$B2F42F
	BIT.w #$0007				;$B2F431
...
mama_bird_barrier_gem_main:
	...
	JSL.l delete_sprite_handle_deallocation	;$B2F67E
...
CODE_B2F80B:
	LDA.b active_frame_counter		;$B2F80B
	BIT.w #$001F				;$B2F80D
