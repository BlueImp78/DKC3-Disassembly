...
CODE_B2BFA5:
	...
	JSL.l process_current_movement		;$B2BFAD
...
CODE_B2BFE0:
	LDA.w #$0012				;$B2BFE0
	JSL.l process_alternate_movement	;$B2BFE3
...
CODE_B2C008:
	LDA.w #$0003				;$B2C008
	JSL.l process_alternate_movement	;$B2C00B
	RTS					;$B2C00F

CODE_B2C010:
	LDA.w #$0012				;$B2C010
	JSL.l process_alternate_movement	;$B2C013
...
CODE_B2C037:
	LDA.w #$0012				;$B2C037
	JSL.l process_alternate_movement	;$B2C03A
...
map_kong_main:
	...
	JSL.l process_current_movement		;$B2C09E
CODE_B2C0A2:
...
CODE_B2C1FA:
	...
	LDA.w #$060D				;$B2C204
	JSL.l queue_sound_effect		;$B2C207
	LDA.w #$0080				;$B2C20B
	STA.w $1C39				;$B2C20E
...
CODE_B2C2FF:
	...
	STA.b $38,x				;$B2C309
	LDA.w #$0769				;$B2C30B
	JSL.l queue_sound_effect		;$B2C30E
	RTS					;$B2C312
...
CODE_B2C34B:
	LDA.w #$066C				;$B2C34B
	JSL.l queue_sound_effect		;$B2C34E
CODE_B2C352:
	STZ.b $38,x				;$B2C352
	LDA.w #$FE01				;$B2C354
	STA.w $04E4				;$B2C357
...
CODE_B2C3E1:
	...
	LDA.w #$076A				;$B2C3FB
	JSL.l queue_sound_effect		;$B2C3FE
CODE_B2C402:
	RTS					;$B2C402
...
CODE_B2C448:
	...
	LDA.w #$076A				;$B2C454
	JSL.l queue_sound_effect		;$B2C457
CODE_B2C45B:
...
CODE_B2C469:
	...
	JSL.l process_current_movement		;$B2C479
...
CODE_B2C4D9:
	LDA.w #$056B				;$B2C4D9
	JSL.l queue_sound_effect		;$B2C4DC
CODE_B2C4E0:
	RTS					;$B2C4E0
...
CODE_B2C519:
	...
	LDA.w #$076A				;$B2C53F
	JSL.l queue_sound_effect		;$B2C542
CODE_B2C546:
	RTS					;$B2C546
...
CODE_B2C60D:
	...
	LDA.w $0016,y				;$B2C629
	STA.l $7EA224				;$B2C62C
	JSL.l process_current_movement		;$B2C630
...
CODE_B2C753:
	...
	STA.w $1C57				;$B2C77C
	LDA.w #$0500				;$B2C77F
	JSL.l queue_sound_effect		;$B2C782
CODE_B2C786:
...
CODE_B2C983:
	...
	LDA.w #$0767				;$B2C996
	JSL.l queue_sound_effect		;$B2C999
CODE_B2C99D:
	RTS					;$B2C99D
...
CODE_B2C9C5:
	...
	JSL.l queue_sound_effect		;$B2C9CD
	RTS					;$B2C9D1
...
CODE_B2CCCC:
	JSL.l process_current_movement		;$B2CCCC
...
CODE_B2CD1A:
	...
	LDA.w $0016,y				;$B2CD2A
	STA.l $7EA224				;$B2CD2D
	JSL.l process_current_movement		;$B2CD31
...
CODE_B2D604:
	JSL.l process_current_movement		;$B2D604
...
CODE_B2D65E:
	LDA.w #$0012				;$B2D65E
	JSL.l process_alternate_movement	;$B2D661
...
CODE_B2D6DF:
	LDA.w #$0012				;$B2D6DF
	JSL.l process_alternate_movement	;$B2D6E2
...
knautilus_sprite_mask_main:
	JSL.l process_current_movement		;$B2D6FC
	JML [$04F5]				;$B2D700
...
CODE_B2EE8C:
	...
	LDY.w #$7E2F80				;$B2EEB8
	LDA.w #$000F				;$B2EEBB
	MVN $7E2F80>>16,dixie_sprite_palettes>>16		;$B2EEBE
	LDA.w #$0566				;$B2EEC1
...
CODE_B2F3F9:
	...
	LDA.w #$0777				;$B2F419
	JSL.l queue_sound_effect		;$B2F41C
CODE_B2F420:
	TYX					;$B2F420
	LDA.b $58,x				;$B2F421
...
CODE_B2F42F:
	...
	JSL.l queue_sound_effect		;$B2F442
	LDA.w #$0100				;$B2F446
	TSB.w $05FD				;$B2F449
CODE_B2F44C:
	JML [$04F5]				;$B2F44C
...
mama_bird_barrier_gem_main:
	...
	LDA.w #$037A				;$B2F65B
	JSL.l queue_sound_effect		;$B2F65E
	LDA.w #$040C				;$B2F662
	JSL.l queue_sound_effect		;$B2F665
	LDA.w #$050F				;$B2F669
	JSL.l queue_sound_effect		;$B2F66C
	LDA.w #$0629				;$B2F670
	JSL.l queue_sound_effect		;$B2F673
	LDA.w #$074F				;$B2F677
	JSL.l queue_sound_effect		;$B2F67A
...
CODE_B2F7D4:
	...
	STA.w $005E,y				;$B2F801
CODE_B2F804:
	JSL.l process_current_movement		;$B2F804
	JML [$04F5]				;$B2F808
...
CODE_B2F9E6:
	JSL.l process_current_movement		;$B2F9E6
