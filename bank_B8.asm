...
CODE_B8805A:
	JMP.w CODE_B89C62			;$B8805A

CODE_B8805D:
	JMP.w CODE_B89CBD			;$B8805D

CODE_B88060:
	JMP.w CODE_B8E198			;$B88060

CODE_B88063:
	JMP.w CODE_B8E369			;$B88063

CODE_B88066:
	JMP.w CODE_B8E3A3			;$B88066

CODE_B88069:
	JMP.w CODE_B882B6			;$B88069

CODE_B8806C:
	JMP.w CODE_B882E6			;$B8806C

CODE_B8806F:
	JMP.w CODE_B89EC6			;$B8806F

CODE_B88072:
	JMP.w CODE_B89EFB			;$B88072

CODE_B88075:
	JMP.w CODE_B8E15A			;$B88075

CODE_B88078:
	JMP.w CODE_B8E179			;$B88078

CODE_B8807B:
	JMP.w CODE_B8E22A			;$B8807B

CODE_B8807E:
	JMP.w CODE_B8837A			;$B8807E

CODE_B88081:
	JMP.w CODE_B880DB			;$B88081

CODE_B88084:
	JMP.w CODE_B880CE			;$B88084

CODE_B88087:
	JMP.w CODE_B880C0			;$B88087

CODE_B8808A:
	JMP.w CODE_B880F1			;$B8808A

CODE_B8808D:
	JMP.w CODE_B880FA			;$B8808D

CODE_B88090:
	JMP.w CODE_B8810B			;$B88090

CODE_B88093:
	JMP.w CODE_B8906D			;$B88093

CODE_B88096:
	JMP.w CODE_B8E587			;$B88096

CODE_B88099:
	JMP.w CODE_B8E5B3			;$B88099

CODE_B8809C:
	JMP.w CODE_B8EF54			;$B8809C

CODE_B8809F:
	JMP.w CODE_B89C4C			;$B8809F

CODE_B880A2:
	JMP.w CODE_B8EFE7			;$B880A2

CODE_B880A5:
	JMP.w CODE_B8E25D			;$B880A5

CODE_B880A8:
	JMP.w CODE_B88368			;$B880A8

CODE_B880AB:
	JMP.w CODE_B88A97			;$B880AB

CODE_B880AE:
	JMP.w CODE_B8E5A6			;$B880AE

CODE_B880B1:
	JMP.w CODE_B8C91E			;$B880B1

CODE_B880B4:
	JMP.w CODE_B88307			;$B880B4

CODE_B880B7:
	JMP.w CODE_B8831A			;$B880B7

CODE_B880BA:
	JMP.w CODE_B8813B			;$B880BA

CODE_B880BD:
	JMP.w CODE_B8821D			;$B880BD
...
CODE_B88163:
	...
	CPY.w $0503 				;$B88165 / Compare with index of kiddy
	BNE.b CODE_B8816D 			;$B88168 / If not, branch
	JMP.w CODE_B881CB 			;$B8816A / Else do some other shit

CODE_B8816D:
	LDA.w $0000,y 				;$B8816D / Get id of standable sprite	
	CMP.w #$02D4  				;$B88170 / Check if its the steel keg
...
CODE_B882E6:
	LDA.w $05AF				;$B882E6
	AND.w #$0001				;$B882E9
	BEQ.b CODE_B882F6			;$B882EC
	LDA.w screen_brightness			;$B882EE
	BNE.b CODE_B882F6			;$B882F1
	JMP.w CODE_B88336			;$B882F3

CODE_B882F6:
	PHK					;$B882F6
	PLB					;$B882F7
	LDA.w $17C6				;$B882F8
	BNE.b CODE_B882FE			;$B882FB
	RTL					;$B882FD
...
CODE_B88D72:
	...
	INC					;$B88D77
	ORA.b $1A				;$B88D78
	STA.w !REGISTER_Multiplicand		;$B88D7A
	LDA.w !REGISTER_ProductOrRemainderLo	;$B88D7D
	LDA.w !REGISTER_ProductOrRemainderLo	;$B88D80
	EOR.w #$FFFF				;$B88D83
	INC					;$B88D86
	RTS					;$B88D87
...
CODE_B88D88:
	ORA.b $1A				;$B88D88
	STA.w !REGISTER_Multiplicand		;$B88D8A
	LDA.w !REGISTER_ProductOrRemainderLo	;$B88D8D
	LDA.w !REGISTER_ProductOrRemainderLo	;$B88D90
	RTS					;$B88D93
...
CODE_B89CBD:
	...
	LDA.l DATA_FF1840			;$B89CE8
	STA.w $1488				;$B89CEC
	LDA.l DATA_FF1840+$08			;$B89CEF
	STA.w $148A				;$B89CF3
	LDA.w $0775				;$B89CF6
	AND.w #$0800				;$B89CF9
...
CODE_B89D01:
	...
	LDA.l DATA_FF1840+$02			;$B89D31
	STA.w $14DA				;$B89D35
	LDA.l DATA_FF1840+$0A			;$B89D38
	STA.w $14DC				;$B89D3C
	LDA.w $0775				;$B89D3F
	AND.w #$0800				;$B89D42
...
CODE_B89EC6:
	...
	LDA.l DATA_FF1840			;$B89ED2
	STA.w $1488				;$B89ED6
	LDA.l DATA_FF1840+$08			;$B89ED9
	STA.w $148A				;$B89EDD
	LDA.w #$14D2				;$B89EE0
	STA.b $72				;$B89EE3
	LDY.w #$01F2				;$B89EE5
	JSL.l CODE_BB8585			;$B89EE8
	LDA.l DATA_FF1840+$02			;$B89EEC
	STA.w $14DA				;$B89EF0
	LDA.l DATA_FF1840+$0A			;$B89EF3
	STA.w $14DC				;$B89EF7
	RTL					;$B89EFA
...
CODE_B89F3A:
	...
	ASL					;$B89F4B
	TAX					;$B89F4C
	JMP.w (DATA_B8A191,x)			;$B89F4D

CODE_B89F50:
	LDA.w #$0003				;$B89F50
	JSL.l CODE_B9E00F			;$B89F53
	LDA.w #$0003				;$B89F57
	JSL.l CODE_B9E012			;$B89F5A
...
CODE_B8A371:
	LDX.w active_kong_sprite		;$B8A371
	LDA.b $38,x				;$B8A374
	ASL					;$B8A376
	ASL					;$B8A377
	TAX					;$B8A378
	LDA.l DATA_B8A191+$02,x			;$B8A379
	RTS					;$B8A37D
...
CODE_B8B337:
	...
	XBA					;$B8B33B
	SEP.b #$20				;$B8B33C
	STA.w !REGISTER_Multiplicand		;$B8B33E
	LDA.b #$20				;$B8B341
	STA.w !REGISTER_Multiplier		;$B8B343
	REP.b #$20				;$B8B346
	LDA.w $04A8				;$B8B348
	LSR					;$B8B34B
	STA.b $1A				;$B8B34C
	LDA.w !REGISTER_ProductOrRemainderLo	;$B8B34E
	ASL					;$B8B351
	ASL					;$B8B352
	ASL					;$B8B353
	AND.w #$FF00				;$B8B354
...
CODE_B8BA8A:
	SEP.b #$20				;$B8BA8A
	STA.w !REGISTER_Multiplicand		;$B8BA8C
	STX.w !REGISTER_Multiplier		;$B8BA8F
	PLX					;$B8BA92
	NOP					;$B8BA93
	REP.b #$20				;$B8BA94
	LDA.w !REGISTER_ProductOrRemainderLo	;$B8BA96
	STA.w !REGISTER_DividendLo		;$B8BA99
	STX.w !REGISTER_Divisor			;$B8BA9C
	LDA.b ($00)				;$B8BA9F
	LDA.b ($00)				;$B8BAA1
	LDA.b $00				;$B8BAA3
	LDA.w !REGISTER_QuotientLo		;$B8BAA5
	DEY					;$B8BAA8
...
CODE_B8C232:
	...
	EOR.w #$FFFF				;$B8C237
	INC					;$B8C23A
	STA.w !REGISTER_DividendLo		;$B8C23B
	SEP.b #$20				;$B8C23E
	TYA					;$B8C240
	STA.w !REGISTER_Divisor			;$B8C241
	REP.b #$20				;$B8C244
	LDA.b [$00]				;$B8C246
	LDA.b ($00)				;$B8C248
	LDA.w !REGISTER_QuotientLo		;$B8C24A
	EOR.w #$FFFF				;$B8C24D
	INC					;$B8C250
	RTS					;$B8C251

CODE_B8C252:
	STA.w !REGISTER_DividendLo		;$B8C252
	SEP.b #$20				;$B8C255
	TYA					;$B8C257
	STA.w !REGISTER_Divisor			;$B8C258
	REP.b #$20				;$B8C25B
	LDA.b [$00]				;$B8C25D
	LDA.b ($00)				;$B8C25F
	LDA.w !REGISTER_QuotientLo		;$B8C261
	RTS					;$B8C264
...
check_sprite_underwater:
	LDX.b $70				;$B8C73A
	LDA.w $050F				;$B8C73C
	BMI.b .no_water				;$B8C73F
	SEC					;$B8C741
	SBC.b $16,x				;$B8C742
	CMP.w #$FFEC				;$B8C744
	BMI.b .in_water				;$B8C747
	CMP.w #$FFF8				;$B8C749
	BPL.b .no_water				;$B8C74C
	LDA.w #$0001				;$B8C74E
	RTS					;$B8C751
...
CODE_B8D6B9:
	...
	LDY.b $72 				;$B8D6E3 / get pointer to kong control variables
	LDA.b $00				;$B8D6E5
	STA.w $0012,y				;$B8D6E7
...
CODE_B8EB26:
	...
	LDA.w #$0009				;$B8EB30
	JSL.l CODE_B9E00F			;$B8EB33
	LDA.w #$000C				;$B8EB37
	JSL.l CODE_B9E012			;$B8EB3A
...
CODE_B8F0C5:
	XBA					;$B8F0C5
	STA.w !REGISTER_DividendLo		;$B8F0C6
	SEP.b #$20				;$B8F0C9
	LDA.b $22				;$B8F0CB
	DEC					;$B8F0CD
	STA.w !REGISTER_Divisor			;$B8F0CE
	REP.b #$20				;$B8F0D1
	LDA.w !REGISTER_QuotientLo		;$B8F0D3
	LDA.w !REGISTER_QuotientLo		;$B8F0D6
	LDY.w #$0000				;$B8F0D9
	LDA.w !REGISTER_QuotientLo		;$B8F0DC
	RTS					;$B8F0DF
