...
CODE_B880C0:
	...
	EOR.b #$FF				;$B880C2
	SEC					;$B880C4
	ADC.w hud_lives_to_add			;$B880C5
	STA.w hud_lives_to_add			;$B880C8
	REP.b #$20				;$B880CB
	RTL					;$B880CD
...
CODE_B880CE:
	...
	PHA					;$B880D0
	CLC					;$B880D1
	ADC.w hud_lives_to_add			;$B880D2
	STA.w hud_lives_to_add			;$B880D5
	PLA					;$B880D8
	REP.b #$20				;$B880D9
CODE_B880DB:
	CLC					;$B880DB
	ADC.w lives_count			;$B880DC
	STA.w lives_count			;$B880DF
	LDA.w hud_lives_display_timer		;$B880E2
	BNE.b CODE_B880EA			;$B880E5
	STZ.w RAM_18D9				;$B880E7
CODE_B880EA:
	LDA.w #$0078				;$B880EA
	STA.w hud_lives_display_timer		;$B880ED
	RTL					;$B880F0

CODE_B880F1:
	LDA.w #$2000				;$B880F1
	TSB.w game_state_flags			;$B880F4
	BEQ.b CODE_B880FA			;$B880F7
	RTL					;$B880F9

CODE_B880FA:
	DEC.w lives_count			;$B880FA
	LDA.w #$0078				;$B880FD
	STA.w hud_lives_display_timer		;$B88100
	SEP.b #$20				;$B88103
	INC.w $18D4				;$B88105
	REP.b #$20				;$B88108
	RTL					;$B8810A
...
CODE_B8810B:
	LDA.w #$8000				;$B8810B
	TSB.w RAM_044A				;$B8810E
	BNE.b CODE_B88136			;$B88111
	LDA.w RAM_075C				;$B88113
	AND.w #$00FF				;$B88116
	CMP.w #$0003				;$B88119
...
CODE_B8813B:
	LDA.b sprite.terrain_interaction,x	;$B8813B
	AND.w #$1010 				;$B8813D / Check if on a standable sprite
	BEQ.b CODE_B88180 			;$B88140 / If not, branch
	LDA.w RAM_0777 				;$B88142 / Get level properties?
	AND.w #$0400 				;$B88145 / Check bit 4 and 8
	BEQ.b CODE_B88163 			;$B88148 / If not set branch
	LDA.b sprite.y_position,x 		;$B8814A / Else get Y position
	SEC					;$B8814C
	SBC.w RAM_1883				;$B8814D
	CMP.w #$0010				;$B88150
	BCC.b CODE_B88163			;$B88153
	STZ.b sprite.max_x_speed,x		;$B88155
	LDA.b sprite.x_speed,x			;$B88157
	CMP.w #$8000				;$B88159
	ROR					;$B8815C
	CMP.w #$8000				;$B8815D
	ROR					;$B88160
	STA.b sprite.x_speed,x			;$B88161
CODE_B88163:
	LDY.b sprite.general_purpose_4C,x 	;$B88163 / Get index to platform sprite in sprite that is on it
	CPY.w RAM_0503 				;$B88165
	BNE.b CODE_B8816D 			;$B88168
	JMP.w CODE_B881CB 			;$B8816A

CODE_B8816D:
	LDA.w sprite.type,y 			;$B8816D / Get id of standable sprite
	CMP.w #!sprite_steel_keg  		;$B88170 / Check if its the steel keg
	BNE.b CODE_B88180 			;$B88173 / If not, branch
	LDA.w sprite.state,y 			;$B88175 / Else get steel keg state
	CMP.w #$0005				;$B88178
...
CODE_B881A6:
	...
	LDA.w #!kong_state_10			;$B881AB
	STA.b sprite.state,x			;$B881AE
	LDA.w #$0026				;$B881B0
...
CODE_B881BB:
	LDA.w #!kong_state_3F			;$B881BB
	STA.b sprite.state,x			;$B881BE
	LDA.w #$002B				;$B881C0
...
CODE_B881CB:
	...
	LDA.w #!kong_state_52			;$B881CF
	STA.b sprite.state,x			;$B881D2
	LDA.w #$0036				;$B881D4
...
CODE_B881DF:
	...
	LDA.w #!kong_state_57			;$B881EB
	STA.b sprite.state,x			;$B881EE
	LDA.w #$0006				;$B881F0
...
CODE_B881FB:
	...
	LDA.b sprite.y_speed,x			;$B88206
	CMP.w #$8000				;$B88208
	ROR.b sprite.y_speed,x			;$B8820B
	LDA.w #$0031				;$B8820D
	JSL.l set_anim_handle_kiddy		;$B88210
	LDA.w #!kong_state_44			;$B88214
	STA.b sprite.state,x			;$B88217
	JSR.w CODE_B8E2DD			;$B88219
	RTL					;$B8821C

CODE_B8821D:
	LDA.b sprite.terrain_interaction,x	;$B8821D
	AND.w #$1010				;$B8821F
	BEQ.b CODE_B88280			;$B88222
	LDA.w RAM_0777				;$B88224
	AND.w #$0400				;$B88227
	BEQ.b CODE_B88245			;$B8822A
	LDA.b sprite.y_position,x		;$B8822C
	SEC					;$B8822E
	SBC.w RAM_1883				;$B8822F
	CMP.w #$0010				;$B88232
	BCC.b CODE_B88245			;$B88235
	STZ.b sprite.max_x_speed,x		;$B88237
	LDA.b sprite.x_speed,x			;$B88239
	CMP.w #$8000				;$B8823B
	ROR					;$B8823E
	CMP.w #$8000				;$B8823F
	ROR					;$B88242
	STA.b sprite.x_speed,x			;$B88243
CODE_B88245:
	LDY.b sprite.general_purpose_4C,x	;$B88245
	LDA.w sprite.type,y			;$B88247
	CMP.w #!sprite_steel_keg		;$B8824A
	BNE.b CODE_B88280			;$B8824D
	LDA.w sprite.state,y			;$B8824F
	CMP.w #$0005				;$B88252
	BNE.b CODE_B88280			;$B88255
	JSR.w CODE_B89071			;$B88257
	LDA.b sprite.y_speed,x			;$B8825A
	CMP.w #$8000				;$B8825C
	ROR.b sprite.y_speed,x			;$B8825F
	...
	LDA.w #!kong_state_24			;$B88272
	CPY.w #!sprite_ellie			;$B88275
	BEQ.b CODE_B8827D			;$B88278
	LDA.w #!kong_state_68			;$B8827A
CODE_B8827D:
	STA.b sprite.state,x			;$B8827D
	RTL					;$B8827F

CODE_B88280:
	LDA.w #!kong_state_67			;$B88280
	LDY.b current_animal_type		;$B88283
	CPY.w #!sprite_squitter			;$B88285
	BEQ.b CODE_B88295			;$B88288
	LDA.w #!kong_state_23			;$B8828A
	LDY.w current_held_sprite		;$B8828D
	BEQ.b CODE_B88295			;$B88290
	LDA.w #!kong_state_26			;$B88292
CODE_B88295:
	STA.b sprite.state,x			;$B88295
	LDA.w #$0007				;$B88297
	JSL.l set_anim_handle_animal_and_kiddy	;$B8829A
	RTL					;$B8829E

CODE_B8829F:
	EOR.b sprite.render_order,x		;$B8829F
	AND.w #$FFBF				;$B882A1
	EOR.b sprite.render_order,x		;$B882A4
	STA.b sprite.render_order,x		;$B882A6
	RTS					;$B882A8

CODE_B882A9:
	EOR.w sprite.render_order,y		;$B882A9
	AND.w #$FFBF				;$B882AC
	EOR.w sprite.render_order,y		;$B882AF
	STA.w sprite.render_order,y		;$B882B2
	RTS					;$B882B5
...
CODE_B882B6:
	...
	CMP.w #!player_interaction_2B		;$B882BD
	BCS.b CODE_B882DA			;$B882C0
	PHX					;$B882C2
	PHA					;$B882C3
	LDX.w active_kong_sprite		;$B882C4
	LDA.b sprite.state,x			;$B882C7
	ASL					;$B882C9
CODE_B882CA:
	ASL					;$B882CA
	TAX					;$B882CB
...
CODE_B8837A:
	LDA.w #$0001				;$B8837A
	TSB.w game_state_flags			;$B8837D
	BNE.b CODE_B88389			;$B88380
	LDA.w #$820F				;$B88382
	JSL.l set_screen_fade			;$B88385
CODE_B88389:
	RTL					;$B88389

player_interaction_28:
	LDX.w RAM_1B63				;$B8838A
	...
	LDA.w #$0001				;$B883A4
	STA.w RAM_195D				;$B883A7
	LDA.w RAM_17CA				;$B883AA
	AND.w #$4000				;$B883AD
	BEQ.b CODE_B883C4			;$B883B0
	ORA.b $1E,x				;$B883B2
	STA.b $1E,x				;$B883B4
	LDA.w RAM_196D				;$B883B6
	CLC					;$B883B9
	ADC.w #$0010				;$B883BA
	STA.w RAM_195F				;$B883BD
...
CODE_B883C4:
	...
	AND.w #$BFFF				;$B883C6
	STA.b $1E,x				;$B883C9
	LDA.w RAM_196D				;$B883CB
	CLC					;$B883CE
	ADC.w #$00F0				;$B883CF
	STA.w RAM_195F				;$B883D2
...
CODE_B883E9:
	...
	STZ.w RAM_1929				;$B883FB
	LDA.w #$0020				;$B883FE
	STA.w RAM_192B				;$B88401
...
player_interaction_1D:
	...
	LDA.w RAM_17CA				;$B884CC
	STA.w RAM_195B				;$B884CF
	LDA.w #$0001				;$B884D2
	STA.w RAM_195D				;$B884D5
	LDA.w RAM_17CC				;$B884D8
	STA.w RAM_195F				;$B884DB
	LDA.w RAM_17CE				;$B884DE
	STA.w RAM_1961				;$B884E1
	LDA.w RAM_195F				;$B884E4
	SEC					;$B884E7
	SBC.b $12,x				;$B884E8
	LSR					;$B884EA
	EOR.b $1E,x				;$B884EB
...
CODE_B88533:
	STZ.w RAM_04AA				;$B88533
	STZ.w RAM_04AE				;$B88536
	LDX.w RAM_17C8				;$B88539
	STX.b current_mount			;$B8853C
	STX.b current_sprite			;$B8853E
	LDA.b sprite.type,x			;$B88540
...
CODE_B8856B:
	...
	STA.w kong_animal_x_offset		;$B88578
	STA.w RAM_188D				;$B8857B
	LDA.l DATA_B88783+$02,x			;$B8857E
	STA.w kong_animal_y_offset		;$B88582
	STA.w RAM_188F				;$B88585
	TYX					;$B88588
	LDA.l DATA_B88783,x			;$B88589
	SEC					;$B8858D
	SBC.w kong_animal_x_offset		;$B8858E
	STA.w RAM_1887				;$B88591
	LDA.l DATA_B88783+$02,x			;$B88594
	SEC					;$B88598
	SBC.w kong_animal_y_offset		;$B88599
	STA.w RAM_188B				;$B8859C
...
CODE_B885D5:
	...
	LDA.w #$0023				;$B885D8
	STA.b $38,x				;$B885DB
	STZ.w ellie_ammo_count			;$B885DD
	LDX.w RAM_17C8				;$B885E0
	LDA.w #$FFC0				;$B885E3
...
CODE_B885EE:
	CLC					;$B885EE
	ADC.b $16,x				;$B885EF
	STA.w RAM_187D				;$B885F1
	STA.w RAM_187F				;$B885F4
	RTS					;$B885F7
...
CODE_B886B0:
	...
	STA.w kong_control.jump_event_time,y	;$B88709
	LDA.w #$0009				;$B8870C
...
CODE_B88860:
	...
	STA.w kong_control.jump_event_time,y	;$B88878
	LDA.w #$0009				;$B8887B
	JSL.l set_anim_handle_kiddy		;$B8887E
	LDA.w #!kong_state_02			;$B88882
	STA.b sprite.state,x			;$B88885
	RTS					;$B88887

CODE_B88888:
	LDA.w game_state_flags			;$B88888
	AND.w #$4000				;$B8888B
	BEQ.b CODE_B888AF			;$B8888E
	JSL.l CODE_B89C3C			;$B88890
	LDA.w #!kong_state_33			;$B88894
	STA.b sprite.state,x			;$B88897
	LDA.w #$0001				;$B88899
	LDX.w #$0037				;$B8889C
	LDY.w #$0000				;$B8889F
...
CODE_B88950:
	...
	LDA.w RAM_17CC				;$B8895A
	STA.b $62,x				;$B8895D
	LDA.w RAM_17CE				;$B8895F
	STA.b $64,x				;$B88962
	LDA.w RAM_17D0				;$B88964
	STA.b $66,x				;$B88967
	LDA.w RAM_17D2				;$B88969
	STA.b $6A,x				;$B8896C
	CLC					;$B8896E
	RTL					;$B8896F
...
player_interaction_1A:
	...
	LDX.w RAM_17C8				;$B8897C
	STX.b current_sprite			;$B8897F
	LDA.w RAM_17CA				;$B88981
	STA.w contact_flash_x_position		;$B88984
	LDA.w RAM_17CC				;$B88987
	STA.w contact_flash_y_position		;$B8898A
	LDY.w #$000C				;$B8898D
	...
	STZ.b $5E,x				;$B889BE
	STZ.b $60,x				;$B889C0
	STZ.w RAM_1B63				;$B889C2
	LDA.w #$0001				;$B889C5
	LDX.w #$0037				;$B889C8
	LDY.w #$0000				;$B889CB
	JSL.l CODE_B8F028			;$B889CE
CODE_B889D2:
	LDA.w game_state_flags			;$B889D2
	AND.w #$4000				;$B889D5
...
CODE_B889F5:
	LDX.w RAM_17C8				;$B889F5
	STX.b current_sprite			;$B889F8
	JMP.w CODE_B889FD			;$B889FA

CODE_B889FD:
	LDA.w RAM_17D2				;$B889FD
	STA.b $1A				;$B88A00
	LDA.w RAM_17D4				;$B88A02
	STA.b $1C				;$B88A05
	JMP.w [$001A]				;$B88A07
...
player_interaction_19:
	...
	LDX.w RAM_17C8				;$B88A27
	STX.b current_sprite			;$B88A2A
	LDA.w RAM_17CA				;$B88A2C
	STA.w contact_flash_x_position		;$B88A2F
	LDA.w RAM_17CC				;$B88A32
	STA.w contact_flash_y_position		;$B88A35
	LDY.w #$000C				;$B88A38
...
CODE_B88C1E:
	...
	LDA.b $16,x				;$B88C20
	CMP.w water_y_position			;$B88C22
	BCC.b CODE_B88C2D			;$B88C25
	STZ.w RAM_04AA				;$B88C27
	STZ.w RAM_04AE				;$B88C2A
CODE_B88C2D:
...
CODE_B88C4C:
	...
	STZ.w RAM_04AA				;$B88C58
	STZ.w RAM_04AE				;$B88C5B
CODE_B88C5E:
	PHX					;$B88C5E
...
CODE_B88DA7:
	LDA.w #$0008				;$B88DA7
	STA.b $38,x				;$B88DAA
	LDA.w RAM_17CC				;$B88DAC
	CLC					;$B88DAF
	ADC.w #$0028				;$B88DB0
	STA.b $16,x				;$B88DB3
	LDA.w RAM_17CA				;$B88DB5
	STA.b $12,x				;$B88DB8
	LDA.w #$0016				;$B88DBA
	...
	LDA.w #$0020				;$B88DCA
	TSB.w game_state_flags			;$B88DCD
	LDA.w #$2000				;$B88DD0
	TSB.w RAM_0474				;$B88DD3
	LDA.w #$7000				;$B88DD6
	STA.w RAM_04AC				;$B88DD9
	RTL					;$B88DDC
...
player_interaction_07:
	...
	LDA.w #$0014				;$B88DE1
	STA.b $38,x				;$B88DE4
	LDA.w RAM_17CE				;$B88DE6
	STA.b $4C,x				;$B88DE9
	LDA.w RAM_17CC				;$B88DEB
	CLC					;$B88DEE
	ADC.w #$002A				;$B88DEF
	STA.b $16,x				;$B88DF2
	LDA.w RAM_17CA				;$B88DF4
	STA.b $12,x				;$B88DF7
	STZ.b $2A,x				;$B88DF9
	STZ.b $30,x				;$B88DFB
	STZ.b $2E,x				;$B88DFD
	...
	LDA.w #$0020				;$B88E0B
	TSB.w game_state_flags			;$B88E0E
	LDA.w #$2000				;$B88E11
	TSB.w RAM_0474				;$B88E14
	LDA.w #$7000				;$B88E17
	STA.w RAM_04AC				;$B88E1A
	RTL					;$B88E1D

player_interaction_0C:
	JSL.l CODE_B89C4C			;$B88E1E
	CPY.w #dixie_control_variables		;$B88E22
	BNE.b CODE_B88E31			;$B88E25
	LDA.w RAM_17CC				;$B88E27
	SEC					;$B88E2A
	SBC.w #$0008				;$B88E2B
	STA.w RAM_17CC				;$B88E2E
CODE_B88E31:
	LDA.w #$0010				;$B88E31
	STA.b $5E,x				;$B88E34
	STZ.b $2E,x				;$B88E36
...
CODE_B88E40:
	LDA.w #$000B				;$B88E40
	STA.b $38,x				;$B88E43
	LDA.w RAM_17CA				;$B88E45
	STA.b $12,x				;$B88E48
	LDA.w RAM_17CC				;$B88E4A
	STA.b $16,x				;$B88E4D
	LDA.w #$001B				;$B88E4F
	...
	STZ.b $26,x				;$B88E5C
	LDA.w #$0020				;$B88E5E
	TSB.w game_state_flags			;$B88E61
	LDA.w #$2000				;$B88E64
	TSB.w RAM_0474				;$B88E67
	LDA.w #$8000				;$B88E6A
	STA.w RAM_04A6				;$B88E6D
	STA.w RAM_04A8				;$B88E70
	STZ.w RAM_04AA				;$B88E73
	STZ.w RAM_04AE				;$B88E76
	LDA.w #$AC00				;$B88E79
	STA.w RAM_04AC				;$B88E7C
	RTL					;$B88E7F

player_interaction_08:
	JSL.l CODE_B89C4C			;$B88E80
	LDY.w RAM_17C8				;$B88E84
	STY.b $4C,x				;$B88E87
	LDA.w sprite.type,y			;$B88E89
	CMP.w #!sprite_level_end_flagpole	;$B88E8C
	BEQ.b CODE_B88EB7			;$B88E8F
	LDA.w RAM_17CA				;$B88E91
	STA.b $4E,x				;$B88E94
	LDA.w RAM_17CC				;$B88E96
	STA.b $50,x				;$B88E99
...
CODE_B88EDD:
	...
	LDA.w #$0020				;$B88EEE
	TSB.w game_state_flags			;$B88EF1
	LDA.w #$2000				;$B88EF4
	TSB.w RAM_0474				;$B88EF7
	LDA.w #$8000				;$B88EFA
	STA.w RAM_04A6				;$B88EFD
	STA.w RAM_04A8				;$B88F00
	STZ.w RAM_04AA				;$B88F03
	STZ.w RAM_04AE				;$B88F06
	LDA.w #$AC00				;$B88F09
	STA.w RAM_04AC				;$B88F0C
	RTL					;$B88F0F

player_interaction_0D:
	LDA.w #$0020				;$B88F10
	TRB.w game_state_flags			;$B88F13
...
player_interaction_0F:
	LDX.w RAM_17C8				;$B88F2F
	CPX.w active_kong_sprite		;$B88F32
	BEQ.b CODE_B88F44			;$B88F35
	LDA.w RAM_17CA				;$B88F37
	STA.b $2A,x				;$B88F3A
	STZ.b $30,x				;$B88F3C
	LDA.w RAM_17CC				;$B88F3E
	STA.b $2E,x				;$B88F41
CODE_B88F43:
	RTL					;$B88F43
...
CODE_B88F44:
	...
	LDA.w RAM_17CA				;$B88F4E
	STA.b $2A,x				;$B88F51
	STZ.b $30,x				;$B88F53
	LDA.w RAM_17CC				;$B88F55
	STA.b $2E,x				;$B88F58
	STZ.w RAM_04AA				;$B88F5A
	STZ.w RAM_04AE				;$B88F5D
...
player_interaction_0E:
	STZ.w RAM_04AA				;$B88FB7
	STZ.w RAM_04AE				;$B88FBA
	LDA.w #$001C				;$B88FBD
	LDY.w #$0002				;$B88FC0
	JSL.l enable_timestop			;$B88FC3
	JSL.l CODE_B89C4C			;$B88FC7
	LDA.w RAM_17CA				;$B88FCB
	STA.b $2E,x				;$B88FCE
...
player_interaction_11:
	STZ.w RAM_04AA				;$B89001
	STZ.w RAM_04AE				;$B89004
	LDA.w #$001C				;$B89007
	LDY.w #$0002				;$B8900A
...
CODE_B89144:
	STZ.w RAM_04AA				;$B89144
	STZ.w RAM_04AE				;$B89147
...
CODE_B8916A:
	...
	LDA.w RAM_17CA				;$B89185
	STA.b $2A,x				;$B89188
	STZ.b $30,x				;$B8918A
	LDA.w RAM_17CC				;$B8918C
	STA.b $2E,x				;$B8918F
	LDA.w RAM_17CE				;$B89191
...
CODE_B891B0:
	...
	LDA.w RAM_17CA				;$B891B8
	STA.b $2A,x				;$B891BB
	STZ.b $30,x				;$B891BD
	LDA.w RAM_17CC				;$B891BF
	STA.b $2E,x				;$B891C2
	LDA.w RAM_17CE				;$B891C4
...
CODE_B891E3:
	...
	LDA.w RAM_17CA				;$B891F4
	STA.b $2A,x				;$B891F7
	STZ.b $30,x				;$B891F9
	LDA.w RAM_17CC				;$B891FB
	STA.b $2E,x				;$B891FE
	LDA.w RAM_17CE				;$B89200
...
player_interaction_10:
	...
	LDA.w #$004C				;$B8925C
	STA.b $38,x				;$B8925F
	STZ.w RAM_1929				;$B89261
	LDA.w #$0014				;$B89264
	STA.w RAM_192B				;$B89267
	RTL					;$B8926A

player_interaction_26:
	LDA.w RAM_075C				;$B8926B
	AND.w #$00FF				;$B8926E
	CMP.w #$0002				;$B89271
...
CODE_B89364:
	...
	LDA.b $12,x				;$B89371
	STA.w RAM_1931				;$B89373
	LDA.b $16,x				;$B89376
	STA.w RAM_1935				;$B89378
	LDA.b $2A,x				;$B8937B
	STA.w RAM_1939				;$B8937D
	STZ.b $2A,x				;$B89380
	STZ.b $30,x				;$B89382
	STZ.b $3A,x				;$B89384
...
player_interaction_01:
	...
	STZ.w RAM_186D				;$B89742
	STZ.w RAM_186F				;$B89745
	LDA.w #$0001				;$B89748
	STA.w RAM_1871				;$B8974B
...
player_interaction_03:
	...
	STZ.w RAM_186D				;$B897AF
	STZ.w RAM_186F				;$B897B2
	LDA.w #$0001				;$B897B5
	STA.w RAM_1871				;$B897B8
...
player_interaction_02:
	...
	STZ.w RAM_186D				;$B89825
	STZ.w RAM_186F				;$B89828
	LDA.w #$0001				;$B8982B
	STA.w RAM_1871				;$B8982E
...
player_interaction_18:
	...
	LDX.w RAM_17CC				;$B898F0
	JSL.l CODE_B89C37			;$B898F3
	JSL.l CODE_B89C01			;$B898F7
	STZ.w RAM_04AA				;$B898FB
	STZ.w RAM_04AE				;$B898FE
	LDX.b current_sprite			;$B89901
	LDA.w RAM_17CA				;$B89903
	STA.b $5C,x				;$B89906
	LDA.w #$003B				;$B89908
	...
	STZ.w RAM_1929				;$B89934
	LDA.w #$0020				;$B89937
	STA.w RAM_192B				;$B8993A
CODE_B8993D:
	RTL					;$B8993D
...
player_interaction_17:
	...
	LDA.w #$8000				;$B899A0
	STA.w RAM_04A6				;$B899A3
	STA.w RAM_04A8				;$B899A6
	STZ.w RAM_04AA				;$B899A9
	LDA.w #$4000				;$B899AC
	TSB.w RAM_1957				;$B899AF
	RTL					;$B899B2
...
CODE_B89AAC:
	...
	LDA.b $88				;$B89AAF
	STA.w RAM_1933				;$B89AB1
	STA.b $12,x				;$B89AB4
	LDA.b $8A				;$B89AB6
	STA.w RAM_1937				;$B89AB8
	STA.b $16,x				;$B89ABB
	STZ.b $26,x				;$B89ABD
	LDX.w active_kong_sprite		;$B89ABF
	LDY.w active_kong_control_variables	;$B89AC2
	LDA.b $12,x				;$B89AC5
	STA.w RAM_1931				;$B89AC7
	LDA.b $16,x				;$B89ACA
	STA.w RAM_1935				;$B89ACC
	STZ.b $26,x				;$B89ACF
	STZ.b $14,x				;$B89AD1
	LDA.w $0016,y				;$B89AD3
	PHA					;$B89AD6
	...
	PLA					;$B89ADB
	LDY.w active_kong_control_variables	;$B89ADC
	STA.w $0016,y				;$B89ADF
	...
	LDA.w $001A,y				;$B89AFD
	STA.b $1A,x				;$B89B00
	LDA.w RAM_1931				;$B89B02
	SEC					;$B89B05
	SBC.w RAM_1933				;$B89B06
	BIT.b $1E,x				;$B89B09
	BVC.b CODE_B89B11			;$B89B0B
	EOR.w #$FFFF				;$B89B0D
	INC					;$B89B10
CODE_B89B11:
	STA.w RAM_186D				;$B89B11
	LDA.w RAM_1935				;$B89B14
	SEC					;$B89B17
	SBC.w RAM_1937				;$B89B18
	STA.w RAM_186F				;$B89B1B
	LDA.w #$FFFF				;$B89B1E
	STA.w RAM_1871				;$B89B21
...
CODE_B89C3C:
	LDA.w follower_kong_control_variables	;$B89C3C
...
CODE_B89C4C:
	LDA.w active_kong_control_variables	;$B89C4C
...
CODE_B89C62:
	...
	LDA.w #dixie_control_variables		;$B89C72
	STA.w active_kong_control_variables	;$B89C75
	LDA.w #sprite_table.slot_2		;$B89C78
	STA.w follower_kong_sprite		;$B89C7B
	LDA.w #kiddy_control_variables		;$B89C7E
	STA.w follower_kong_control_variables	;$B89C81
	BRA.b CODE_B89C9E			;$B89C84

CODE_B89C86:
	LDA.w #sprite_table.slot_2		;$B89C86
	STA.w active_kong_sprite		;$B89C89
	LDA.w #kiddy_control_variables		;$B89C8C
	STA.w active_kong_control_variables	;$B89C8F
	LDA.w #sprite_table.slot_1		;$B89C92
	STA.w follower_kong_sprite		;$B89C95
	LDA.w #dixie_control_variables		;$B89C98
	STA.w follower_kong_control_variables	;$B89C9B
CODE_B89C9E:
	PHX					;$B89C9E
...
CODE_B89D01:
	...
	ADC.b $06,x				;$B89D02
	STA.b $06,x				;$B89D04
	LDA.w #kiddy_control_variables		;$B89D06
	STA current_kong_control_variables	;$B89D09
	LDA.w RAM_0767				;$B89D0B
	AND.w #$00FF				;$B89D0E
	DEC					;$B89D11
	ASL					;$B89D12
...
CODE_B89E83:
	...
	STA.b $1E,x				;$B89E90
CODE_B89E92:
	LDA.w RAM_077B				;$B89E92
	STA.b $12,x				;$B89E95
	LDA.w RAM_077D				;$B89E97
	STA.b $16,x				;$B89E9A
	LDA.w RAM_0792				;$B89E9C
	AND.w #$0002				;$B89E9F
...
CODE_B89EC6:
	...
	STA.w RAM_1488				;$B89ED6
	LDA.l dixie_kong_constants+$08		;$B89ED9
	STA.w RAM_148A				;$B89EDD
	...
	STA.w RAM_14DA				;$B89EF0
	LDA.l kiddy_kong_constants+$08		;$B89EF3
	STA.w RAM_14DC				;$B89EF7
	RTL					;$B89EFA
...
CODE_B8A095:
	LDA.w #$2000				;$B8A095
	TRB.w RAM_1957				;$B8A098
CODE_B8A09B:
	JSR.w CODE_B8A0A7			;$B8A09B
	LDX.b current_kong_control_variables	;$B8A09E
	STZ.b $28,x				;$B8A0A0
	STZ.b $2E,x				;$B8A0A2
	JML [sprite_return_address]		;$B8A0A4

CODE_B8A0A7:
	LDA.w RAM_0775				;$B8A0A7
	AND.w #$0004				;$B8A0AA
	...
	LDA.w #$8000				;$B8A0B7
CODE_B8A0BA:
	STA.w RAM_18B5				;$B8A0BA
	PHK					;$B8A0BD
	%return(CODE_B8A0C4)			;$B8A0BE
	JMP.w [RAM_18B1]			;$B8A0C1
...
CODE_B8A0C5:
	...
	LDA.w RAM_187D				;$B8A0DC
	STA.w RAM_1883				;$B8A0DF
CODE_B8A0E2:
	LDA.b $16,x				;$B8A0E2
	STA.w RAM_187D				;$B8A0E4
	LDY.b current_animal_type		;$B8A0E7
	BEQ.b CODE_B8A0EE			;$B8A0E9
	STA.w RAM_187F				;$B8A0EB
CODE_B8A0EE:
	LDY.w current_held_sprite		;$B8A0EE
	BEQ.b CODE_B8A0F6			;$B8A0F1
	STA.w RAM_1881				;$B8A0F3
CODE_B8A0F6:
	RTS					;$B8A0F6

CODE_B8A0F7:
	LDA.w water_current_speed		;$B8A0F7
...
CODE_B8A11B:
	...
	EOR.w #$FFFF				;$B8A11C
	SEC					;$B8A11F
	ADC.w water_current_speed		;$B8A120
	CMP.w #$8000				;$B8A123
	ROR					;$B8A126
	CMP.w #$8000				;$B8A127
	ROR					;$B8A12A
...
CODE_B8A138:
	...
	PHA					;$B8A13A
	ASL					;$B8A13B
	ADC.w water_current_speed		;$B8A13C
	CMP.w #$8000				;$B8A13F
	ROR					;$B8A142
	STA.b $2A,x				;$B8A143
...
CODE_B8A16D:
	...
	EOR.w #$FFFF				;$B8A16E
	SEC					;$B8A171
	ADC.w water_current_speed		;$B8A172
	CLC					;$B8A175
	ADC.b $2A,x				;$B8A176
	STA.b $2A,x				;$B8A178
...
CODE_B8A182:
	PHA					;$B8A182
	CLC					;$B8A183
	ADC.w water_current_speed		;$B8A184
	STA.b $2A,x				;$B8A187
...
CODE_B8A4B4:
	...
	STA.b $12,x				;$B8A4B8
	STZ.b $10,x				;$B8A4BA
	STZ.w water_current_speed		;$B8A4BC
	LDA.b $36,x				;$B8A4BF
...
CODE_B8A50F:
	...
	STA.b $36,x				;$B8A511
	STA.w water_current_speed		;$B8A513
	LDA.b $12,x				;$B8A516
	STA.b $54,x				;$B8A518
	STZ.b $3E				;$B8A51A
	LDA.b $2A,x				;$B8A51C
...
kong_state_0B:
	LDA.w #$0004				;$B8A591
	TSB.w game_state_flags			;$B8A594
	LDA.w #$0001				;$B8A597
	TSB.w RAM_1927				;$B8A59A
...
CODE_B8A5D2:
	...
	LDA.b $14,x				;$B8A5D9
	STA.w RAM_1935				;$B8A5DB
	LDA.b $16,x				;$B8A5DE
	STA.w RAM_1937				;$B8A5E0
...
kong_state_15:
	LDA.w #$0004				;$B8A724
	TSB.w game_state_flags			;$B8A727
	JMP.w CODE_B8A075			;$B8A72A

kong_state_16:
	LDA.w #$0004				;$B8A72D
	TSB.w game_state_flags			;$B8A730
	LDA.w #$0007				;$B8A733
...
CODE_B8A763:
	...
	LDA.b $14,x				;$B8A76A
	STA.w RAM_1935				;$B8A76C
	LDA.b $16,x				;$B8A76F
	STA.w RAM_1937				;$B8A771
...
CODE_B8A9AF:
	...
	LDA.w RAM_195D				;$B8A9B1
	BEQ.b CODE_B8A9DA			;$B8A9B4
	LDA.w RAM_1961				;$B8A9B6
	SEC					;$B8A9B9
	SBC.b $16,x				;$B8A9BA
...
kong_state_1C:
	LDA.w #$0001				;$B8AA07
	TSB.w RAM_1927				;$B8AA0A
	LDA.w #$0002				;$B8AA0D
	TSB.w game_state_flags			;$B8AA10
	LDA.w #$0001				;$B8AA13
...
kong_state_1D:
	LDA.w #$0002				;$B8AA2F
	TSB.w RAM_1927				;$B8AA32
	LDX.w RAM_0501				;$B8AA35
	LDA.b $06,x				;$B8AA38
	STA.b $6A				;$B8AA3A
...
CODE_B8AA5D:
	...
	LDY.w #$0002				;$B8AA67
	STY.w RAM_0533				;$B8AA6A
	DEC.b $5C,x				;$B8AA6D
	BPL.b CODE_B8AA78			;$B8AA6F
	STA.w RAM_195B				;$B8AA71
...
CODE_B8AAFF:
	...
	STZ.w RAM_04AA				;$B8AB08
	STZ.w RAM_04AE				;$B8AB0B
...
CODE_B8AD5C:
	...
	STZ.b $3C,x				;$B8AD77
	LDY.b $3E,x				;$B8AD79
	LDA.w sprite.type,y			;$B8AD7B
	CMP.w #!sprite_sneek			;$B8AD7E
	BNE.b CODE_B8ADC3			;$B8AD81
	LDA.w RAM_18A1				;$B8AD83
	CLC					;$B8AD86
	ADC.w #$00E0				;$B8AD87
	CMP.w #$01C0				;$B8AD8A
	BCS.b CODE_B8ADC3			;$B8AD8D
	LDA.w $0012,y				;$B8AD8F
	CMP.w RAM_18A7				;$B8AD92
	BCC.b CODE_B8ADC3			;$B8AD95
	CMP.w RAM_18A9				;$B8AD97
	BCS.b CODE_B8ADC3			;$B8AD9A
	LDA.b $12,x				;$B8AD9C
	CMP.w RAM_18A7				;$B8AD9E
	BCC.b CODE_B8ADC3			;$B8ADA1
	CMP.w RAM_18A9				;$B8ADA3
...
kong_state_34:
	...
	LDA.w RAM_1925				;$B8AEE5
	INC					;$B8AEE8
	INC					;$B8AEE9
	AND.w #$003F				;$B8AEEA
	CMP.w RAM_1923				;$B8AEED
...
CODE_B8AFD2:
	...
	JML [sprite_return_address]		;$B8AFD5
...
CODE_B8AFEC:
	JML [sprite_return_address]		;$B8AFEC
...
kong_state_3A:
	...
	JML [sprite_return_address]		;$B8B001

CODE_B8B004:
	JSL.l disable_timestop			;$B8B004
	LDA.w #$4000				;$B8B008
	TRB.w game_state_flags			;$B8B00B
...
CODE_B8B086:
	...
	LDY.w #$0002				;$B8B088
	LDA.w RAM_1931				;$B8B08B
	SEC					;$B8B08E
	SBC.b $12,x				;$B8B08F
	JSR.w CODE_B8B0A3			;$B8B091
	STA.b $2A,x				;$B8B094
	LDA.w RAM_1935				;$B8B096
	SEC					;$B8B099
	SBC.b $16,x				;$B8B09A
...
kong_state_3C:
	LDA.w RAM_0474				;$B8B115
	AND.w #$BFFF				;$B8B118
	ORA.w #$A000				;$B8B11B
	STA.w RAM_0474				;$B8B11E
	LDA.w $005A,y				;$B8B121
	ASL					;$B8B124
	TAX					;$B8B125
...
CODE_B8B15C:
	LDA.w #$0001				;$B8B15C
	TSB.w RAM_1927				;$B8B15F
	LDA.w #$0002				;$B8B162
	TSB.w game_state_flags			;$B8B165
...
CODE_B8B203:
	...
	LDA.w #$0100				;$B8B20F
	CMP.w rocket_rush_fuel_amount		;$B8B212
	BCC.b CODE_B8B21A			;$B8B215
	STA.w rocket_rush_fuel_amount		;$B8B217
CODE_B8B21A:
...
CODE_B8B24F:
	...
	STA.w $006A,y				;$B8B269
	LDA.w #$0001				;$B8B26C
	STA.w rocket_rush_fuel_amount		;$B8B26F
	STZ.w RAM_18EB				;$B8B272
CODE_B8B275:
	RTS					;$B8B275
...
CODE_B8B30E:
	...
	STA.b $0A,x				;$B8B315
	LDY.w #$01A0				;$B8B317
	LDA.w RAM_18EB				;$B8B31A
	XBA					;$B8B31D
	CLC					;$B8B31E
	ADC.w rocket_rush_fuel_amount		;$B8B31F
	DEC					;$B8B322
...
CODE_B8B41F:
	STZ.w rocket_rush_fuel_amount		;$B8B41F
	STZ.w RAM_18EB				;$B8B422
...
CODE_B8B4D2:
	PHA					;$B8B4D2
	LDA.w rocket_rush_fuel_amount		;$B8B4D3
	SEC					;$B8B4D6
	SBC.b $01,S				;$B8B4D7
...
CODE_B8B4DD:
	...
	LDA.w #$0001				;$B8B4E3
CODE_B8B4E6:
	STA.w rocket_rush_fuel_amount		;$B8B4E6
	PLA					;$B8B4E9
...
kong_state_3E:
	LDA.w #$0002				;$B8B5F0
	TSB.w RAM_1927				;$B8B5F3
	JSR.w CODE_B8F0E0			;$B8B5F6
	LDA.w RAM_1925				;$B8B5F9
	INC					;$B8B5FC
	INC					;$B8B5FD
	AND.w #$003F				;$B8B5FE
	CMP.w RAM_1923				;$B8B601
...
kong_state_49:
	...
	LDY.w active_kong_control_variables	;$B8B782
	LDA.w $0004,y				;$B8B785
	AND.w #$0300				;$B8B788
...
CODE_B8B7EC:
	LDA.w RAM_0775				;$B8B7EC
	BIT.w #$0004				;$B8B7EF
	BNE.b CODE_B8B7F7			;$B8B7F2
CODE_B8B7F4:
	JML [sprite_return_address]		;$B8B7F4
...
CODE_B8B813:
	...
	STZ.w RAM_1929				;$B8B82F
	LDA.w #$0020				;$B8B832
	STA.w RAM_192B				;$B8B835
...
CODE_B8B86F:
	...
	STZ.w RAM_1929				;$B8B881
	LDA.w #$0020				;$B8B884
	STA.w RAM_192B				;$B8B887
	JSL.l CODE_B89C3C			;$B8B88A
	LDA.w #$0053				;$B8B88E
	STA.b $38,x				;$B8B891
	LDA.w #$0016				;$B8B893
	JSL.l set_anim_handle_kiddy		;$B8B896
	JML [sprite_return_address]		;$B8B89A
...
CODE_B8B917:
	LDA.w #$4000				;$B8B917
	TRB.w game_state_flags			;$B8B91A
	JSR.w CODE_B89F1E			;$B8B91D
	JML [sprite_return_address]		;$B8B920
...
CODE_B8B9A6:
	...
	LDY.w #$E000				;$B8B9B6
CODE_B8B9B9:
	STY.w RAM_18B5				;$B8B9B9
	PHK					;$B8B9BC
	%return(CODE_B8B9C3)			;$B8B9BD
	JMP.w [RAM_18B1]			;$B8B9C0

CODE_B8B9C3:
	JML [sprite_return_address]		;$B8B9C3
...
CODE_B8B9DF:
	...
	LDA.w #$FFE6				;$B8B9E1
	CPX.w RAM_0503				;$B8B9E4
	BEQ.b CODE_B8B9EC			;$B8B9E7
	LDA.w #$FFE0				;$B8B9E9
CODE_B8B9EC:
	STA.w RAM_1921				;$B8B9EC
	STZ.w RAM_191F				;$B8B9EF
	RTS					;$B8B9F2
...
CODE_B8BA01:
	LDA.w RAM_1929				;$B8BA01
	BNE.b CODE_B8BA15			;$B8BA04
	LDA.b $12,x				;$B8BA06
	STA.w RAM_192D				;$B8BA08
	LDA.b $16,x				;$B8BA0B
	STA.w RAM_192F				;$B8BA0D
	INC.w RAM_1929				;$B8BA10
	CLC					;$B8BA13
	RTS					;$B8BA14

CODE_B8BA15:
	CMP.w RAM_192B				;$B8BA15
	BCS.b CODE_B8BA47			;$B8BA18
	LDA.w $0012,y				;$B8BA1A
	CLC					;$B8BA1D
	ADC.w RAM_191F				;$B8BA1E
	SEC					;$B8BA21
	SBC.w RAM_192D				;$B8BA22
	JSR.w CODE_B8BA5B			;$B8BA25
	CLC					;$B8BA28
	ADC.w RAM_192D				;$B8BA29
	STA.b $12,x				;$B8BA2C
	LDA.w $0016,y				;$B8BA2E
	CLC					;$B8BA31
	ADC.w RAM_1921				;$B8BA32
	SEC					;$B8BA35
	SBC.w RAM_192F				;$B8BA36
	JSR.w CODE_B8BA5B			;$B8BA39
	CLC					;$B8BA3C
	ADC.w RAM_192F				;$B8BA3D
	STA.b $16,x				;$B8BA40
	INC.w RAM_1929				;$B8BA42
	CLC					;$B8BA45
	RTS					;$B8BA46
...
CODE_B8BA47:
	LDA.w $0012,y				;$B8BA47
	CLC					;$B8BA4A
	ADC.w RAM_191F				;$B8BA4B
	STA.b $12,x				;$B8BA4E
	LDA.w $0016,y				;$B8BA50
	CLC					;$B8BA53
	ADC.w RAM_1921				;$B8BA54
	STA.b $16,x				;$B8BA57
	SEC					;$B8BA59
	RTS					;$B8BA5A
...
CODE_B8BA5B:
	PHX					;$B8BA5B
	PHY					;$B8BA5C
	LDX.w RAM_1929				;$B8BA5D
	LDY.w RAM_192B				;$B8BA60
...
CODE_B8BAF4:
	STZ.w RAM_18B5				;$B8BAF4
	PHK					;$B8BAF7
	%return(CODE_B8BAFE)			;$B8BAF8
	JMP.w [RAM_18B1]			;$B8BAFB

CODE_B8BAFE:
	JML [sprite_return_address]		;$B8BAFE
...
CODE_B8BB77:
	...
	LDA.w #$0020				;$B8BBA3
	TSB.w game_state_flags			;$B8BBA6
	LDA.w #$2000				;$B8BBA9
	TSB.w RAM_0474				;$B8BBAC
	LDA.w #$7000				;$B8BBAF
	STA.w RAM_04AC				;$B8BBB2
...
CODE_B8BBF6:
	...
	LDY.w active_kong_control_variables	;$B8BBFE
	LDA.w $0004,y				;$B8BC01
	AND.w #$0300				;$B8BC04
...
CODE_B8BC81:
	LDA.w RAM_0775				;$B8BC81
	BIT.w #$0004				;$B8BC84
	BNE.b CODE_B8BC8C			;$B8BC87
CODE_B8BC89:
	JML [sprite_return_address]		;$B8BC89
...
CODE_B8BCD8:
	...
	STZ.w RAM_1929				;$B8BCEA
	LDA.w #$0020				;$B8BCED
	STA.w RAM_192B				;$B8BCF0
	JSL.l CODE_B89C3C			;$B8BCF3
	LDA.w #$0053				;$B8BCF7
	STA.b $38,x				;$B8BCFA
	LDA.w #$0016				;$B8BCFC
	JSL.l set_anim_handle_kiddy		;$B8BCFF
	JML [sprite_return_address]		;$B8BD03
...
CODE_B8BF4C:
	STZ.w RAM_18B5				;$B8BF4C
	PHK					;$B8BF4F
	%return(CODE_B8BF56)			;$B8BF50
	JMP.w [RAM_18B1]			;$B8BF53

CODE_B8BF56:
	JML [sprite_return_address]		;$B8BF56
...
CODE_B8BF7C:
	...
	LDA.w #$0033				;$B8BF8E
	STA.w $0038,y				;$B8BF91
	JML [sprite_return_address]		;$B8BF94

kong_state_55:
	TYX					;$B8BF97
	STZ.b $2A,x				;$B8BF98
	LDA.b $16,x				;$B8BF9A
	CMP.w water_y_position			;$B8BF9C
...
CODE_B8BFA6:
	...
	JML [sprite_return_address]		;$B8BFB1

kong_state_56:
	JML [sprite_return_address]		;$B8BFB4

kong_state_58:
	LDA.w #$0002				;$B8BFB7
	TSB.w RAM_1927				;$B8BFBA
	LDA.w #$0002				;$B8BFBD
	TSB.w game_state_flags			;$B8BFC0
	LDA.w #$0001				;$B8BFC3
...
CODE_B8BFFC:
	...
	JML [sprite_return_address]		;$B8C018

CODE_B8C01B:
	LDA.w #$C000				;$B8C01B
	STA.b $26,x				;$B8C01E
	JML [sprite_return_address]		;$B8C020
...
CODE_B8C034:
	JML [sprite_return_address]		;$B8C034
...
CODE_B8C042:
	LDA.w RAM_189D				;$B8C042
	STA.b $38,x				;$B8C045
	JMP.w CODE_B8A075			;$B8C047

kong_state_5C:
	LDX.w RAM_1B63				;$B8C04A
	BEQ.b CODE_B8C051			;$B8C04D
	STZ.b $2E,x				;$B8C04F
CODE_B8C051:
	LDA.w $0012,y				;$B8C051
	SEC					;$B8C054
	SBC.w RAM_196D				;$B8C055
	CMP.w #$0100				;$B8C058
...
kong_state_60:
	...
	LDA.b $12,x				;$B8C0AC
	CMP.w RAM_18A7				;$B8C0AE
	BCC.b CODE_B8C0C1			;$B8C0B1
	CMP.w RAM_18A9				;$B8C0B3
...
CODE_B8C0F3:
	LDA.w #$0014				;$B8C0F3
	STA.b $5C,x				;$B8C0F6
	LDA.w RAM_1931				;$B8C0F8
	SEC					;$B8C0FB
	SBC.w RAM_1933				;$B8C0FC
	AND.w #$00FF				;$B8C0FF
	XBA					;$B8C102
	LDY.b $5C,x				;$B8C103
	JSR.w CODE_B8C232			;$B8C105
	STA.b $2A,x				;$B8C108
	LDA.w RAM_1935				;$B8C10A
	SEC					;$B8C10D
	SBC.w RAM_1937				;$B8C10E
	AND.w #$00FF				;$B8C111
	XBA					;$B8C114
	LDY.b $5C,x				;$B8C115
...
CODE_B8C12D:
	LDA.w RAM_1931				;$B8C12D
	STA.b $12,x				;$B8C130
	LDA.w RAM_1935				;$B8C132
	STA.b $16,x				;$B8C135
	INC.b $5A,x				;$B8C137
	LDA.w #$003D				;$B8C139
...
CODE_B8C1E8:
	...
	LDA.w #$0014				;$B8C1F0
	STA.b $5C,x				;$B8C1F3
	LDA.w RAM_1933				;$B8C1F5
	SEC					;$B8C1F8
	SBC.w RAM_1931				;$B8C1F9
	AND.w #$00FF				;$B8C1FC
	XBA					;$B8C1FF
	LDY.b $5C,x				;$B8C200
...
CODE_B8C292:
	...
	LDA.w #$FFEF				;$B8C29A
CODE_B8C29D:
	STA.w RAM_191F				;$B8C29D
	LDA.w #$FFDC				;$B8C2A0
	STA.w RAM_1921				;$B8C2A3
	...
	INC					;$B8C2BC
CODE_B8C2BD:
	STA.w RAM_186D				;$B8C2BD
	LDA.w $0016,y				;$B8C2C0
	SEC					;$B8C2C3
	SBC.b $16,x				;$B8C2C4
	STA.w RAM_186F				;$B8C2C6
	PLP					;$B8C2C9
...
CODE_B8C483:
	...
	LDA.b sprite.type,x			;$B8C485
	CMP.w #!sprite_kiddy_kong		;$B8C487
	BNE.b CODE_B8C4F7			;$B8C48A
	DEC.w RAM_1929				;$B8C48C
	BNE.b CODE_B8C4F7			;$B8C48F
	LDY.w active_kong_control_variables	;$B8C491
	LDA.w #$0000				;$B8C494
	STA.w $0014,y				;$B8C497
	LDA.w $0016,y				;$B8C49A
	PHA					;$B8C49D
	JSL.l CODE_B89C5C			;$B8C49E
	LDY.w active_kong_control_variables	;$B8C4A2
	PLA					;$B8C4A5
	STA.w $0016,y				;$B8C4A6
	LDA.w #$0000				;$B8C4A9
	STA.w $0014,y				;$B8C4AC
	...
	STZ.b $2A,x				;$B8C4B8
	STZ.b $2E,x				;$B8C4BA
	LDA.w RAM_1931				;$B8C4BC
	STA.b $12,x				;$B8C4BF
	LDA.w RAM_1935				;$B8C4C1
	STA.b $16,x				;$B8C4C4
	LDA.w #$00E4				;$B8C4C6
	STA.b $0E,x				;$B8C4C9
...
CODE_B8C616:
	...
	LDA.w #$0080				;$B8C631
	TRB.w RAM_1959				;$B8C634
	JSL.l CODE_BB8600			;$B8C637
	RTS					;$B8C63B

CODE_B8C63C:
	LDA.w #$0080				;$B8C63C
	TSB.w RAM_1959				;$B8C63F
...
CODE_B8C6BF:
	STZ.w RAM_04AA				;$B8C6BF
	STZ.w RAM_04AE				;$B8C6C2
...
CODE_B8C6F3:
	...
	STZ.b $30,x				;$B8C70E
	STZ.b $2E,x				;$B8C710
	LDA.w water_y_position			;$B8C712
	CLC					;$B8C715
	ADC.w #$0014				;$B8C716
	CMP.b $16,x				;$B8C719
	BCC.b CODE_B8C72F			;$B8C71B
	STA.b $16,x				;$B8C71D
	LDA.w RAM_04AD				;$B8C71F
	AND.w #$00FF				;$B8C722
	EOR.w #$FFFF				;$B8C725
	SEC					;$B8C728
	ADC.w water_y_position			;$B8C729
	STA.w RAM_04A2				;$B8C72C
CODE_B8C72F:
	LDX.w #$0000				;$B8C72F
	LDY.w RAM_187D				;$B8C732
	JSL.l CODE_B8E587			;$B8C735
	RTS					;$B8C739

check_sprite_underwater:
	LDX current_sprite			;$B8C73A
	LDA water_y_position			;$B8C73C
	BMI .no_water				;$B8C73F
	SEC					;$B8C741
...
CODE_B8C7F5:
	...
	ADC.b $DC				;$B8C803
	LSR					;$B8C805
	STA.w RAM_17CA				;$B8C806
	LDA.b $DA				;$B8C809
	STA.w RAM_17CC				;$B8C80B
	LDA.b $78				;$B8C80E
	STA.w RAM_17CE				;$B8C810
	SEC					;$B8C813
	RTS					;$B8C814
...
CODE_B8C858:
	...
	LDA.b $42				;$B8C861
	STA.w RAM_17CA				;$B8C863
	LDA.b $44				;$B8C866
	STA.w RAM_17CC				;$B8C868
	LDA.b $78				;$B8C86B
	STA.w RAM_17C8				;$B8C86D
	SEC					;$B8C870
	RTS					;$B8C871
...
CODE_B8C8AF:
	...
	LDA.b $3E				;$B8C8B8
	STA.w RAM_17CA				;$B8C8BA
	LDA.b $40				;$B8C8BD
	STA.w RAM_17CC				;$B8C8BF
	LDA.b $A2				;$B8C8C2
	STA.b $1C,x				;$B8C8C4
	SEC					;$B8C8C6
	RTS					;$B8C8C7
...
CODE_B8C8FA:
	...
	LDA.b $3E				;$B8C903
	STA.w RAM_17CA				;$B8C905
	LDA.b $40				;$B8C908
	STA.w RAM_17CC				;$B8C90A
	SEC					;$B8C90D
	RTS					;$B8C90E
...
CODE_B8C97D:
	...
	AND.w #$FFF0				;$B8C97F
	CLC					;$B8C982
	ADC.w RAM_0519				;$B8C983
	STA.b $3A				;$B8C986
	CLC					;$B8C988
	ADC.w RAM_051B				;$B8C989
	STA.b $3C				;$B8C98C
	CLC					;$B8C98E
	RTS					;$B8C98F
...
CODE_B8C9C7:
	...
	AND.w #$FFF0				;$B8C9C9
	CLC					;$B8C9CC
	ADC.w RAM_0519				;$B8C9CD
	STA.b $3A				;$B8C9D0
	CLC					;$B8C9D2
	ADC.w RAM_051B				;$B8C9D3
	STA.b $3C				;$B8C9D6
	LDA.b $3A				;$B8C9D8
	SEC					;$B8C9DA
	SBC.w #$0010				;$B8C9DB
...
CODE_B8CA0D:
	...
	CPY.w #dixie_control_variables		;$B8CA28
...
CODE_B8CA55:
	...
	CPY.w #dixie_control_variables		;$B8CA5A
...
CODE_B8CAE7:
	...
	CPY.w #dixie_control_variables		;$B8CAEC
...
CODE_B8CC4E:
	...
	STA.w player_action_button_pressed	;$B8CC51
	LDA.w player_active_held		;$B8CC54
	STA.w player_action_button_held		;$B8CC57
	LDY current_kong_control_variables	;$B8CC5A
	LDA.w player_action_button_held		;$B8CC5C
	STA.w $0004,y				;$B8CC5F
	LDA.w player_action_button_pressed	;$B8CC62
	STA.w $0002,y				;$B8CC65
...
CODE_B8CD13:
	LDX.w player_action			;$B8CD13
	LDA.w player_action_button_held		;$B8CD16
	AND.w #$0300				;$B8CD19
...
;shit
CODE_B8CD2C:
	LDX.w player_action			;$B8CD2C
	LDA.w player_action_button_held		;$B8CD2F
	AND.w #$0C00				;$B8CD32
...
CODE_B8CD45:
	LDX.w player_action			;$B8CD45
	LDA.w player_action_button_held		;$B8CD48
	AND.w #$8000				;$B8CD4B
...
CODE_B8CD56:
	LDX.w player_action			;$B8CD56
	LDA.w player_action_button_held		;$B8CD59
	AND.w #$4000				;$B8CD5C
...
CODE_B8D247:
	...
	LDA.w player_action_button_pressed	;$B8D249
	AND.w #$0040				;$B8D24C
...
pause_game_action:
	LDA.w player_action_button_pressed	;$B8D26D
	BIT.w #$1000				;$B8D270
...
CODE_B8D329:
	LDA.w player_action_button_pressed	;$B8D329
	AND.w #$0800				;$B8D32C
...
CODE_B8D376:
	...
	CLC					;$B8D378
	ADC.w RAM_04AE				;$B8D379
	BMI.b CODE_B8D381			;$B8D37C
	LDA.w #$0000				;$B8D37E
CODE_B8D381:
	STA.w RAM_04AE				;$B8D381
	RTS					;$B8D384

CODE_B8D385:
	CLC					;$B8D385
	ADC.w RAM_04AE				;$B8D386
	CMP.w #$D800				;$B8D389
	BCS.b CODE_B8D391			;$B8D38C
	LDA.w #$D800				;$B8D38E
CODE_B8D391:
	STA.w RAM_04AE				;$B8D391
	RTS					;$B8D394
...
CODE_B8D395:
	...
	LDA.w player_action_button_pressed	;$B8D39B
	AND.w #$0400				;$B8D39E
...
CODE_B8D51E:
	LDA.w player_action_button_pressed	;$B8D51E
	AND.w #$0200				;$B8D521
...
CODE_B8D535:
	LDA.w player_action_button_pressed	;$B8D535
	AND.w #$0100				;$B8D538
...
CODE_B8D56E:
	...
	LDA.b $3A				;$B8D5AF
	STA.w RAM_17CC				;$B8D5B1
	LDA.b $3E				;$B8D5B4
	STA.w RAM_17CA				;$B8D5B6
	LDA.b $A2				;$B8D5B9
	STA.b $1C,x				;$B8D5BB
CODE_B8D5BD:
	RTS					;$B8D5BD
...
CODE_B8D5DF:
	...
	LDY.w #$01E8				;$B8D5E1
CODE_B8D5E4:
	LDA.w player_action_button_held		;$B8D5E4
	AND.w #$4000				;$B8D5E7
	CMP.w #$0001				;$B8D5EA
	LDA.b [$6A],y				;$B8D5ED
...
CODE_B8D628:
	LDA.w player_action_button_held		;$B8D628
	AND.w #$8000				;$B8D62B
...
CODE_B8D63E:
	LDA.w player_action_button_pressed	;$B8D63E
	AND.w #$8000				;$B8D641
...
CODE_B8D65E:
	...
	LDA.w player_action_button_pressed	;$B8D660
	AND.w #$8000				;$B8D663
...
CODE_B8D744:
	...
	AND.w #$0010				;$B8D74E
	TSB.w player_action_button_pressed	;$B8D751
	RTS					;$B8D754
...
CODE_B8D795:
	LDA.w player_action_button_pressed	;$B8D795
	AND.w #$8000				;$B8D798
...
CODE_B8D7A5:
	LDA.w player_action_button_pressed	;$B8D7A5
	AND.w #$8000				;$B8D7A8
...
CODE_B8D7AE:
	LDY.w #$001A				;$B8D7AE
	LDA.w player_action_button_held		;$B8D7B1
	AND.w #$0400				;$B8D7B4
...
CODE_B8D7DB:
	LDA.w player_action_button_pressed	;$B8D7DB
	AND.w #$8000				;$B8D7DE
	BEQ.b CODE_B8D7EB			;$B8D7E1
	LDA.w player_action_button_held		;$B8D7E3
	AND.w #$0300				;$B8D7E6
...
CODE_B8D7EC:
	LDA.w player_action_button_pressed	;$B8D7EC
	AND.w #$8000				;$B8D7EF
	BEQ.b CODE_B8D82E			;$B8D7F2
	LDA.w player_action_button_held		;$B8D7F4
	AND.w #$0300				;$B8D7F7
	BNE.b CODE_B8D82F			;$B8D7FA
	LDA.w player_action_button_held		;$B8D7FC
	AND.w #$0C00				;$B8D7FF
...
CODE_B8D814:
	...
	STZ.b $30,x				;$B8D81A
	LDA.w #$0008				;$B8D81C
	STA.w RAM_1955				;$B8D81F
	JSR.w CODE_B8E2DD			;$B8D822
	LDA.w #$0020				;$B8D825
	TRB.w game_state_flags			;$B8D828
...
CODE_B8D86E:
	LDA.w player_action_button_pressed	;$B8D86E
	AND.w #$8000				;$B8D871
...
CODE_B8D877:
	...
	LDY.w #$0210				;$B8D886
	LDA.w player_action_button_held		;$B8D889
	AND.w #$0C00				;$B8D88C
...
CODE_B8D8D7:
	...
	LDA.w player_action_button_pressed	;$B8D8D9
	AND.w #$8000				;$B8D8DC
...
CODE_B8D910:
	LDA.w player_action_button_pressed	;$B8D910
	AND.w #$8000				;$B8D913
...
CODE_B8D95A:
	LDA.w player_action_button_pressed	;$B8D95A
	AND.w #$C000				;$B8D95D
	BEQ.b CODE_B8D96B			;$B8D960
	EOR.w player_action_button_pressed	;$B8D962
	STA.w player_action_button_pressed	;$B8D965
...
CODE_B8D9A0:
	...
	LDA.w player_action_button_pressed	;$B8D9B8
	AND.w #$4000				;$B8D9BB
...
CODE_B8DA37:
	LDA.w player_action_button_pressed	;$B8DA37
	AND.w #$4000				;$B8DA3A
...
CODE_B8DABF:
	...
	STZ.w RAM_1877				;$B8DAC2
	LDX.b current_sprite			;$B8DAC5
	LDA.w #$0001				;$B8DAC7
	STA.w $003C,y				;$B8DACA
	STX.b $3E,y				;$B8DACD
	LDA.w $003A,y				;$B8DACF
	STA.w RAM_1875				;$B8DAD2
	AND.w #$FFFA				;$B8DAD5
	ORA.w #$0020				;$B8DAD8
	STA.w $003A,y				;$B8DADB
	LDA.w $000E,y				;$B8DADE
	STA.w RAM_1873				;$B8DAE1
	LDA.w $0012,y				;$B8DAE4
	SEC					;$B8DAE7
	SBC.b $12,x				;$B8DAE8
	BIT.b $1E,x				;$B8DAEA
	...
	INC					;$B8DAF1
CODE_B8DAF2:
	STA.w RAM_186D				;$B8DAF2
	LDA.w $0016,y				;$B8DAF5
	SEC					;$B8DAF8
	SBC.b $16,x				;$B8DAF9
	STA.w RAM_186F				;$B8DAFB
	LDA.w #$FFFF				;$B8DAFE
	STA.w RAM_1871				;$B8DB01
	LDA.w player_action_button_held		;$B8DB04
	AND.w #$1300				;$B8DB07
	STA.w player_action_button_held		;$B8DB0A
	SEC					;$B8DB0D
	RTS					;$B8DB0E
...
CODE_B8DB3A:
	...
	STZ.w RAM_1929				;$B8DB4B
	LDA.w #$000F				;$B8DB4E
	STA.w RAM_192B				;$B8DB51
	SEC					;$B8DB54
	RTS					;$B8DB55
...
CODE_B8DB69:
	STZ.w RAM_187B				;$B8DB69
CODE_B8DB6C:
	INC.w RAM_187B				;$B8DB6C
CODE_B8DB6F:
	STZ.w RAM_1879				;$B8DB6F
...
CODE_B8DC77:
	...
	AND.w #$FFFB				;$B8DC7C
	STA.w $0006,y				;$B8DC7F
	STZ.w RAM_1879				;$B8DC82
	STZ.w RAM_187B				;$B8DC85
	RTS					;$B8DC88
...
CODE_B8DC89:
	...
	LDA.w player_action_button_held		;$B8DC92
	AND.w #$0400				;$B8DC95
...
CODE_B8DCBB:
	...
	LDA.w player_action_button_held		;$B8DCC4
	AND.w #$0400				;$B8DCC7
...
CODE_B8DCED:
	LDA.w player_action_button_pressed	;$B8DCED
	AND.w #$0080				;$B8DCF0
...
CODE_B8DD31:
	LDA.w player_action_button_pressed	;$B8DD31
	AND.w #$0080				;$B8DD34
...
CODE_B8DD50:
	...
	LDA.w player_action_button_pressed	;$B8DD5C
	AND.w #$0080				;$B8DD5F
	BEQ.b CODE_B8DD6C			;$B8DD62
	LDA.w player_action_button_held		;$B8DD64
	AND.w #$0400				;$B8DD67
...
CODE_B8DD6D:
	...
	LDA.w player_action_button_pressed	;$B8DD79
	AND.w #$0010				;$B8DD7C
...
CODE_B8DD82:
	...
	LDA.w player_action_button_pressed	;$B8DD87
	AND.w #$0080				;$B8DD8A
	...
	LDA.w player_action_button_held		;$B8DD98
	AND.w #$0400				;$B8DD9B
...
CODE_B8DDA3:
	...
	LDA.w player_action_button_pressed	;$B8DDA8
	AND.w #$0010				;$B8DDAB
...
CODE_B8DDB1:
	...
	LDA.w #$0046				;$B8DDC3
	CMP.w kong_control.animation_id,y	;$B8DDC6
	BEQ.b CODE_B8DDDF			;$B8DDC9
	LDA.b $16,x				;$B8DDCB
	CMP.w water_y_position			;$B8DDCD
...
CODE_B8DDE2:
	STZ.w RAM_04AA				;$B8DDE2
	STZ.w RAM_04AE				;$B8DDE5
	LDA.w #$0069				;$B8DDE8
	STA.b $38,x				;$B8DDEB
	LDA.w #$000F				;$B8DDED
...
CODE_B8DDF5:
	LDA.w #$0001				;$B8DDF5
	TSB.w RAM_1957				;$B8DDF8
	RTS					;$B8DDFB

CODE_B8DDFC:
	LDA.w player_action_button_pressed	;$B8DDFC
	AND.w #$0020				;$B8DDFF
...
CODE_B8DE1F:
	LDA.w player_action_button_held		;$B8DE1F
	AND.w #$0200				;$B8DE22
	BNE.b CODE_B8DE2A			;$B8DE25
	JSR.w CODE_B8DE36			;$B8DE27
CODE_B8DE2A:
	LDA.w player_action_button_held		;$B8DE2A
	AND.w #$0100				;$B8DE2D
...
CODE_B8DE36:
	LDA.w rocket_rush_fuel_amount		;$B8DE36
	DEC					;$B8DE39
...
CODE_B8DE55:
	LDA.w rocket_rush_fuel_amount		;$B8DE55
	DEC					;$B8DE58
...
CODE_B8DE74:
	LDA.w rocket_rush_fuel_amount		;$B8DE74
	DEC					;$B8DE77
...
CODE_B8DED8:
	LDA.w player_action_button_pressed	;$B8DED8
	AND.w #$8000				;$B8DEDB
	...
	LDY.w #$0330				;$B8DEE9
CODE_B8DEEC:
	LDA.w player_action_button_held		;$B8DEEC
	AND.w #$0800				;$B8DEEF
...
CODE_B8DF35:
	LDA.w player_action_button_pressed	;$B8DF35
	AND.w #$4000				;$B8DF38
	...
	LDA.w #$0069				;$B8DF46
	CMP.w kong_control.animation_id,y	;$B8DF49
...
CODE_B8DF5E:
	...
	LDA.w player_action_button_held		;$B8DF67
	AND.w #$0400				;$B8DF6A
...
CODE_B8DF90:
	...
	LDA.w player_action_button_pressed	;$B8DF93
	AND.w #$4000				;$B8DF96
...
CODE_B8DFD4:
	...
	STA.b $2A,x				;$B8DFD6
	LDA.w player_action_button_held		;$B8DFD8
	AND.w #$0C00				;$B8DFDB
...
CODE_B8E05F:
	...
	STA.b $2A,x				;$B8E061
	LDA.w player_action_button_held		;$B8E063
	AND.w #$0C00				;$B8E066
...
CODE_B8E271:
	...
	LDA.w player_action_button_held		;$B8E273
	AND.w #$0300				;$B8E276
...
CODE_B8E369:
	LDA.w #$0200				;$B8E369
	STA.w RAM_059B				;$B8E36C
	LDX.w active_kong_sprite		;$B8E36F
	STX.b current_sprite			;$B8E372
	LDA.w active_kong_control_variables	;$B8E374
...
CODE_B8E45B:
	JML [sprite_return_address]		;$B8E45B

CODE_B8E45E:
	LDA.w #$0005				;$B8E45E
	STA.b $38,x				;$B8E461
	STZ.b $30,x				;$B8E463
	JML [sprite_return_address]		;$B8E465

CODE_B8E468:
	JSR.w CODE_B8E78D			;$B8E468
	JSL.l process_sprite_animation		;$B8E46B
	JML [sprite_return_address]		;$B8E46F
...
CODE_B8E477:
	...
	JML [sprite_return_address]		;$B8E47B
...
CODE_B8E49D:
	JML [sprite_return_address]		;$B8E49D
...
CODE_B8E4AB:
	...
	STA.b $38,x				;$B8E4AE
	STZ.b $30,x				;$B8E4B0
	JML [sprite_return_address]		;$B8E4B2
...
CODE_B8E4D0:
	JML [sprite_return_address]		;$B8E4D0
...
CODE_B8E522:
	...
	CMP.w water_y_position			;$B8E52E
	LDA.b $16,x				;$B8E531
	BMI.b CODE_B8E54F			;$B8E533
	ROR.b $3E				;$B8E535
	CMP.w water_y_position			;$B8E537
	ROR					;$B8E53A
	EOR.b $3E				;$B8E53B
...
ellie_diagonal_water_shot_main:
	...
	LDA.w RAM_0777				;$B8E703
	AND.w #$0100				;$B8E706
	STA.w RAM_1860				;$B8E709
	LDA.w #$0040				;$B8E70C
	LDY.w #$0010				;$B8E70F
	...
	JML [sprite_return_address]		;$B8E732

CODE_B8E735:
	JSL.l delete_sprite_handle_deallocation	;$B8E735
	JML [sprite_return_address]		;$B8E739
...
CODE_B8E75B:
	JML [sprite_return_address]		;$B8E75B

CODE_B8E75E:
	JSR.w CODE_B8E78D			;$B8E75E
	JSL.l process_sprite_animation		;$B8E761
	JML [sprite_return_address]		;$B8E765
...
CODE_B8E76D:
	...
	JML [sprite_return_address]		;$B8E771
...
CODE_B8E78A:
	JML [sprite_return_address]		;$B8E78A
...
CODE_B8E78F:
	...
	LDA.w $0016,y				;$B8E79E
	CLC					;$B8E7A1
	ADC.w RAM_188F				;$B8E7A2
	STA.b $16,x				;$B8E7A5
	BIT.b $1E,x				;$B8E7A7
	BVS.b CODE_B8E7B5			;$B8E7A9
	LDA.w $0012,y				;$B8E7AB
	CLC					;$B8E7AE
	ADC.w RAM_188D				;$B8E7AF
	STA.b $12,x				;$B8E7B2
	RTS					;$B8E7B4
...
CODE_B8E7B5:
	LDA.w $0012,y				;$B8E7B5
	SEC					;$B8E7B8
	SBC.w RAM_188D				;$B8E7B9
	STA.b $12,x				;$B8E7BC
	RTS					;$B8E7BE

CODE_B8E7BF:
	LDA.w game_state_flags			;$B8E7BF
	AND.w #$4000				;$B8E7C2
	...
	LDA.w $0012,y				;$B8E7CC
	CLC					;$B8E7CF
	ADC.w RAM_1887				;$B8E7D0
	STA.b $12,x				;$B8E7D3
	LDA.w $0016,y				;$B8E7D5
	CLC					;$B8E7D8
	ADC.w RAM_188B				;$B8E7D9
	STA.b $16,x				;$B8E7DC
CODE_B8E7DE:
	RTS					;$B8E7DE

CODE_B8E7DF:
	LDA.w RAM_1899				;$B8E7DF
...
CODE_B8E82A:
	DEC.w RAM_1899				;$B8E82A
CODE_B8E82D:
	CLC					;$B8E82D
	RTS					;$B8E82E

CODE_B8E82F:
	LDA.w RAM_0517				;$B8E82F
	CMP.w #$0004				;$B8E832
...
CODE_B8E8B7:
	...
	JML [sprite_return_address]		;$B8E8BB
...
CODE_B8E984:
	JML [sprite_return_address]		;$B8E984

CODE_B8E987:
	JSR.w CODE_B8E78D			;$B8E987
	JSL.l process_sprite_animation		;$B8E98A
	JML [sprite_return_address]		;$B8E98E
...
CODE_B8E996:
	...
	JML [sprite_return_address]		;$B8E99A
...
CODE_B8E9F1:
	JML [sprite_return_address]		;$B8E9F1
...
web_shot_main:
	...
	JML [sprite_return_address]		;$B8EA16

CODE_B8EA19:
	JSL.l CODE_BB8597			;$B8EA19
CODE_B8EA1D:
	DEC.w RAM_1897				;$B8EA1D
	JML [sprite_return_address]		;$B8EA20
...
CODE_B8EA41:
	LDA.w water_y_position			;$B8EA41
	PHA					;$B8EA44
	STZ.w water_y_position			;$B8EA45
	JSL.l CODE_B9E006			;$B8EA48
	PLA					;$B8EA4C
	STA.w water_y_position			;$B8EA4D
	LDA.b $28,x				;$B8EA50
	BIT.w #$0202				;$B8EA52
...
CODE_B8EA66:
	...
	JML [sprite_return_address]		;$B8EA78

CODE_B8EA7B:
	LDA.w #$0006				;$B8EA7B
	TRB.w RAM_1957				;$B8EA7E
	JML [sprite_return_address]		;$B8EA81

CODE_B8EA84:
	LDA.w #$0002				;$B8EA84
	TRB.w RAM_1957				;$B8EA87
	JSL.l process_sprite_animation		;$B8EA8A
	JML [sprite_return_address]		;$B8EA8E
...
CODE_B8EA91:
	...
	STA.b $60,x				;$B8EAAC
	INC.b $38,x				;$B8EAAE
	JML [sprite_return_address]		;$B8EAB0
...
CODE_B8EAE9:
	JML [sprite_return_address]		;$B8EAE9
...
CODE_B8EB63:
	...
	JML [sprite_return_address]		;$B8EB80
...
CODE_B8EBA6:
	JML [sprite_return_address]		;$B8EBA6
...
CODE_B8ECAE:
	...
	INC.b $38,x				;$B8ECB9
CODE_B8ECBB:
	JML [sprite_return_address]		;$B8ECBB

CODE_B8ECBE:
	LDA.w game_state_flags			;$B8ECBE
	AND.w #$4000				;$B8ECC1
	BEQ.b CODE_B8ECD0			;$B8ECC4
	LDA.b current_animal_type		;$B8ECC6
	CMP.w $0060,y				;$B8ECC8
	BNE.b CODE_B8ED07			;$B8ECCB
	JML [sprite_return_address]		;$B8ECCD
...
CODE_B8ECD0:
	...
	LDA.w #$0040				;$B8ECD3
	STA.b $5E,x				;$B8ECD6
	JML [sprite_return_address]		;$B8ECD8
...
CODE_B8ECF3:
	...
	EOR.w #$4000				;$B8ECF5
	STA.b $26,x				;$B8ECF8
	JML [sprite_return_address]		;$B8ECFA
...
CODE_B8ED04:
	JML [sprite_return_address]		;$B8ED04

CODE_B8ED07:
	JSL.l CODE_BB8597			;$B8ED07
	STZ.w RAM_189B				;$B8ED0B
	JML [sprite_return_address]		;$B8ED0E

CODE_B8ED11:
	LDA.w game_state_flags			;$B8ED11
	AND.w #$4000				;$B8ED14
	BEQ.b CODE_B8ED4A			;$B8ED17
	LDA.b current_animal_type		;$B8ED19
	BEQ.b CODE_B8ED4A			;$B8ED1B
	LDX.w RAM_189B				;$B8ED1D
...
CODE_B8EDC1:
	...
	JML [sprite_return_address]		;$B8EDC5
...
CODE_B8EDF1:
	...
	LDA.w #bear_dialogue.baffle		;$B8EDFF
...
CODE_B8EE45:
	ADC.w $0016,y				;$B8EE45
	STA.w RAM_17CE				;$B8EE48
	LDA.w $0060,y				;$B8EE4B
	STA.w RAM_17D0				;$B8EE4E
	LDA.w $0062,y				;$B8EE51
	STA.w RAM_17D2				;$B8EE54
	RTS					;$B8EE57

animal_sign_prize_main:
	JSL.l process_current_movement		;$B8EE58
	BCS.b CODE_B8EE61			;$B8EE5C
	JML [sprite_return_address]		;$B8EE5E
...
CODE_B8EE7A:
	...
	JML [sprite_return_address]		;$B8EE85
...
CODE_B8EEAD:
	LDA.w #$0001				;$B8EEAD
	STA.b $60,x				;$B8EEB0
	LDA.w RAM_0777				;$B8EEB2
	AND.w #$0200				;$B8EEB5
	BEQ.b CODE_B8EEC1			;$B8EEB8
	JSL.l CODE_BB8597			;$B8EEBA
	JML [sprite_return_address]		;$B8EEBE
...
CODE_B8EEE6:
	...
	LDA.w #$041D				;$B8EEFF
	JSL play_high_priority_sound		;$B8EF02
	LDA.w #$071E				;$B8EF06
	JSL play_high_priority_sound		;$B8EF09
	LDA.w #$051F				;$B8EF0D
	JSL play_high_priority_sound		;$B8EF10
	LDA.w #$0620				;$B8EF14
	JSL play_high_priority_sound		;$B8EF17
	JML [sprite_return_address]		;$B8EF1B
...
CODE_B8EF1E:
	...
	STA.w $0016,y				;$B8EF3F
CODE_B8EF42:
	JML [sprite_return_address]		;$B8EF42
...
CODE_B8EFE7:
	...
	LDA.b $0E,x				;$B8EFF2
	CLC					;$B8EFF4
	ADC.w RAM_1871				;$B8EFF5
	STA.w $000E,y				;$B8EFF8
	LDA.b $16,x				;$B8EFFB
	CLC					;$B8EFFD
	ADC.w RAM_186F				;$B8EFFE
	STA.w $0016,y				;$B8F001
	LDA.b $1E,x				;$B8F004
	EOR.w $001E,y				;$B8F006
	AND.w #$7000				;$B8F009
...
CODE_B8F064:
	...
	STA.w RAM_1923				;$B8F0A1
	STZ.w RAM_1925				;$B8F0A4
	LDA.w #$0002				;$B8F0A7
	TSB.w game_state_flags			;$B8F0AA
	RTL					;$B8F0AD
...
CODE_B8F0E0:
	...
	STA.w RAM_191B				;$B8F107
	LDA.l $7E4100,x				;$B8F10A
	STA.w RAM_191D				;$B8F10E
	LDA.w RAM_1917				;$B8F111
	CMP.w $0012,y				;$B8F114
	BEQ.b CODE_B8F11C			;$B8F117
	JSR.w CODE_B8F179			;$B8F119
CODE_B8F11C:
	LDA.w RAM_1927				;$B8F11C
	AND.w #$0003				;$B8F11F
...
CODE_B8F150:
	TRB.w RAM_1927				;$B8F150
	AND.w #$0002				;$B8F153
	BEQ.b CODE_B8F168			;$B8F156
	LDA.w RAM_1925				;$B8F158
	INC					;$B8F15B
	INC					;$B8F15C
	AND.w #$003F				;$B8F15D
	CMP.w RAM_1923				;$B8F160
	BEQ.b CODE_B8F178			;$B8F163
	STA.w RAM_1925				;$B8F165
CODE_B8F168:
	LDA.w RAM_1925				;$B8F168
	INC					;$B8F16B
	INC					;$B8F16C
	AND.w #$003F				;$B8F16D
	CMP.w RAM_1923				;$B8F170
	BEQ.b CODE_B8F178			;$B8F173
	STA.w RAM_1925				;$B8F175
CODE_B8F178:
	RTS					;$B8F178
...
CODE_B8F19B:
	LDA.w #$0004				;$B8F19B
	TSB.w RAM_1927				;$B8F19E
	RTS					;$B8F1A1

CODE_B8F1A2:
	LDX.w RAM_191B				;$B8F1A2
...
CODE_B8F203:
	...
	LDA.w kong_control.animation_id,y	;$B8F205
	CMP.w #$001D				;$B8F208
	BEQ.b CODE_B8F229			;$B8F20B
	LDX.b current_sprite			;$B8F20D
	LDA.b $1E,x				;$B8F20F
	EOR.w RAM_191D				;$B8F211
	AND.w #$4000				;$B8F214
...
CODE_B8F29E:
	...
	JML [sprite_return_address]		;$B8F2B5
...
kong_state_70:
	...
	JML [sprite_return_address]		;$B8F2BE

kong_state_71:
	JSL.l process_anim_preserve_state	;$B8F2C1
	JSR.w CODE_B8F35B			;$B8F2C5
	JML [sprite_return_address]		;$B8F2C8
...
kong_state_72:
	...
	JML [sprite_return_address]		;$B8F2DF
...
kong_state_73:
	...
	JML [sprite_return_address]		;$B8F2F3
...
kong_state_75:
	...
	JML [sprite_return_address]		;$B8F345
...
CODE_B8F389:
	LDA.w RAM_1945				;$B8F389
	BEQ.b CODE_B8F397			;$B8F38C
	LDA.b $1A,x				;$B8F38E
	BNE.b CODE_B8F39A			;$B8F390
	STA.w RAM_1945				;$B8F392
	BRA.b CODE_B8F3A4			;$B8F395

CODE_B8F397:
	DEC.w RAM_193F				;$B8F397
CODE_B8F39A:
	RTS					;$B8F39A

CODE_B8F39B:
	STA.w RAM_193B				;$B8F39B
	STZ.w RAM_193D				;$B8F39E
	STZ.w RAM_193F				;$B8F3A1
CODE_B8F3A4:
	PHK					;$B8F3A4
	PLB					;$B8F3A5
	LDA.w RAM_193B				;$B8F3A6
	ASL					;$B8F3A9
	TAX					;$B8F3AA
	LDA.l DATA_B8F3F5,x			;$B8F3AB
	CLC					;$B8F3AF
	ADC.w RAM_193D				;$B8F3B0
	TAX					;$B8F3B3
	LDA.w $0000,x				;$B8F3B4
	STA.w RAM_193F				;$B8F3B7
	STZ.w RAM_1941				;$B8F3BA
	STZ.w RAM_1945				;$B8F3BD
	JMP.w ($0002,x)				;$B8F3C0

CODE_B8F3C3:
	CLC					;$B8F3C3
	ADC.w RAM_193D				;$B8F3C4
	STA.w RAM_193D				;$B8F3C7
CODE_B8F3CA:
	RTS					;$B8F3CA

CODE_B8F3CB:
	CLC					;$B8F3CB
	ADC.w RAM_193D				;$B8F3CC
	STA.w RAM_193D				;$B8F3CF
	PHK					;$B8F3D2
	PLB					;$B8F3D3
	LDA.w RAM_193B				;$B8F3D4
	ASL					;$B8F3D7
	TAX					;$B8F3D8
	LDA.l DATA_B8F3F5,x			;$B8F3D9
	CLC					;$B8F3DD
	ADC.w RAM_193D				;$B8F3DE
	TAX					;$B8F3E1
	LDA.w $0000,x				;$B8F3E2
	CLC					;$B8F3E5
	ADC.w RAM_193F				;$B8F3E6
	STA.w RAM_193F				;$B8F3E9
	STZ.w RAM_1941				;$B8F3EC
	STZ.w RAM_1945				;$B8F3EF
	JMP.w ($0002,x)				;$B8F3F2
...
CODE_B8F624:
	STZ.w RAM_195B				;$B8F624
	JSL.l CODE_B8837A			;$B8F627
	RTS					;$B8F62B

CODE_B8F62C:
	LDA.w game_state_flags			;$B8F62C
	AND.w #$4000				;$B8F62F
...
CODE_B8F788:
	LDY.w active_kong_control_variables	;$B8F788
	LDA.w $0006,y				;$B8F78B
	AND.w #$FFFB				;$B8F78E
	STA.w $0006,y				;$B8F791
...
CODE_B8F796:
	LDY.w active_kong_control_variables	;$B8F796
	LDA.w $0006,y				;$B8F799
	ORA.w #$0004				;$B8F79C
	STA.w $0006,y				;$B8F79F
...
CODE_B8F7A4:
	LDA.w $0004,x				;$B8F7A4
	STA.w RAM_1941				;$B8F7A7
	JSL.l CODE_B89C4C			;$B8F7AA
	LDA.b $12,x				;$B8F7AE
	STA.w RAM_1943				;$B8F7B0
	LDA.w #$0073				;$B8F7B3
	STA.b $38,x				;$B8F7B6
	LDA.w #$0002				;$B8F7B8
	...
	STZ.b $2E,x				;$B8F7C1
	LDA.w RAM_1941				;$B8F7C3
	CMP.w RAM_1943				;$B8F7C6
...
CODE_B8FA09:
	LDA.w $0004,x				;$B8FA09
	AND.w RAM_194F				;$B8FA0C
	BEQ.b CODE_B8FA1A			;$B8FA0F
	TRB.w RAM_194F				;$B8FA11
	LDA.w #$0006				;$B8FA14
